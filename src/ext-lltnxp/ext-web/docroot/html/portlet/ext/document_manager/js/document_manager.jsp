...
<script type="text/javascript">
	...
	function checkValidate(){
		if(checkInput() == false || checkFileUpload() == false){
			return false;
		}else{
			fileUpload();
		}
	...
	function checkInput(){
		if(document.<portlet:namespace/>fm.<portlet:namespace/>documentManagerCode.value == ""){
			alert("<liferay-ui:message key='input-document-manager-code'/>");
			return false;
		}
		if(document.<portlet:namespace/>fm.<portlet:namespace/>documentManagerCategory.value == ""){
			alert("<liferay-ui:message key='input-document-manager-category'/>");
			return false;
		}
		if(document.<portlet:namespace/>fm.<portlet:namespace/>documentManagerDescription.value == ""){
			alert("<liferay-ui:message key='input-document-manager-description'/>");
			return false;
		}
	}
