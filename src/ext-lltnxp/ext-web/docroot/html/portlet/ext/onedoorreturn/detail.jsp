...
<form action="<portlet:actionURL windowState="<%= WindowState.MAXIMIZED.toString() %>">
	<portlet:param name="struts_action" value="/sgs/onedoorreturn/detail" /></portlet:actionURL>" 	enctype="multipart/form-data" method="post" name="<portlet:namespace />fm_View">
	...
	<li style="width: 49.6%; margin-right: 0.8%" >
		...
		<legend class="laborder"><liferay-ui:message key="pccc-TN-thongtinhoso"/></legend>
			...
			<tr>
				...
				<td class="td-right td-right-trangthai"><liferay-ui:message key="pccc-trangthaihoso-hoanthanh"/></td>
			</tr>
			<tr valign="top">
		...
		<legend class="laborder"><liferay-ui:message key="pccc-TN-hosodinhkem"/></legend>
			<table class="taglib-search-iterator table-pml" cellspacing="0" width="100%">	
					<tr class="portlet-section-header results-header" >
						<td width="35px" align="center"><liferay-ui:message key="pccc-TN-stt"/></td>
						<td width="45%"><liferay-ui:message key="pccc-TN-tenhosodinhkem"/></td>
			...
			<table class="taglib-search-iterator table-pml" cellspacing="0" width="100%" style="display: none">	
					<tr class="portlet-section-header results-header" >
						<td width="35px" align="center"><liferay-ui:message key="pccc-TN-stt"/></td>
						<td width="35%"><liferay-ui:message key="pccc-TN-tentailieubanve"/></td>
