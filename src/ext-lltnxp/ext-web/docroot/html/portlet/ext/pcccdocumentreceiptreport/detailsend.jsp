...
<table width="100%" cellspacing="0">
	...
	<tr>
		<td class="td-left"><liferay-ui:message key="receipt.docrectype"/>&nbsp;:</td>
	...
	<tr>
		...
		<td colspan="3" class="td-right"><textarea class="textarea-display" style="width: 98%" readonly="" rows="5"><%=sendDTO.getBriefContent() %></textarea></td>
	</tr>	
</table>
</fieldset>
		<%
...
<table cellspacing="0" width="100%">
					...
					<tr valign="top">
						...
						<textarea class="textarea-display" style="width: 98%" readonly="" rows="5"><%=receiptDTO.getBriefContent() %></textarea>
						</td>
					</tr>
</table>
</fieldset>
...
<table cellspacing="0" class="taglib-search-iterator table-pml">
							<tr class="portlet-section-header results-header" >
									<td width="3%" align="center"><liferay-ui:message key="pccc-TN-stt"/></td>
...
<div id="table-button" align="right">
	<span onclick="back();" ><input type="button" value='<liferay-ui:message key="back" />'></span>
</div>
</form>  
</div>
