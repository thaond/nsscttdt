	...
	<table class="taglib-search-iterator table-pml" cellspacing="0" width="100%">	
		...
		%>
			<tr class="<%=(k % 2) == 0 ? "results-row" : "tr_two results-row" %>" onmouseover="onMouseOverTr(this);" onmouseout="onMouseOutTr(this);">
				...
				<td width="20%"><%=directProcesserName.length() > 0 ? processerName + "<br/><small>("+ directProcesserName + ": " + LanguageUtil.get(pageContext, "nhap-lieu-thay") + ")</small>" : processerName %></td>
