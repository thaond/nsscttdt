...
<form method="post" id="<portlet:namespace/>fm" name="<portlet:namespace/>fm">
		...
		<table cellspacing="0" width="100%" class="tabldtail">
				<tr>	  
				    ...
				    <td class="td-right"><%=documentDTO.getLevelSendName() != null ? documentDTO.getLevelSendName() : "" %></td>
				...
				<tr>
					<td class="td-left" nowrap="nowrap"><label><liferay-ui:message key="pccc-cvdtn-socongvan"/>: </label></td>
