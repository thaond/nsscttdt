...
<%@page import="com.sgs.portlet.onedoorpcccreport.dto.BaoCaoHoSoThangDTO"%>
<%@page import="com.sgs.portlet.onedoorpcccreport_baocaohosothang.search.BaoCaoHoSoThangSearchTerms"%>
<%@page import="com.sgs.portlet.onedoorpcccreport_baocaohosothang.search.BaoCaoHoSoThangSearch"%>
...
<%@page import="com.sgs.portlet.filetype.model.impl.PmlFileTypeImpl"%>
...
<%@page import="com.sgs.portlet.onedoorpcccreport_baocaohosothang.action.ViewAction"%>
<%@page import="com.sgs.portlet.filetype.service.persistence.PmlFileTypeUtil"%>

<liferay-util:include page="/html/portlet/ext/onedoorpcccreport_baocaohosothang/js/onedoorpcccreport_baocaohosothang-js.jsp"></liferay-util:include>
<portlet:actionURL var="report">
	<portlet:param name="struts_action" value="/sgs/onedoorpcccreport_baocaohosothang/view" />
</portlet:actionURL>
...
function <portlet:namespace />setActionFrom(param) {
	...
	<%
		...
		portletURL.setParameter("struts_action", "/sgs/onedoorpcccreport_baocaohosothang/view" );
	%>
<form name="<portlet:namespace />frmReport" action="<%= report %>" method="post" onsubmit="return <portlet:namespace/>checkForm(this);">
<div class="title_categ"><liferay-ui:message key="bao-cao-ho-so-thang"/></div>
<div class="boxcontent">
	...
	<liferay-ui:search-form
			page="/html/portlet/ext/onedoorpcccreport_baocaohosothang/baocaohosothang_search.jsp"
		...
		int total1 = PmlFileTypeLocalServiceUtil.searchCount();
	...
	<%
		...
		//tinh tong
		List<PmlFileType> pmlFileTypeListTotal = PmlFileTypeUtil.findAll();
	...
	<%
		...
		if ( pmlFileTypeList.size() > 0 ){
			for ( int i=0; i< baoCaoHoSoThangList.size(); i++) {
				...
				tenSanPhamURL.setParameter("struts_action","/sgs/onedoorpcccreport_baocaohosothang/filedetails");
				...
				tonDauKyURL.setParameter("struts_action","/sgs/onedoorpcccreport_baocaohosothang/filedetails");
				...
				nhanTrongThangURL.setParameter("struts_action","/sgs/onedoorpcccreport_baocaohosothang/filedetails");
				...
				tongCongURL.setParameter("struts_action","/sgs/onedoorpcccreport_baocaohosothang/filedetails");
				...
				soDungHanURL.setParameter("struts_action","/sgs/onedoorpcccreport_baocaohosothang/filedetails");
				...
				soTreHanURL.setParameter("struts_action","/sgs/onedoorpcccreport_baocaohosothang/filedetails");
				...
				trongHanURL.setParameter("struts_action","/sgs/onedoorpcccreport_baocaohosothang/filedetails");
				...
				daTreHanURL.setParameter("struts_action","/sgs/onedoorpcccreport_baocaohosothang/filedetails");
				...
				chinhSuaBoSungURL.setParameter("struts_action","/sgs/onedoorpcccreport_baocaohosothang/filedetails");
	...
	<div class="results-grid">
			<table class="taglib-search-iterator" cellspacing="0" width="100%">
				<tr class="portlet-section-header results-header">
					<td rowspan="3" width="3%" align="center"><liferay-ui:message key="onedoorpcccreport-stt" /></b></td>
