...
<!-- %@ include file="/html/portlet/ext/onedoorpcccreport_tinhhinhthulyhosocapso/page_iterator/init_search.jsp" %-->

<%@page import="java.text.SimpleDateFormat"%>
<%@page import="javax.portlet.PortletURL"%>
<%@page import="javax.portlet.WindowState"%>
<%@page import="com.sgs.portlet.onedoorpcccreport_tinhhinhthulyhosocapso.search.HoSoCapSoSearch"%>
...
<%@page import="com.sgs.portlet.onedoorpcccreport.dto.TinhHinhThuLyHoSoCapSoDTO"%>
...
<%@page import="com.sgs.portlet.pmluser.service.persistence.PmlUserUtil"%><portlet:actionURL var="report">
	<portlet:param name="struts_action" value="/sgs/onedoorpcccreport_tinhhinhthulyhosocapso/view" />
</portlet:actionURL>
...
<%
	...
	portletURL.setParameter("struts_action","/sgs/onedoorpcccreport_tinhhinhthulyhosocapso/view" );
	...
	List<Department> departmentList = DepartmentLocalServiceUtil.findDepartments("tatca", start1, end1, searchContainer.getOrderByComparator());
...
<div class="boxcontent">
	...
	<%
		...
		for ( int i=0; i< departmentList.size(); i++) {
			...
			phongBanURL.setParameter("struts_action","/sgs/onedoorpcccreport_tinhhinhthulyhosocapso/filedetails" );
			...
			tonTruocURL.setParameter("struts_action","/sgs/onedoorpcccreport_tinhhinhthulyhosocapso/filedetails" );
			...
			daNhanURL.setParameter("struts_action","/sgs/onedoorpcccreport_tinhhinhthulyhosocapso/filedetails" );
			...
			chuaNhanURL.setParameter("struts_action","/sgs/onedoorpcccreport_tinhhinhthulyhosocapso/filedetails" );
			...
			tongCanXuLyURL.setParameter("struts_action","/sgs/onedoorpcccreport_tinhhinhthulyhosocapso/filedetails" );
			...
			hsGiaiQuyetURL.setParameter("struts_action","/sgs/onedoorpcccreport_tinhhinhthulyhosocapso/filedetails" );
			...
			trongHanISOURL.setParameter("struts_action","/sgs/onedoorpcccreport_tinhhinhthulyhosocapso/filedetails" );
			...
			quaHanISOURL.setParameter("struts_action","/sgs/onedoorpcccreport_tinhhinhthulyhosocapso/filedetails" );
			...
			tongTonDongURL.setParameter("struts_action","/sgs/onedoorpcccreport_tinhhinhthulyhosocapso/filedetails" );
