...
<%
	...
	String uId = (String) renderRequest.getAttribute("id");
...
%>	  
	...
	<portlet:renderURL var="search" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
		<portlet:param name="struts_action" value="/sgs/onedoorpcccreport_tinhhinhthulyhosocapso/search"/>
	</portlet:renderURL>
...
<script type="text/javascript">
	...
	<portlet:renderURL var="searchFile">
		<portlet:param name="struts_action" value="/sgs/onedoorpcccreport_tinhhinhthulyhosocapso/searchresult"/>
