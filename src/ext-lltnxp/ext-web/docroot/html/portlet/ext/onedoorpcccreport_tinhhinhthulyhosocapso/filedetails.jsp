...
<%@page import="com.sgs.portlet.onedoorpcccreport_tinhhinhthulyhosocapso.searchfiledetail.PmlOneDoorReceiveFileSearch"%>
		...
		<div id="listdivpccc">
			<div id="listdiv" >
				...
				<ul>
						...
						<li style="width: 22%">
							<div class="btpre_hs" align="left"><liferay-util:include page="/html/portlet/ext/onedoorpcccreport_tinhhinhthulyhosocapso/button.jsp"></liferay-util:include></div>
						</li>
				</ul>
