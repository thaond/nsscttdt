...
public class SoVanBanNoiBoUtil {
    ...
    public static com.sgs.portlet.sovanbannoibo.model.SoVanBanNoiBo create(
        long soVanBanNoiBoId) {
        return getPersistence().create(soVanBanNoiBoId);
    }

    public static com.sgs.portlet.sovanbannoibo.model.SoVanBanNoiBo remove(
        long soVanBanNoiBoId)
     ...
     */
    public static com.sgs.portlet.sovanbannoibo.model.SoVanBanNoiBo update(
        com.sgs.portlet.sovanbannoibo.model.SoVanBanNoiBo soVanBanNoiBo)
        throws com.liferay.portal.SystemException {
    ...
    public static com.sgs.portlet.sovanbannoibo.model.SoVanBanNoiBo updateImpl(
        com.sgs.portlet.sovanbannoibo.model.SoVanBanNoiBo soVanBanNoiBo,
        boolean merge) throws com.liferay.portal.SystemException {
        return getPersistence().updateImpl(soVanBanNoiBo, merge);
    }

    public static com.sgs.portlet.sovanbannoibo.model.SoVanBanNoiBo findByPrimaryKey(
        long soVanBanNoiBoId)
        throws com.liferay.portal.SystemException,
            com.sgs.portlet.sovanbannoibo.NoSuchException {
    ...
    public static com.sgs.portlet.sovanbannoibo.model.SoVanBanNoiBo fetchByPrimaryKey(
    ...
    public static java.util.List<com.sgs.portlet.sovanbannoibo.model.SoVanBanNoiBo> findAll()
        throws com.liferay.portal.SystemException {
