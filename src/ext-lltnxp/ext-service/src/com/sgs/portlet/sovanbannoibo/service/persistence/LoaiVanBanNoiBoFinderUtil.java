...
public class LoaiVanBanNoiBoFinderUtil {
    ...
    public static java.util.List<com.sgs.portlet.sovanbannoibo.model.LoaiVanBanNoiBo> findByKeywords(
    ...
    public static java.util.List<com.sgs.portlet.sovanbannoibo.model.LoaiVanBanNoiBo> find_loai_van_ban_noi_bo(
        java.lang.String kyHieuLoaiVanBanNoiBos,
