...
/**
 * <a href="AttactFileHolidayServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class AttactFileHolidayServiceUtil {
    private static AttactFileHolidayService _service;

    public static AttactFileHolidayService getService() {
        if (_service == null) {
            throw new RuntimeException("AttactFileHolidayService is not set");
        }
