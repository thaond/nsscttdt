...
/**
 * <a href="PmlEdmDocumentRecordToServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class PmlEdmDocumentRecordToServiceUtil {
    private static PmlEdmDocumentRecordToService _service;

    public static PmlEdmDocumentRecordToService getService() {
        if (_service == null) {
            throw new RuntimeException(
                "PmlEdmDocumentRecordToService is not set");
        }
