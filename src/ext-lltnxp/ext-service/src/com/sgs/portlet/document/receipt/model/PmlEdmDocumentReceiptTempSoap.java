...
/**
 * <a href="PmlEdmDocumentReceiptTempSoap.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 * <code>com.sgs.portlet.document.receipt.service.http.PmlEdmDocumentReceiptTempServiceSoap</code>.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.sgs.portlet.document.receipt.service.http.PmlEdmDocumentReceiptTempServiceSoap
 *
 */
public class PmlEdmDocumentReceiptTempSoap implements Serializable {
    ...
    public PmlEdmDocumentReceiptTempSoap() {
    }

    public static PmlEdmDocumentReceiptTempSoap toSoapModel(
        PmlEdmDocumentReceiptTemp model) {
        PmlEdmDocumentReceiptTempSoap soapModel = new PmlEdmDocumentReceiptTempSoap();
    ...
    public static PmlEdmDocumentReceiptTempSoap[] toSoapModels(
        List<PmlEdmDocumentReceiptTemp> models) {
        List<PmlEdmDocumentReceiptTempSoap> soapModels = new ArrayList<PmlEdmDocumentReceiptTempSoap>(models.size());

        for (PmlEdmDocumentReceiptTemp model : models) {
            soapModels.add(toSoapModel(model));
        }

        return soapModels.toArray(new PmlEdmDocumentReceiptTempSoap[soapModels.size()]);
    }
