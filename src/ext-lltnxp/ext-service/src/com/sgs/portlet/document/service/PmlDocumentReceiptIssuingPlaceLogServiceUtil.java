...
/**
 * <a href="PmlDocumentReceiptIssuingPlaceLogServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class PmlDocumentReceiptIssuingPlaceLogServiceUtil {
    private static PmlDocumentReceiptIssuingPlaceLogService _service;

    public static PmlDocumentReceiptIssuingPlaceLogService getService() {
        if (_service == null) {
            throw new RuntimeException(
                "PmlDocumentReceiptIssuingPlaceLogService is not set");
        }
