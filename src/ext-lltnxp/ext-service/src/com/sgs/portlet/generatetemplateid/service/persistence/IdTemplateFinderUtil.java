...
public class IdTemplateFinderUtil {
    ...
    public static java.util.List<com.sgs.portlet.generatetemplateid.model.IdTemplate> findByKeywords(
    ...
    public static java.util.List<com.sgs.portlet.generatetemplateid.model.IdTemplate> findByMA_MOTA(
