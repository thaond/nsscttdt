...
public interface IdTemplateFinder {
    ...
    public java.util.List<com.sgs.portlet.generatetemplateid.model.IdTemplate> findByKeywords(
        java.lang.String keywords, int start, int end,
        com.liferay.portal.kernel.util.OrderByComparator obc)
        throws com.liferay.portal.SystemException;

    public java.util.List<com.sgs.portlet.generatetemplateid.model.IdTemplate> findByMA_MOTA(
