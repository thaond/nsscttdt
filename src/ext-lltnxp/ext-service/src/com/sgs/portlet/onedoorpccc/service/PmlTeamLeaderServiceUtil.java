...
/**
 * <a href="PmlTeamLeaderServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class PmlTeamLeaderServiceUtil {
    private static PmlTeamLeaderService _service;

    public static PmlTeamLeaderService getService() {
        if (_service == null) {
            throw new RuntimeException("PmlTeamLeaderService is not set");
        }
