...
public abstract class RoomResourceLocalServiceBaseImpl
    implements RoomResourceLocalService {
    ...
    public RoomResource addRoomResource(RoomResource roomResource)
    ...
    public RoomResource createRoomResource(long roomId) {
        return roomResourcePersistence.create(roomId);
    }

    public void deleteRoomResource(long roomId)
        throws PortalException, SystemException {
        roomResourcePersistence.remove(roomId);
    }

    public void deleteRoomResource(RoomResource roomResource)
        throws SystemException {
        roomResourcePersistence.remove(roomResource);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return roomResourcePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public RoomResource getRoomResource(long roomId)
        throws PortalException, SystemException {
        return roomResourcePersistence.findByPrimaryKey(roomId);
    }

    public List<RoomResource> getRoomResources(int start, int end)
        throws SystemException {
        return roomResourcePersistence.findAll(start, end);
    }

    public int getRoomResourcesCount() throws SystemException {
        return roomResourcePersistence.countAll();
    }

    public RoomResource updateRoomResource(RoomResource roomResource)
        throws SystemException {
        roomResource.setNew(false);

        return roomResourcePersistence.update(roomResource, true);
    }
