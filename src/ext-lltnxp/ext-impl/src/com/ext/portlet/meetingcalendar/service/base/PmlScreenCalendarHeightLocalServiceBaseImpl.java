...
public abstract class PmlScreenCalendarHeightLocalServiceBaseImpl
    implements PmlScreenCalendarHeightLocalService {
    ...
    public PmlScreenCalendarHeight addPmlScreenCalendarHeight(
        PmlScreenCalendarHeight pmlScreenCalendarHeight)
        throws SystemException {
        pmlScreenCalendarHeight.setNew(true);

        return pmlScreenCalendarHeightPersistence.update(pmlScreenCalendarHeight,
            false);
    }

    public PmlScreenCalendarHeight createPmlScreenCalendarHeight(
        long screenCalendarHeightId) {
        return pmlScreenCalendarHeightPersistence.create(screenCalendarHeightId);
    }

    public void deletePmlScreenCalendarHeight(long screenCalendarHeightId)
        throws PortalException, SystemException {
        pmlScreenCalendarHeightPersistence.remove(screenCalendarHeightId);
    }

    public void deletePmlScreenCalendarHeight(
        PmlScreenCalendarHeight pmlScreenCalendarHeight)
        throws SystemException {
        pmlScreenCalendarHeightPersistence.remove(pmlScreenCalendarHeight);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlScreenCalendarHeightPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlScreenCalendarHeight getPmlScreenCalendarHeight(
        long screenCalendarHeightId) throws PortalException, SystemException {
        return pmlScreenCalendarHeightPersistence.findByPrimaryKey(screenCalendarHeightId);
    }

    public List<PmlScreenCalendarHeight> getPmlScreenCalendarHeights(
        int start, int end) throws SystemException {
        return pmlScreenCalendarHeightPersistence.findAll(start, end);
    }

    public int getPmlScreenCalendarHeightsCount() throws SystemException {
        return pmlScreenCalendarHeightPersistence.countAll();
    }

    public PmlScreenCalendarHeight updatePmlScreenCalendarHeight(
        PmlScreenCalendarHeight pmlScreenCalendarHeight)
        throws SystemException {
