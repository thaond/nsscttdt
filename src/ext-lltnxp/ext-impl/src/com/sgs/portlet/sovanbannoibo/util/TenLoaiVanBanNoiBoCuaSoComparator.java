...
public class TenLoaiVanBanNoiBoCuaSoComparator extends OrderByComparator {
	...
	public TenLoaiVanBanNoiBoCuaSoComparator() {
		this(false);
	}

	public TenLoaiVanBanNoiBoCuaSoComparator(boolean asc) {
		this._asc = asc;
	}
