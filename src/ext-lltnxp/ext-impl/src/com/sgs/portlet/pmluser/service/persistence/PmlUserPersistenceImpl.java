...
public class PmlUserPersistenceImpl extends BasePersistenceImpl
    ...
    public List<PmlUser> findByIsLeaderMetting(boolean isLeaderMetting)
        throws SystemException {
        boolean finderClassNameCacheEnabled = PmlUserModelImpl.CACHE_ENABLED;
        String finderClassName = PmlUser.class.getName();
        String finderMethodName = "findByIsLeaderMetting";
        String[] finderParams = new String[] { Boolean.class.getName() };
        Object[] finderArgs = new Object[] { Boolean.valueOf(isLeaderMetting) };
    ...
    public List<PmlUser> findByIsLeaderMetting(boolean isLeaderMetting,
        ...
        return findByIsLeaderMetting(isLeaderMetting, start, end, null);
    }
    ...
    public List<PmlUser> findByIsLeaderMetting(boolean isLeaderMetting,
        ...
        Object[] finderArgs = new Object[] {
                Boolean.valueOf(isLeaderMetting),
    ...
    public PmlUser findByIsLeaderMetting_First(boolean isLeaderMetting,
        OrderByComparator obc) throws NoSuchPmlUserException, SystemException {
        List<PmlUser> list = findByIsLeaderMetting(isLeaderMetting, 0, 1, obc);
        ...
        if (list.size() == 0) {
            ...
            msg.append("isLeaderMetting=" + isLeaderMetting);
    ...
    public PmlUser findByIsLeaderMetting_Last(boolean isLeaderMetting,
        OrderByComparator obc) throws NoSuchPmlUserException, SystemException {
        int count = countByIsLeaderMetting(isLeaderMetting);

        List<PmlUser> list = findByIsLeaderMetting(isLeaderMetting, count - 1,
                count, obc);
    ...
    public PmlUser[] findByIsLeaderMetting_PrevAndNext(long userId,
        boolean isLeaderMetting, OrderByComparator obc)
        throws NoSuchPmlUserException, SystemException {
        PmlUser pmlUser = findByPrimaryKey(userId);
    ...
    public int countByIsLeaderMetting(boolean isLeaderMetting)
        ...
        boolean finderClassNameCacheEnabled = PmlUserModelImpl.CACHE_ENABLED;
        String finderClassName = PmlUser.class.getName();
        String finderMethodName = "countByIsLeaderMetting";
        String[] finderParams = new String[] { Boolean.class.getName() };
        Object[] finderArgs = new Object[] { Boolean.valueOf(isLeaderMetting) };
