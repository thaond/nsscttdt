...
/**
 * <a href="PmlHoSoCongViecLocalServiceImpl.java.html"><b><i>View
 * Source</i></b></a>
 * 
 * @author XUANCONG
 * 
 */
public class PmlHoSoCongViecLocalServiceImpl extends
		PmlHoSoCongViecLocalServiceBaseImpl {

	public int searchCount(long userId, String keywords) throws SystemException {

		return pmlHoSoCongViecFinder.countByKeywords(userId, keywords);
	}

	public int searchCount(long userId, String soHieuHSCV, String tieuDe,
			Date ngayMoHSCV, String idLinhVuc, String vanDeLienQuan,
			long idDoQuanTrong, long idTrangThaiHSCV, String tomTatNoiDung,
			String hoatDong, boolean andOperator) throws SystemException {

		return pmlHoSoCongViecFinder.countByS_T_N_I_V_I_I_T_U_H(userId,
				soHieuHSCV, tieuDe, ngayMoHSCV, idLinhVuc, vanDeLienQuan,
				idDoQuanTrong, idTrangThaiHSCV, tomTatNoiDung, hoatDong,
				andOperator);
	}

	public List<PmlHoSoCongViec> search(long userId, String keywords,
			int start, int end, OrderByComparator obc) throws SystemException {

		return pmlHoSoCongViecFinder.findByKeywords(userId, keywords, start,
				end, obc);
	}

	public List<PmlHoSoCongViec> search(long userId, String soHieuHSCV,
			String tieuDe, Date ngayMoHSCV, String idLinhVuc,
			String vanDeLienQuan, long idDoQuanTrong, long idTrangThaiHSCV,
			String tomTatNoiDung, String hoatDong, boolean andOperator,
			int start, int end, OrderByComparator obc) throws SystemException {

		return pmlHoSoCongViecFinder.findByS_T_N_I_V_I_I_T_U_H(userId,
				soHieuHSCV, tieuDe, ngayMoHSCV, idLinhVuc, vanDeLienQuan,
				idDoQuanTrong, idTrangThaiHSCV, tomTatNoiDung, hoatDong,
	...
	public PmlHoSoCongViec addPmlHoSoCongViec(long userId, long idHSCVCha,
			String soHieuHSCV, String tieuDe, int ngayMoHSCVMonth,
			int ngayMoHSCVDay, int ngayMoHSCVYear, int hanXuLyMonth,
			int hanXuLyDay, int hanXuLyYear, String idLinhVuc,
			String vanDeLienQuan, long idDoQuanTrong, long idTinhChat,
			long idTrangThaiHSCV, String tomTatNoiDung, String hoatDong)
			throws PortalException, SystemException {

		// Parse date from inputted values
		Date ngayMoHSCV = PortalUtil.getDate(ngayMoHSCVMonth, ngayMoHSCVDay,
				ngayMoHSCVYear, new PmlHoSoCongViecNgayMoHSCVException());
		Date hanXuLy = PortalUtil.getDate(hanXuLyMonth, hanXuLyDay,
				hanXuLyYear, new PmlHoSoCongViecHanXuLyException());
		...
		PmlHoSoCongViec pmlHoSoCongViec = pmlHoSoCongViecPersistence
				.create(idHoSoCongViec);

		// Set properties value
		pmlHoSoCongViec.setUserId(user.getUserId());
		pmlHoSoCongViec.setIdHSCVCha(idHSCVCha);
		pmlHoSoCongViec.setUserName(user.getLastName().concat(" ")
				+ user.getMiddleName().concat(" ") + user.getFirstName());
	...
	protected void validate(long userId, String soHieuHSCV, String tieuDe,
			Date ngayMoHSCV, Date hanXuLy) throws PortalException,
			SystemException {
		...
		if (Validator.isNull(soHieuHSCV)) {
			...
			List<PmlHoSoCongViec> pmlHSCVSearches = pmlHoSoCongViecPersistence
					.findBySoHieuHSCV(soHieuHSCV);
		...
		// Check hanXuLy
		if (Validator.isNotNull(ngayMoHSCV) && Validator.isNotNull(hanXuLy)
				&& !hanXuLy.after(ngayMoHSCV)) {
			throw new PmlHoSoCongViecHanXuLyException();
		}
	}

	protected void validate(long userId, String soHieuHSCV, String tieuDe,
			Date ngayMoHSCV, Date hanXuLy, long idHoSoCongViec)
			throws PortalException, SystemException {
	...
	public PmlHoSoCongViec updatePmlHoSoCongViec(long idHoSoCongViec,
			...
			String hoatDong) throws PortalException, SystemException {
		...
		PmlHoSoCongViec oldPmlHoSoCongViec = pmlHoSoCongViecPersistence
				.findByPrimaryKey(idHoSoCongViec);

		// Updated properties
		oldPmlHoSoCongViec.setUserId(user.getUserId());
		oldPmlHoSoCongViec.setUserName(user.getLastName().concat(" ")
				+ user.getMiddleName().concat(" ") + user.getFirstName());
	...
	public int countByI_S(long idHoSoCongViec, String soHieuHSCV)
			throws SystemException, PortalException {

		return pmlHoSoCongViecFinder.countByI_S(idHoSoCongViec, soHieuHSCV);
	}

	public List<PmlHoSoCongViec> getAll() throws PortalException,
			SystemException {
	...
	public List<PmlHoSoCongViec> getByIdHSCVCha(long idHSCVCha)
	...
	@Override
	public void deletePmlHoSoCongViec(long delPmlHSCVId)
			throws SystemException, PortalException {
		...
		try {
			pmlChiTietHSCVs = PmlChiTietHSCVLocalServiceUtil
					.getByIdHoSoCongViec(delPmlHSCVId);
		} catch (Exception ex) {
			// Do nothing
		}
	...
	public void expirePmlHoSoCongViec(long expPmlHSCVId)
		...
		PmlHoSoCongViec expItem = pmlHoSoCongViecPersistence
				.findByPrimaryKey(expPmlHSCVId);
	...
	public List<PmlHoSoCongViec> findByIdDoQuanTrong(long idDoQuanTrong)
		...
		try {
			return pmlHoSoCongViecPersistence
					.findByIdDoQuanTrong(idDoQuanTrong);
		} catch (Exception ex) {
			return null;
		}
	}
	...
	public List<PmlHoSoCongViec> findByIdTrangThaiHSCV(long idTrangThaiHSCV)
		...
		try {
			return pmlHoSoCongViecPersistence
					.findByIdTrangThaiHSCV(idTrangThaiHSCV);
		} catch (Exception ex) {
			return null;
		}
	}

	public int findByHSCVIdTrangThaiHSCV(String idTrangThaiHSCV)
			throws SystemException {
		int count = 0;
		try {
			...
			if (idTrangThaiHSCVList.length > 0) {
				...
				count = pmlHoSoCongViecFinder
						.countByID_T_T_HSCV(idTrangThaiHSCVs);
				return count;
			}
	...
	public int findByHSCVIdDoQuanTrong(String idDoQuanTrong)
			throws SystemException {
		int count = 0;
		try {
