...
import com.sgs.portlet.onedoorpcccprocess.SearchIsDelegated.PmlOneDoorReceiveFileSearchIsDelegated;
import com.sgs.portlet.onedoorpcccprocess.search.PmlOneDoorReceiveFileSearch;
import com.sgs.portlet.onedoorpcccprocess.searchDelegated.PmlOneDoorReceiveFileSearchDelegated;
...
public class ViewAction extends OneDoorProcessPortletAction {
	...
	public void processStrutsAction(ActionMapping mapping, ActionForm form,
		...
		// phmphuc them 06/05/2010 - lay danh sach ho so xu ly tuong ung
		// get current user
	...
	public ActionForward renderStruts(ActionMapping mapping, ActionForm form,
		...
		portletURL.setParameter("struts_action", "/sgs/onedoorpcccprocess/view");
		...
		portletURLChuaNhan.setParameter("struts_action", "/sgs/onedoorpcccprocess/view");
		...
		portletURLCanXLTrongNgay.setParameter("struts_action", "/sgs/onedoorpcccprocess/view");
		...
		portletURLTreHan.setParameter("struts_action", "/sgs/onedoorpcccprocess/view");
		...
		portletURLBoSung.setParameter("struts_action", "/sgs/onedoorpcccprocess/view");
		...
		portletURLDelegated.setParameter("struts_action", "/sgs/onedoorpcccprocess/view");
		...
		portletURLIsDelegated.setParameter("struts_action", "/sgs/onedoorpcccprocess/view");
