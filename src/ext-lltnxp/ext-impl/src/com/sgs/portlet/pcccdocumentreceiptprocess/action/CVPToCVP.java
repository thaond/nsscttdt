 ...
 *
 */
public class CVPToCVP extends DocumentReceiptPortletAction {
	private static Log _log = LogFactory.getLog(CVPToCVP.class);
...
//		addWorkflowParameter(req, "processor",  WorkflowParam.TRANSIENT, String.valueOf(PortalUtil.getUserId(req)));
	...
	public ActionForward renderStruts(ActionMapping mapping, ActionForm arg1,
		...
		return mapping.findForward("portlet.sgs.pcccdocumentreceiptprocess.cvptocvp");
	}
