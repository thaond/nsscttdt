...
public abstract class LoaiVanBanNoiBoLocalServiceBaseImpl
    implements LoaiVanBanNoiBoLocalService {
    ...
    public LoaiVanBanNoiBo addLoaiVanBanNoiBo(LoaiVanBanNoiBo loaiVanBanNoiBo)
        throws SystemException {
        loaiVanBanNoiBo.setNew(true);

        return loaiVanBanNoiBoPersistence.update(loaiVanBanNoiBo, false);
    }

    public LoaiVanBanNoiBo createLoaiVanBanNoiBo(long loaiVanBanNoiBoId) {
        return loaiVanBanNoiBoPersistence.create(loaiVanBanNoiBoId);
    }

    public void deleteLoaiVanBanNoiBo(long loaiVanBanNoiBoId)
        throws PortalException, SystemException {
        loaiVanBanNoiBoPersistence.remove(loaiVanBanNoiBoId);
    }

    public void deleteLoaiVanBanNoiBo(LoaiVanBanNoiBo loaiVanBanNoiBo)
        throws SystemException {
        loaiVanBanNoiBoPersistence.remove(loaiVanBanNoiBo);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return loaiVanBanNoiBoPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public LoaiVanBanNoiBo getLoaiVanBanNoiBo(long loaiVanBanNoiBoId)
        throws PortalException, SystemException {
        return loaiVanBanNoiBoPersistence.findByPrimaryKey(loaiVanBanNoiBoId);
    }

    public List<LoaiVanBanNoiBo> getLoaiVanBanNoiBos(int start, int end)
        throws SystemException {
        return loaiVanBanNoiBoPersistence.findAll(start, end);
    }

    public int getLoaiVanBanNoiBosCount() throws SystemException {
        return loaiVanBanNoiBoPersistence.countAll();
    }

    public LoaiVanBanNoiBo updateLoaiVanBanNoiBo(
        LoaiVanBanNoiBo loaiVanBanNoiBo) throws SystemException {
        loaiVanBanNoiBo.setNew(false);

        return loaiVanBanNoiBoPersistence.update(loaiVanBanNoiBo, true);
    }
