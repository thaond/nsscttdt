...
public abstract class PmlEdmProcessDocumentReceiptDetailLocalServiceBaseImpl
    implements PmlEdmProcessDocumentReceiptDetailLocalService {
    ...
    public PmlEdmProcessDocumentReceiptDetail addPmlEdmProcessDocumentReceiptDetail(
        PmlEdmProcessDocumentReceiptDetail pmlEdmProcessDocumentReceiptDetail)
        throws SystemException {
        pmlEdmProcessDocumentReceiptDetail.setNew(true);

        return pmlEdmProcessDocumentReceiptDetailPersistence.update(pmlEdmProcessDocumentReceiptDetail,
            false);
    }

    public PmlEdmProcessDocumentReceiptDetail createPmlEdmProcessDocumentReceiptDetail(
        long id) {
        return pmlEdmProcessDocumentReceiptDetailPersistence.create(id);
    }

    public void deletePmlEdmProcessDocumentReceiptDetail(long id)
        throws PortalException, SystemException {
        pmlEdmProcessDocumentReceiptDetailPersistence.remove(id);
    }

    public void deletePmlEdmProcessDocumentReceiptDetail(
        PmlEdmProcessDocumentReceiptDetail pmlEdmProcessDocumentReceiptDetail)
        throws SystemException {
        pmlEdmProcessDocumentReceiptDetailPersistence.remove(pmlEdmProcessDocumentReceiptDetail);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlEdmProcessDocumentReceiptDetailPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlEdmProcessDocumentReceiptDetail getPmlEdmProcessDocumentReceiptDetail(
        long id) throws PortalException, SystemException {
        return pmlEdmProcessDocumentReceiptDetailPersistence.findByPrimaryKey(id);
    }

    public List<PmlEdmProcessDocumentReceiptDetail> getPmlEdmProcessDocumentReceiptDetails(
        int start, int end) throws SystemException {
        return pmlEdmProcessDocumentReceiptDetailPersistence.findAll(start, end);
    }

    public int getPmlEdmProcessDocumentReceiptDetailsCount()
        throws SystemException {
        return pmlEdmProcessDocumentReceiptDetailPersistence.countAll();
    }

    public PmlEdmProcessDocumentReceiptDetail updatePmlEdmProcessDocumentReceiptDetail(
        PmlEdmProcessDocumentReceiptDetail pmlEdmProcessDocumentReceiptDetail)
        throws SystemException {
