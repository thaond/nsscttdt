...
public abstract class PmlEdmDocumentReceiptTempLocalServiceBaseImpl
    implements PmlEdmDocumentReceiptTempLocalService {
    ...
    public PmlEdmDocumentReceiptTemp addPmlEdmDocumentReceiptTemp(
        PmlEdmDocumentReceiptTemp pmlEdmDocumentReceiptTemp)
        throws SystemException {
        pmlEdmDocumentReceiptTemp.setNew(true);

        return pmlEdmDocumentReceiptTempPersistence.update(pmlEdmDocumentReceiptTemp,
            false);
    }

    public PmlEdmDocumentReceiptTemp createPmlEdmDocumentReceiptTemp(
        long documentReceiptId) {
        return pmlEdmDocumentReceiptTempPersistence.create(documentReceiptId);
    }

    public void deletePmlEdmDocumentReceiptTemp(long documentReceiptId)
        throws PortalException, SystemException {
        pmlEdmDocumentReceiptTempPersistence.remove(documentReceiptId);
    }

    public void deletePmlEdmDocumentReceiptTemp(
        PmlEdmDocumentReceiptTemp pmlEdmDocumentReceiptTemp)
        throws SystemException {
        pmlEdmDocumentReceiptTempPersistence.remove(pmlEdmDocumentReceiptTemp);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlEdmDocumentReceiptTempPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlEdmDocumentReceiptTemp getPmlEdmDocumentReceiptTemp(
        long documentReceiptId) throws PortalException, SystemException {
        return pmlEdmDocumentReceiptTempPersistence.findByPrimaryKey(documentReceiptId);
    }

    public List<PmlEdmDocumentReceiptTemp> getPmlEdmDocumentReceiptTemps(
        int start, int end) throws SystemException {
        return pmlEdmDocumentReceiptTempPersistence.findAll(start, end);
    }

    public int getPmlEdmDocumentReceiptTempsCount() throws SystemException {
        return pmlEdmDocumentReceiptTempPersistence.countAll();
    }

    public PmlEdmDocumentReceiptTemp updatePmlEdmDocumentReceiptTemp(
        PmlEdmDocumentReceiptTemp pmlEdmDocumentReceiptTemp)
        throws SystemException {
