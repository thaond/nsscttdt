...
public abstract class PmlEdmLevelSendDetailLocalServiceBaseImpl
    implements PmlEdmLevelSendDetailLocalService {
    ...
    public PmlEdmLevelSendDetail addPmlEdmLevelSendDetail(
        PmlEdmLevelSendDetail pmlEdmLevelSendDetail) throws SystemException {
        pmlEdmLevelSendDetail.setNew(true);

        return pmlEdmLevelSendDetailPersistence.update(pmlEdmLevelSendDetail,
            false);
    }

    public PmlEdmLevelSendDetail createPmlEdmLevelSendDetail(
        PmlEdmLevelSendDetailPK pmlEdmLevelSendDetailPK) {
        return pmlEdmLevelSendDetailPersistence.create(pmlEdmLevelSendDetailPK);
    }

    public void deletePmlEdmLevelSendDetail(
        PmlEdmLevelSendDetailPK pmlEdmLevelSendDetailPK)
        throws PortalException, SystemException {
        pmlEdmLevelSendDetailPersistence.remove(pmlEdmLevelSendDetailPK);
    }

    public void deletePmlEdmLevelSendDetail(
        PmlEdmLevelSendDetail pmlEdmLevelSendDetail) throws SystemException {
        pmlEdmLevelSendDetailPersistence.remove(pmlEdmLevelSendDetail);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlEdmLevelSendDetailPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlEdmLevelSendDetail getPmlEdmLevelSendDetail(
        PmlEdmLevelSendDetailPK pmlEdmLevelSendDetailPK)
        throws PortalException, SystemException {
        return pmlEdmLevelSendDetailPersistence.findByPrimaryKey(pmlEdmLevelSendDetailPK);
    }

    public List<PmlEdmLevelSendDetail> getPmlEdmLevelSendDetails(int start,
        int end) throws SystemException {
        return pmlEdmLevelSendDetailPersistence.findAll(start, end);
    }

    public int getPmlEdmLevelSendDetailsCount() throws SystemException {
        return pmlEdmLevelSendDetailPersistence.countAll();
    }

    public PmlEdmLevelSendDetail updatePmlEdmLevelSendDetail(
        PmlEdmLevelSendDetail pmlEdmLevelSendDetail) throws SystemException {
