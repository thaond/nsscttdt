...
public abstract class PmlDocumentSendLogLocalServiceBaseImpl
    implements PmlDocumentSendLogLocalService {
    ...
    public PmlDocumentSendLog addPmlDocumentSendLog(
        PmlDocumentSendLog pmlDocumentSendLog) throws SystemException {
        pmlDocumentSendLog.setNew(true);

        return pmlDocumentSendLogPersistence.update(pmlDocumentSendLog, false);
    }

    public PmlDocumentSendLog createPmlDocumentSendLog(long documentSendLogId) {
        return pmlDocumentSendLogPersistence.create(documentSendLogId);
    }

    public void deletePmlDocumentSendLog(long documentSendLogId)
        throws PortalException, SystemException {
        pmlDocumentSendLogPersistence.remove(documentSendLogId);
    }

    public void deletePmlDocumentSendLog(PmlDocumentSendLog pmlDocumentSendLog)
        throws SystemException {
        pmlDocumentSendLogPersistence.remove(pmlDocumentSendLog);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlDocumentSendLogPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlDocumentSendLog getPmlDocumentSendLog(long documentSendLogId)
        throws PortalException, SystemException {
        return pmlDocumentSendLogPersistence.findByPrimaryKey(documentSendLogId);
    }

    public List<PmlDocumentSendLog> getPmlDocumentSendLogs(int start, int end)
        throws SystemException {
        return pmlDocumentSendLogPersistence.findAll(start, end);
    }

    public int getPmlDocumentSendLogsCount() throws SystemException {
        return pmlDocumentSendLogPersistence.countAll();
    }

    public PmlDocumentSendLog updatePmlDocumentSendLog(
        PmlDocumentSendLog pmlDocumentSendLog) throws SystemException {
        pmlDocumentSendLog.setNew(false);

        return pmlDocumentSendLogPersistence.update(pmlDocumentSendLog, true);
    }
