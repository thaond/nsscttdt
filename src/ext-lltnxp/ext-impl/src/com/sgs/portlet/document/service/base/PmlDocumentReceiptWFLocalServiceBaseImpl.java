...
public abstract class PmlDocumentReceiptWFLocalServiceBaseImpl
    implements PmlDocumentReceiptWFLocalService {
    ...
    public PmlDocumentReceiptWF addPmlDocumentReceiptWF(
        PmlDocumentReceiptWF pmlDocumentReceiptWF) throws SystemException {
        pmlDocumentReceiptWF.setNew(true);

        return pmlDocumentReceiptWFPersistence.update(pmlDocumentReceiptWF,
            false);
    }

    public PmlDocumentReceiptWF createPmlDocumentReceiptWF(long processId) {
        return pmlDocumentReceiptWFPersistence.create(processId);
    }

    public void deletePmlDocumentReceiptWF(long processId)
        throws PortalException, SystemException {
        pmlDocumentReceiptWFPersistence.remove(processId);
    }

    public void deletePmlDocumentReceiptWF(
        PmlDocumentReceiptWF pmlDocumentReceiptWF) throws SystemException {
        pmlDocumentReceiptWFPersistence.remove(pmlDocumentReceiptWF);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlDocumentReceiptWFPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlDocumentReceiptWF getPmlDocumentReceiptWF(long processId)
        throws PortalException, SystemException {
        return pmlDocumentReceiptWFPersistence.findByPrimaryKey(processId);
    }

    public List<PmlDocumentReceiptWF> getPmlDocumentReceiptWFs(int start,
        int end) throws SystemException {
        return pmlDocumentReceiptWFPersistence.findAll(start, end);
    }

    public int getPmlDocumentReceiptWFsCount() throws SystemException {
        return pmlDocumentReceiptWFPersistence.countAll();
    }

    public PmlDocumentReceiptWF updatePmlDocumentReceiptWF(
        PmlDocumentReceiptWF pmlDocumentReceiptWF) throws SystemException {
        pmlDocumentReceiptWF.setNew(false);

        return pmlDocumentReceiptWFPersistence.update(pmlDocumentReceiptWF, true);
    }
