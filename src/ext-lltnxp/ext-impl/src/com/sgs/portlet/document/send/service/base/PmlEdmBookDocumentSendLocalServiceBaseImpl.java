...
public abstract class PmlEdmBookDocumentSendLocalServiceBaseImpl
    implements PmlEdmBookDocumentSendLocalService {
    ...
    public PmlEdmBookDocumentSend addPmlEdmBookDocumentSend(
        PmlEdmBookDocumentSend pmlEdmBookDocumentSend)
        throws SystemException {
        pmlEdmBookDocumentSend.setNew(true);

        return pmlEdmBookDocumentSendPersistence.update(pmlEdmBookDocumentSend,
            false);
    }

    public PmlEdmBookDocumentSend createPmlEdmBookDocumentSend(
        long bookDocumentSendId) {
        return pmlEdmBookDocumentSendPersistence.create(bookDocumentSendId);
    }
    ...
    public void deletePmlEdmBookDocumentSend(
        PmlEdmBookDocumentSend pmlEdmBookDocumentSend)
        throws SystemException {
        pmlEdmBookDocumentSendPersistence.remove(pmlEdmBookDocumentSend);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlEdmBookDocumentSendPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlEdmBookDocumentSend getPmlEdmBookDocumentSend(
        long bookDocumentSendId) throws PortalException, SystemException {
        return pmlEdmBookDocumentSendPersistence.findByPrimaryKey(bookDocumentSendId);
    }

    public List<PmlEdmBookDocumentSend> getPmlEdmBookDocumentSends(int start,
        int end) throws SystemException {
        return pmlEdmBookDocumentSendPersistence.findAll(start, end);
    }

    public int getPmlEdmBookDocumentSendsCount() throws SystemException {
        return pmlEdmBookDocumentSendPersistence.countAll();
    }

    public PmlEdmBookDocumentSend updatePmlEdmBookDocumentSend(
        PmlEdmBookDocumentSend pmlEdmBookDocumentSend)
        throws SystemException {
