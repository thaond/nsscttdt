...
import com.sgs.portlet.document.receipt.model.PmlEdmDocumentReceiptSoap;
...
/**
 * <a href="PmlEdmDocumentReceiptModelImpl.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 * <p>
 * This class is a model that represents the <code>PmlEdmDocumentReceipt</code> table
 * in the database.
 * </p>
 *
 ...
 * @see com.sgs.portlet.document.receipt.model.PmlEdmDocumentReceiptModel
 * @see com.sgs.portlet.document.receipt.model.impl.PmlEdmDocumentReceiptImpl
 *
 */
public class PmlEdmDocumentReceiptModelImpl extends BaseModelImpl {
    public static final String TABLE_NAME = "pml_edm_documentreceipt";
    ...
    public PmlEdmDocumentReceiptModelImpl() {
    }

    public static PmlEdmDocumentReceipt toModel(
        PmlEdmDocumentReceiptSoap soapModel) {
        PmlEdmDocumentReceipt model = new PmlEdmDocumentReceiptImpl();
        ...
        model.setDocReceiptTempId(soapModel.getDocReceiptTempId());
        model.setDocumentRecordTypeId(soapModel.getDocumentRecordTypeId());
        model.setDonViSaoY(soapModel.getDonViSaoY());

        return model;
    }

    public static List<PmlEdmDocumentReceipt> toModels(
        PmlEdmDocumentReceiptSoap[] soapModels) {
        List<PmlEdmDocumentReceipt> models = new ArrayList<PmlEdmDocumentReceipt>(soapModels.length);

        for (PmlEdmDocumentReceiptSoap soapModel : soapModels) {
    ...
    public void setDocReceiptTempId(long docReceiptTempId) {
        if (docReceiptTempId != _docReceiptTempId) {
    ...
    public String getDonViSaoY() {
        return GetterUtil.getString(_donViSaoY);
    }

    public void setDonViSaoY(String donViSaoY) {
        if (((donViSaoY == null) && (_donViSaoY != null)) ||
                ((donViSaoY != null) && (_donViSaoY == null)) ||
                ((donViSaoY != null) && (_donViSaoY != null) &&
                !donViSaoY.equals(_donViSaoY))) {
    ...
    public PmlEdmDocumentReceipt toEscapedModel() {
        if (isEscapedModel()) {
            return (PmlEdmDocumentReceipt) this;
        } else {
            PmlEdmDocumentReceipt model = new PmlEdmDocumentReceiptImpl();
            ...
            model.setDocReceiptTempId(getDocReceiptTempId());
            model.setDocumentRecordTypeId(getDocumentRecordTypeId());
            model.setDonViSaoY(HtmlUtil.escape(getDonViSaoY()));

            model = (PmlEdmDocumentReceipt) Proxy.newProxyInstance(PmlEdmDocumentReceipt.class.getClassLoader(),
                    new Class[] { PmlEdmDocumentReceipt.class },
    ...
    public Object clone() {
        PmlEdmDocumentReceiptImpl clone = new PmlEdmDocumentReceiptImpl();
        ...
        clone.setDocReceiptTempId(getDocReceiptTempId());
        clone.setDocumentRecordTypeId(getDocumentRecordTypeId());
        clone.setDonViSaoY(getDonViSaoY());
    ...
    public int compareTo(Object obj) {
        ...
        PmlEdmDocumentReceiptImpl pmlEdmDocumentReceipt = (PmlEdmDocumentReceiptImpl) obj;

        long pk = pmlEdmDocumentReceipt.getPrimaryKey();
    ...
    public boolean equals(Object obj) {
        ...
        PmlEdmDocumentReceiptImpl pmlEdmDocumentReceipt = null;

        try {
            pmlEdmDocumentReceipt = (PmlEdmDocumentReceiptImpl) obj;
