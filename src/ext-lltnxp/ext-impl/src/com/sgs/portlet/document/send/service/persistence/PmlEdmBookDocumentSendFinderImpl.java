...
public class PmlEdmBookDocumentSendFinderImpl extends BasePersistenceImpl implements PmlEdmBookDocumentSendFinder{
	public static String FIND_BY_LOAI_SO = PmlEdmBookDocumentSendFinder.class.getName() + ".findBy_LOAI_SO";
	public static String COUNT_BY_LOAI_SO = PmlEdmBookDocumentSendFinder.class.getName() + ".countBy_LOAI_SO";
	public static String FIND_BY_LOAI_PB = PmlEdmBookDocumentSendFinder.class.getName() + ".findBy_LOAI_PB";
	public static String COUNT_BY_LOAI_PB = PmlEdmBookDocumentSendFinder.class.getName() + ".countBy_LOAI_PB";
	
	/**
	 * SO CONG VAN DEN CUA SO
	 */
	public List<PmlEdmBookDocumentSend> findByKeywords(String keywords,int start, int end, OrderByComparator obc) throws SystemException{
	...
	public List<PmlEdmBookDocumentSend> findDocumentRecordToAgency(String loaiSoCVs, String so, boolean andOperator, int start, int end, OrderByComparator obc) throws SystemException {
	...
	public List<PmlEdmBookDocumentSend> findDocumentRecordToAgency(String[] loaiSoCVs, String[] so, boolean andOperator, int start, int end, OrderByComparator obc) throws SystemException {
		...
		try {
			...
			q.addEntity("pml_edm_bookdocumentsend", PmlEdmBookDocumentSendImpl.class);
			
			QueryPos qpos = QueryPos.getInstance(q);
			qpos.add(loaiSoCVs,2);
			qpos.add(so,2);
			 
			return (List<PmlEdmBookDocumentSend>) QueryUtil.list(q, getDialect(), start, end);
		} catch (Exception e) {
	 ...
	 */
	public List<PmlEdmBookDocumentSend> findByKeywordsPB(String keywords,int start, int end, OrderByComparator obc) throws SystemException{
		String[] loaiSoCVs = null;
	...
	public List<PmlEdmBookDocumentSend> findDocumentRecordToDepartment(String loaiSoCVs, String phongBan, boolean andOperator, int start, int end, OrderByComparator obc) throws SystemException {
