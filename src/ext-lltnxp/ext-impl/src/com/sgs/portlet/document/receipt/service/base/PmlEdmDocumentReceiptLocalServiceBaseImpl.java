...
public abstract class PmlEdmDocumentReceiptLocalServiceBaseImpl
    implements PmlEdmDocumentReceiptLocalService {
    ...
    public PmlEdmDocumentReceipt addPmlEdmDocumentReceipt(
        ...
        return pmlEdmDocumentReceiptPersistence.update(pmlEdmDocumentReceipt,
            false);
    }

    public PmlEdmDocumentReceipt createPmlEdmDocumentReceipt(
        long documentReceiptId) {
        return pmlEdmDocumentReceiptPersistence.create(documentReceiptId);
    }
    ...
    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return pmlEdmDocumentReceiptPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlEdmDocumentReceipt getPmlEdmDocumentReceipt(
        long documentReceiptId) throws PortalException, SystemException {
        return pmlEdmDocumentReceiptPersistence.findByPrimaryKey(documentReceiptId);
    }

    public List<PmlEdmDocumentReceipt> getPmlEdmDocumentReceipts(int start,
        int end) throws SystemException {
        return pmlEdmDocumentReceiptPersistence.findAll(start, end);
    }

    public int getPmlEdmDocumentReceiptsCount() throws SystemException {
        return pmlEdmDocumentReceiptPersistence.countAll();
    }

    public PmlEdmDocumentReceipt updatePmlEdmDocumentReceipt(
        PmlEdmDocumentReceipt pmlEdmDocumentReceipt) throws SystemException {
