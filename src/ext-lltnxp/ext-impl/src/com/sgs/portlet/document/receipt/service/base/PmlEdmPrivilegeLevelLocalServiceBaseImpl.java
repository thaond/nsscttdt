...
public abstract class PmlEdmPrivilegeLevelLocalServiceBaseImpl
    implements PmlEdmPrivilegeLevelLocalService {
    ...
    public PmlEdmPrivilegeLevel addPmlEdmPrivilegeLevel(
        PmlEdmPrivilegeLevel pmlEdmPrivilegeLevel) throws SystemException {
        pmlEdmPrivilegeLevel.setNew(true);

        return pmlEdmPrivilegeLevelPersistence.update(pmlEdmPrivilegeLevel,
            false);
    }

    public PmlEdmPrivilegeLevel createPmlEdmPrivilegeLevel(
        String privilegeLevelId) {
        return pmlEdmPrivilegeLevelPersistence.create(privilegeLevelId);
    }

    public void deletePmlEdmPrivilegeLevel(String privilegeLevelId)
    ...
    public void deletePmlEdmPrivilegeLevel(
        PmlEdmPrivilegeLevel pmlEdmPrivilegeLevel) throws SystemException {
        pmlEdmPrivilegeLevelPersistence.remove(pmlEdmPrivilegeLevel);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlEdmPrivilegeLevelPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlEdmPrivilegeLevel getPmlEdmPrivilegeLevel(String privilegeLevelId)
        throws PortalException, SystemException {
        return pmlEdmPrivilegeLevelPersistence.findByPrimaryKey(privilegeLevelId);
    }

    public List<PmlEdmPrivilegeLevel> getPmlEdmPrivilegeLevels(int start,
        int end) throws SystemException {
        return pmlEdmPrivilegeLevelPersistence.findAll(start, end);
    }

    public int getPmlEdmPrivilegeLevelsCount() throws SystemException {
        return pmlEdmPrivilegeLevelPersistence.countAll();
    }

    public PmlEdmPrivilegeLevel updatePmlEdmPrivilegeLevel(
        PmlEdmPrivilegeLevel pmlEdmPrivilegeLevel) throws SystemException {
        pmlEdmPrivilegeLevel.setNew(false);

        return pmlEdmPrivilegeLevelPersistence.update(pmlEdmPrivilegeLevel, true);
    }
