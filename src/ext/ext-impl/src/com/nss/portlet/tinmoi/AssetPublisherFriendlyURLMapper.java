package com.nss.portlet.tinmoi;
...
public class AssetPublisherFriendlyURLMapper extends BaseFriendlyURLMapper {
	...
	public String buildPath(LiferayPortletURL portletURL) {
		...
		if ((strutsAction.equals("/nss/tinmoi/view_content"))  &&
			((windowState == null) ||
			...
			if (Validator.isNotNull(portletId) &&
				...
				friendlyURLPath =
					"/nss/tinmoi/" + instanceId + StringPool.SLASH + type +
						StringPool.SLASH;
		...
		if (urlFragments.length > 2) {
		   ...
		   if (Validator.equals(portletId, _PORTLET_ID)) {
			...
			params.put(
				...
				new String[] {"/nss/tinmoi/view_content"});
	...
	private static final String _MAPPING = "tinmoi";
