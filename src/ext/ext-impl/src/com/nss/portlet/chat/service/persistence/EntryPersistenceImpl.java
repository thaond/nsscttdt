...
import com.nss.portlet.chat.NoSuchEntryException;
import com.nss.portlet.chat.model.Entry;
import com.nss.portlet.chat.model.impl.EntryImpl;
import com.nss.portlet.chat.model.impl.EntryModelImpl;
...
public class EntryPersistenceImpl extends BasePersistenceImpl
    ...
    public Entry updateImpl(com.nss.portlet.chat.model.Entry entry,
    ...
    public List<Entry> findByCreateDate(long createDate)
        ...
        if (list == null) {
            ...
            try {
                ...
                query.append("FROM com.nss.portlet.chat.model.Entry WHERE ");
    ...
    public List<Entry> findAll(int start, int end, OrderByComparator obc)
        ...
        if (list == null) {
            ...
            try {
                ...
                query.append("FROM com.nss.portlet.chat.model.Entry ");
        ...
        if (count == null) {
            ...
            try {
                ...
                Query q = session.createQuery(
                        "SELECT COUNT(*) FROM com.nss.portlet.chat.model.Entry");
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.portal.util.PropsUtil.get(
                        "value.object.listener.com.nss.portlet.chat.model.Entry")));
