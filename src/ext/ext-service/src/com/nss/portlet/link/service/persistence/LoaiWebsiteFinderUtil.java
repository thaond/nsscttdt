...
public class LoaiWebsiteFinderUtil {
    private static LoaiWebsiteFinder _finder;
    ...
    public static java.util.List<com.nss.portlet.link.model.LoaiWebsite> findByKeywords(
    ...
    public static java.util.List<com.nss.portlet.link.model.LoaiWebsite> findTEN_MOTA(
    ...
    public static LoaiWebsiteFinder getFinder() {
        return _finder;
    }

    public void setFinder(LoaiWebsiteFinder finder) {
        _finder = finder;
    }
}
