...
<!-- 
<liferay-ui:error exception="<%= ContentCalendarNullException.class %>" message="please-enter-a-valid-content" />
 -->
	...
	<td valign="top">
		...
		<tr>
			...
			<td>
				<table width="100%">
					<tr>
						<td><liferay-ui:message key="all-day" />&nbsp;<liferay-ui:input-checkbox param="allDay" defaultValue="<%= event == null ? false : event.isAllDay() %>" />
						</td>
						<td><liferay-ui:message key="buoi-sang" />&nbsp;<liferay-ui:input-checkbox param="morning" defaultValue="<%= morning %>" />
						</td>
						<td><liferay-ui:message key="buoi-chieu" />&nbsp;<liferay-ui:input-checkbox param="afternoon" defaultValue="<%= afternoon %>" />
						</td>
<!-- Trieu add 20091026 						
						<td><liferay-ui:message key="buoi-toi" />&nbsp;<liferay-ui:input-checkbox param="evening" defaultValue="<%= evening %>" />
 -->
						</td>
					</tr>
				</table>
	...
	<liferay-ui:input-editor/>
		...
		<tr style="display: none;">
			<td><liferay-ui:message key="file-upload" /></td>
			<td class="curved-box-css3">
