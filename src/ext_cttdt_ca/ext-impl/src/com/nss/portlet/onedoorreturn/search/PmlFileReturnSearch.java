...
import com.nss.portlet.onedoorreturn.util.PmlFileReturnSearchUtil;
...
public class PmlFileReturnSearch extends SearchContainer<PmlOneDoorReceiveFile> {
	...
	public PmlFileReturnSearch(RenderRequest renderRequest, PortletURL iteratorURL) {
		...
		try {
			...
			OrderByComparator orderByComparator = PmlFileReturnSearchUtil.getPmlFileReturnOrderByComparator(orderByCol, orderByType);
