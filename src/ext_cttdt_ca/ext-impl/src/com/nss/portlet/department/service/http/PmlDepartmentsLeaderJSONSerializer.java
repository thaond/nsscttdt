 ...
 * <code>com.nss.portlet.department.service.http.PmlDepartmentsLeaderServiceJSON</code>
 * to translate objects.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.nss.portlet.department.service.http.PmlDepartmentsLeaderServiceJSON
 *
 */
public class PmlDepartmentsLeaderJSONSerializer {
    ...
    public static JSONArray toJSONArray(
        com.nss.portlet.department.model.PmlDepartmentsLeader[] models) {
    ...
    public static JSONArray toJSONArray(
        List<com.nss.portlet.department.model.PmlDepartmentsLeader> models) {
        JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
