 ...
 * <code>com.nss.portlet.attachedfile.service.http.AttachedFileServiceJSON</code>
 * to translate objects.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.nss.portlet.attachedfile.service.http.AttachedFileServiceJSON
 *
 */
public class AttachedFileJSONSerializer {
    ...
    public static JSONArray toJSONArray(
        com.nss.portlet.attachedfile.model.AttachedFile[] models) {
    ...
    public static JSONArray toJSONArray(
        List<com.nss.portlet.attachedfile.model.AttachedFile> models) {
        JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
