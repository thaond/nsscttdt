package com.nss.portlet.agency.service.impl;
...
import com.nss.portlet.agency.service.base.AgencyLocalServiceBaseImpl;
...
public class AgencyLocalServiceImpl extends AgencyLocalServiceBaseImpl {
	...
	public void removeAgency(String agencyId) throws SystemException, PortalException {
		...
		try {
			pmlDepartmentList = DepartmentLocalServiceUtil.findByAgencyId(agencyId);
		} catch (Exception e) {
	...
	public Agency addAgency(String agencyCode, String agencyName, String description, 
		...
		String agencyId = "";
		agencyId = IdTemplateLocalServiceUtil.generatedId(Agency.class);
