 ...
 * <code>com.nss.portlet.onedoor.service.PmlFileStatusLocalService</code>
 ...
 *
 * @see com.nss.portlet.onedoor.service.PmlFileStatusLocalService
 *
 */
public class PmlFileStatusLocalServiceUtil {
    private static PmlFileStatusLocalService _service;

    public static com.nss.portlet.onedoor.model.PmlFileStatus addPmlFileStatus(
        com.nss.portlet.onedoor.model.PmlFileStatus pmlFileStatus)
        throws com.liferay.portal.SystemException {
        return getService().addPmlFileStatus(pmlFileStatus);
    }

    public static com.nss.portlet.onedoor.model.PmlFileStatus createPmlFileStatus(
        long fileStatusId) {
    ...
    public static com.nss.portlet.onedoor.model.PmlFileStatus getPmlFileStatus(
        long fileStatusId)
        throws com.liferay.portal.PortalException,
            com.liferay.portal.SystemException {
    ...
    public static java.util.List<com.nss.portlet.onedoor.model.PmlFileStatus> getPmlFileStatuses(
    ...
    public static com.nss.portlet.onedoor.model.PmlFileStatus updatePmlFileStatus(
        com.nss.portlet.onedoor.model.PmlFileStatus pmlFileStatus)
        throws com.liferay.portal.SystemException {
    ...
    public static com.nss.portlet.onedoor.model.PmlFileStatus updatePmlFileStatus(
        ...
        throws com.liferay.portal.SystemException {
        return getService().updatePmlFileStatus(pmlFileStatus, merge);
    }

    public static com.nss.portlet.onedoor.model.PmlFileStatus addFileStatus(
    ...
    public static com.nss.portlet.onedoor.model.PmlFileStatus updateFileStatus(
    ...
    public static java.util.List<com.nss.portlet.onedoor.model.PmlFileStatus> searchMC(
