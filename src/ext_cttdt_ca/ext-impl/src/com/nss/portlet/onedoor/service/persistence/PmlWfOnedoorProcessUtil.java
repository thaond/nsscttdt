...
public class PmlWfOnedoorProcessUtil {
    ...
    public static void cacheResult(
        ...
        getPersistence().cacheResult(pmlWfOnedoorProcess);
    }

    public static void cacheResult(
        java.util.List<com.nss.portlet.onedoor.model.PmlWfOnedoorProcess> pmlWfOnedoorProcesses) {
        getPersistence().cacheResult(pmlWfOnedoorProcesses);
    }
    ...
    public static com.nss.portlet.onedoor.model.PmlWfOnedoorProcess create(
        java.lang.String fileId) {
        return getPersistence().create(fileId);
    }

    public static com.nss.portlet.onedoor.model.PmlWfOnedoorProcess remove(
        java.lang.String fileId)
     ...
     */
    public static com.nss.portlet.onedoor.model.PmlWfOnedoorProcess update(
        com.nss.portlet.onedoor.model.PmlWfOnedoorProcess pmlWfOnedoorProcess)
        throws com.liferay.portal.SystemException {
    ...
    public static com.nss.portlet.onedoor.model.PmlWfOnedoorProcess updateImpl(
        com.nss.portlet.onedoor.model.PmlWfOnedoorProcess pmlWfOnedoorProcess,
        boolean merge) throws com.liferay.portal.SystemException {
        return getPersistence().updateImpl(pmlWfOnedoorProcess, merge);
    }

    public static com.nss.portlet.onedoor.model.PmlWfOnedoorProcess findByPrimaryKey(
        java.lang.String fileId)
        throws com.liferay.portal.SystemException,
            com.nss.portlet.onedoor.NoSuchPmlWfOnedoorProcessException {
    ...
    public static com.nss.portlet.onedoor.model.PmlWfOnedoorProcess fetchByPrimaryKey(
        java.lang.String fileId) throws com.liferay.portal.SystemException {
        return getPersistence().fetchByPrimaryKey(fileId);
    }

    public static java.util.List<com.nss.portlet.onedoor.model.PmlWfOnedoorProcess> findByProcessId(
    ...
    public static com.nss.portlet.onedoor.model.PmlWfOnedoorProcess findByProcessId_First(
    ...
    public static com.nss.portlet.onedoor.model.PmlWfOnedoorProcess findByProcessId_Last(
        long processId, com.liferay.portal.kernel.util.OrderByComparator obc)
        throws com.liferay.portal.SystemException,
            com.nss.portlet.onedoor.NoSuchPmlWfOnedoorProcessException {
    ...
    public static com.nss.portlet.onedoor.model.PmlWfOnedoorProcess[] findByProcessId_PrevAndNext(
    ...
    public static java.util.List<com.nss.portlet.onedoor.model.PmlWfOnedoorProcess> findAll()
        throws com.liferay.portal.SystemException {
