...
public abstract class PmlStateWorkFlowLocalServiceBaseImpl
    implements PmlStateWorkFlowLocalService {
    ...
    public PmlStateWorkFlow addPmlStateWorkFlow(
        PmlStateWorkFlow pmlStateWorkFlow) throws SystemException {
        pmlStateWorkFlow.setNew(true);

        return pmlStateWorkFlowPersistence.update(pmlStateWorkFlow, false);
    }

    public PmlStateWorkFlow createPmlStateWorkFlow(long stateWfId) {
        return pmlStateWorkFlowPersistence.create(stateWfId);
    }

    public void deletePmlStateWorkFlow(long stateWfId)
        throws PortalException, SystemException {
        pmlStateWorkFlowPersistence.remove(stateWfId);
    }

    public void deletePmlStateWorkFlow(PmlStateWorkFlow pmlStateWorkFlow)
        throws SystemException {
        pmlStateWorkFlowPersistence.remove(pmlStateWorkFlow);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlStateWorkFlowPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlStateWorkFlow getPmlStateWorkFlow(long stateWfId)
        throws PortalException, SystemException {
        return pmlStateWorkFlowPersistence.findByPrimaryKey(stateWfId);
    }

    public List<PmlStateWorkFlow> getPmlStateWorkFlows(int start, int end)
        throws SystemException {
        return pmlStateWorkFlowPersistence.findAll(start, end);
    }

    public int getPmlStateWorkFlowsCount() throws SystemException {
        return pmlStateWorkFlowPersistence.countAll();
    }

    public PmlStateWorkFlow updatePmlStateWorkFlow(
        PmlStateWorkFlow pmlStateWorkFlow) throws SystemException {
        pmlStateWorkFlow.setNew(false);

        return pmlStateWorkFlowPersistence.update(pmlStateWorkFlow, true);
    }

    public PmlStateWorkFlow updatePmlStateWorkFlow(
        PmlStateWorkFlow pmlStateWorkFlow, boolean merge)
        throws SystemException {
        pmlStateWorkFlow.setNew(false);

        return pmlStateWorkFlowPersistence.update(pmlStateWorkFlow, merge);
    }
