...
public abstract class PmlFileStatusStateProcessLocalServiceBaseImpl
    implements PmlFileStatusStateProcessLocalService {
    ...
    public PmlFileStatusStateProcess addPmlFileStatusStateProcess(
        PmlFileStatusStateProcess pmlFileStatusStateProcess)
        throws SystemException {
        pmlFileStatusStateProcess.setNew(true);

        return pmlFileStatusStateProcessPersistence.update(pmlFileStatusStateProcess,
            false);
    }

    public PmlFileStatusStateProcess createPmlFileStatusStateProcess(long id) {
        return pmlFileStatusStateProcessPersistence.create(id);
    }

    public void deletePmlFileStatusStateProcess(long id)
        throws PortalException, SystemException {
        pmlFileStatusStateProcessPersistence.remove(id);
    }

    public void deletePmlFileStatusStateProcess(
        PmlFileStatusStateProcess pmlFileStatusStateProcess)
        throws SystemException {
        pmlFileStatusStateProcessPersistence.remove(pmlFileStatusStateProcess);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlFileStatusStateProcessPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlFileStatusStateProcess getPmlFileStatusStateProcess(long id)
        throws PortalException, SystemException {
        return pmlFileStatusStateProcessPersistence.findByPrimaryKey(id);
    }

    public List<PmlFileStatusStateProcess> getPmlFileStatusStateProcesses(
        int start, int end) throws SystemException {
        return pmlFileStatusStateProcessPersistence.findAll(start, end);
    }

    public int getPmlFileStatusStateProcessesCount() throws SystemException {
        return pmlFileStatusStateProcessPersistence.countAll();
    }

    public PmlFileStatusStateProcess updatePmlFileStatusStateProcess(
        PmlFileStatusStateProcess pmlFileStatusStateProcess)
        throws SystemException {
