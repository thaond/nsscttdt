...
public class ViewAction extends PortletAction {
	...
	public void processAction(ActionMapping mapping, ActionForm form,
			...
			throws Exception {
		String redirect = ParamUtil.getString(req, "redirect", "/nss/phone_book_index/view");
	...
	public void addContactBook(ActionRequest req) {
		...
		try {
			...
			_log.error("ERROR IN METHOD addContactBook OF " + ViewAction.class + " " + e.getMessage());
		}
	}
	...
	public void detailContactBook(ActionRequest req,ActionResponse res) {
		...
		try {
			...
			_log.error("ERROR IN METHOD detailContactBook OF " + ViewAction.class + " " + e.getMessage());
		}
	}
	...
	public void editContactBook(ActionRequest req) {
		...
		try {
			...
			_log.error("ERROR IN METHOD editContactBook OF " + ViewAction.class + " " + e.getMessage());
		}
	}
	...
	public void updateContactBook(ActionRequest req, ActionResponse res) {
		...
		try {
			...
			_log.error("ERROR IN METHOD updateContactBook OF " + ViewAction.class + " " + e.getMessage());
		}
	}
	...
	public void deleteContactBook(ActionRequest req, ActionResponse res, String redirect) {
		...
		try {
			...
			_log.error("ERROR IN METHOD deleteContactBook OF " + ViewAction.class + " " + e.getMessage());
		}
	}
	...
	public void updateActiveContactBook(ActionRequest req,ActionResponse res) {
		...
		try {
			...
			_log.error("ERROR IN METHOD updateActiveContactBook OF " + ViewAction.class + " " + e.getMessage());
		}
	}


	public void updateSelect(ActionRequest req, ActionResponse res) {
		long selectContactBook = ParamUtil.getLong(req, "selectContactBook");
		long selectDetailBook = ParamUtil.getLong(req, "selectDetailBook");
		List<DetailBook> detailBooks = new ArrayList<DetailBook>();
		try {
			detailBooks = ContactBookLocalServiceUtil.getDetailBooks(selectContactBook);
			req.setAttribute("detailBooks", detailBooks);
			req.setAttribute("selectContactBook",""+ selectContactBook);
			req.setAttribute("selectDetailBook",""+ selectDetailBook);
		} catch (Exception e) {
			_log.error("ERROR IN METHOD updateSelect OF " + ViewAction.class + " " + e.getMessage());
		}
	}


	public void searchDetail(ActionRequest req, ActionResponse res) {
		String donViCaNhan = ParamUtil.getString(req, "donViCaNhan");
		long selectContactBook = ParamUtil.getLong(req, "selectContactBook");
		long selectDetailBook = ParamUtil.getLong(req, "selectDetailBook");
		List<DetailBook> detailBooks = new ArrayList<DetailBook>();
		try {
			detailBooks = ContactBookLocalServiceUtil.getDetailBooks(selectContactBook);
			req.setAttribute("detailBooks", detailBooks);
			req.setAttribute("donViCaNhan", donViCaNhan);
			req.setAttribute("selectContactBook",""+ selectContactBook);
			req.setAttribute("selectDetailBook",""+ selectDetailBook);
		} catch (Exception e) {
			_log.error("ERROR IN METHOD searchDetail OF " + ViewAction.class + " " + e.getMessage());
		}
	...
	public ActionForward render(ActionMapping mapping, ActionForm form,
		...
		if (getForward(req) != null && !getForward(req).equals("")) {
			...
			return mapping.findForward("portlet.nss.phone_book_index.view");
		}
	}
