...
public class QuangCaoFinderUtil {
    private static QuangCaoFinder _finder;
    ...
    public static java.util.List<com.nss.portlet.adv.model.QuangCao> findTEN_MOTA(
    ...
    public static QuangCaoFinder getFinder() {
        return _finder;
    }

    public void setFinder(QuangCaoFinder finder) {
        _finder = finder;
    }
}
