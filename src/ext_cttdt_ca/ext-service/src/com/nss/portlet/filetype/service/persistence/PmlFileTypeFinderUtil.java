...
public class PmlFileTypeFinderUtil {
    ...
    public static java.util.List<com.nss.portlet.filetype.model.PmlFileType> findByKeywords(
    ...
    public static java.util.List<com.nss.portlet.filetype.model.PmlFileType> findByFileType(
