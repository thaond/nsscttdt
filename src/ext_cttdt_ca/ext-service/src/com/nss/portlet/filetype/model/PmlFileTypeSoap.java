 ...
 * <code>com.nss.portlet.filetype.service.http.PmlFileTypeServiceSoap</code>.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.nss.portlet.filetype.service.http.PmlFileTypeServiceSoap
 *
 */
public class PmlFileTypeSoap implements Serializable {
    ...
    public static PmlFileTypeSoap[] toSoapModels(PmlFileType[] models) {
        PmlFileTypeSoap[] soapModels = new PmlFileTypeSoap[models.length];
    ...
    public static PmlFileTypeSoap[][] toSoapModels(PmlFileType[][] models) {
        PmlFileTypeSoap[][] soapModels = null;

        if (models.length > 0) {
            soapModels = new PmlFileTypeSoap[models.length][models[0].length];
        } else {
            soapModels = new PmlFileTypeSoap[0][0];
        }
