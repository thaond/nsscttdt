 ...
 * <code>com.nss.portlet.onedoor.service.http.PmlProcessDisposeServiceSoap</code>.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.nss.portlet.onedoor.service.http.PmlProcessDisposeServiceSoap
 *
 */
public class PmlProcessDisposeSoap implements Serializable {
    ...
    public static PmlProcessDisposeSoap[] toSoapModels(
        PmlProcessDispose[] models) {
        PmlProcessDisposeSoap[] soapModels = new PmlProcessDisposeSoap[models.length];
    ...
    public static PmlProcessDisposeSoap[][] toSoapModels(
        PmlProcessDispose[][] models) {
        PmlProcessDisposeSoap[][] soapModels = null;

        if (models.length > 0) {
            soapModels = new PmlProcessDisposeSoap[models.length][models[0].length];
        } else {
            soapModels = new PmlProcessDisposeSoap[0][0];
        }
