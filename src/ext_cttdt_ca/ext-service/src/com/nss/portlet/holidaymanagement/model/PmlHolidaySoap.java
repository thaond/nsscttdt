package com.nss.portlet.holidaymanagement.model;
 ...
 * <code>com.nss.portlet.holidaymanagement.service.http.PmlHolidayServiceSoap</code>.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.nss.portlet.holidaymanagement.service.http.PmlHolidayServiceSoap
 *
 */
public class PmlHolidaySoap implements Serializable {
    ...
    public static PmlHolidaySoap[] toSoapModels(PmlHoliday[] models) {
        PmlHolidaySoap[] soapModels = new PmlHolidaySoap[models.length];
    ...
    public static PmlHolidaySoap[][] toSoapModels(PmlHoliday[][] models) {
        PmlHolidaySoap[][] soapModels = null;

        if (models.length > 0) {
            soapModels = new PmlHolidaySoap[models.length][models[0].length];
        } else {
            soapModels = new PmlHolidaySoap[0][0];
        }
