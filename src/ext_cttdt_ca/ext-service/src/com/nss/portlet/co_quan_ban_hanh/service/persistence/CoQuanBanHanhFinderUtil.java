...
public class CoQuanBanHanhFinderUtil {
    private static CoQuanBanHanhFinder _finder;
    ...
    public static java.util.List<com.nss.portlet.co_quan_ban_hanh.model.CoQuanBanHanh> findTEN_MOTA(
    ...
    public static CoQuanBanHanhFinder getFinder() {
        return _finder;
    }

    public void setFinder(CoQuanBanHanhFinder finder) {
        _finder = finder;
    }
}
