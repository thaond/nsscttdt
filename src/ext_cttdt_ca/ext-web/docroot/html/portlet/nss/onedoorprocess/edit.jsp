<%@page import="com.nss.portlet.filetype.service.PmlFileTypeAttachedFileLocalServiceUtil"%>
...
<%@page import="com.nss.portlet.filetype.model.PmlFileAttachedFile"%>
<%@page import="com.nss.portlet.onedoor.model.PmlPaintDocument"%>
<%@page import="com.nss.portlet.onedoor.model.PmlOneDoorReceiveFile"%>
<%@page import="com.nss.portlet.onedoor.model.PmlFilePCCC"%>
...
<%@ include file="/html/portlet/nss/onedoorprocess/js/onedoorpcccprocess-js.jsp" %>
...
<portlet:actionURL var="update">
	<portlet:param name="struts_action" value="/nss/onedoorprocess/update"/>
...
%>
			...
			<logic:iterate id="filePCCCAttachedFile" name="filePCCCAttachedFiles" type="com.nss.portlet.onedoor.model.PmlFilePCCCAttachedFile" indexId="p">
			<tr>
...
<%
	List<PmlFileTypeAttachedFile> pmlFileTypeAttachedFileList = PmlFileTypeAttachedFileLocalServiceUtil.findByFileTypeId(pmlFile.getFileTypeId());
...
%>
		...
		<table id="tbl_DocDrawing" cellspacing="0" width="100%" class="taglib-search-iterator table-pml">
			...
			<logic:iterate id="paintDocument" name="paintDocuments" indexId="i" type="com.nss.portlet.onedoor.model.PmlPaintDocument" scope="request"  >
				<tr class="${((index % 2)==0)? 'results-row':'tr_two results-row'}">
