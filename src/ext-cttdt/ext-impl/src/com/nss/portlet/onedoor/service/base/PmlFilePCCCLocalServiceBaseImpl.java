...
public abstract class PmlFilePCCCLocalServiceBaseImpl
    implements PmlFilePCCCLocalService {
    ...
    public PmlFilePCCC addPmlFilePCCC(PmlFilePCCC pmlFilePCCC)
        throws SystemException {
        pmlFilePCCC.setNew(true);

        return pmlFilePCCCPersistence.update(pmlFilePCCC, false);
    }

    public PmlFilePCCC createPmlFilePCCC(String fileId) {
        return pmlFilePCCCPersistence.create(fileId);
    }

    public void deletePmlFilePCCC(String fileId)
        throws PortalException, SystemException {
        pmlFilePCCCPersistence.remove(fileId);
    }

    public void deletePmlFilePCCC(PmlFilePCCC pmlFilePCCC)
        throws SystemException {
        pmlFilePCCCPersistence.remove(pmlFilePCCC);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlFilePCCCPersistence.findWithDynamicQuery(dynamicQuery);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery, int start,
        int end) throws SystemException {
        return pmlFilePCCCPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }

    public PmlFilePCCC getPmlFilePCCC(String fileId)
        throws PortalException, SystemException {
        return pmlFilePCCCPersistence.findByPrimaryKey(fileId);
    }

    public List<PmlFilePCCC> getPmlFilePCCCs(int start, int end)
        throws SystemException {
        return pmlFilePCCCPersistence.findAll(start, end);
    }

    public int getPmlFilePCCCsCount() throws SystemException {
        return pmlFilePCCCPersistence.countAll();
    }

    public PmlFilePCCC updatePmlFilePCCC(PmlFilePCCC pmlFilePCCC)
        throws SystemException {
        pmlFilePCCC.setNew(false);

        return pmlFilePCCCPersistence.update(pmlFilePCCC, true);
    }

    public PmlFilePCCC updatePmlFilePCCC(PmlFilePCCC pmlFilePCCC, boolean merge)
        throws SystemException {
        pmlFilePCCC.setNew(false);

        return pmlFilePCCCPersistence.update(pmlFilePCCC, merge);
    }
