...
public abstract class PmlStateProcessLocalServiceBaseImpl
    implements PmlStateProcessLocalService {
    ...
    public PmlStateProcess addPmlStateProcess(PmlStateProcess pmlStateProcess)
        throws SystemException {
        pmlStateProcess.setNew(true);

        return pmlStateProcessPersistence.update(pmlStateProcess, false);
    }

    public PmlStateProcess createPmlStateProcess(long stateProcessId) {
        return pmlStateProcessPersistence.create(stateProcessId);
    }

    public void deletePmlStateProcess(long stateProcessId)
        throws PortalException, SystemException {
        pmlStateProcessPersistence.remove(stateProcessId);
    }

    public void deletePmlStateProcess(PmlStateProcess pmlStateProcess)
        throws SystemException {
        pmlStateProcessPersistence.remove(pmlStateProcess);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlStateProcessPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlStateProcess getPmlStateProcess(long stateProcessId)
        throws PortalException, SystemException {
        return pmlStateProcessPersistence.findByPrimaryKey(stateProcessId);
    }

    public List<PmlStateProcess> getPmlStateProcesses(int start, int end)
        throws SystemException {
        return pmlStateProcessPersistence.findAll(start, end);
    }

    public int getPmlStateProcessesCount() throws SystemException {
        return pmlStateProcessPersistence.countAll();
    }

    public PmlStateProcess updatePmlStateProcess(
        PmlStateProcess pmlStateProcess) throws SystemException {
        pmlStateProcess.setNew(false);

        return pmlStateProcessPersistence.update(pmlStateProcess, true);
    }

    public PmlStateProcess updatePmlStateProcess(
        PmlStateProcess pmlStateProcess, boolean merge)
        throws SystemException {
        pmlStateProcess.setNew(false);

        return pmlStateProcessPersistence.update(pmlStateProcess, merge);
    }
