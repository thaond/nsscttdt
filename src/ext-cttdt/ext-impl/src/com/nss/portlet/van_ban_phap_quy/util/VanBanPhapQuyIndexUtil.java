...
public class VanBanPhapQuyIndexUtil implements Runnable {
	
	public VanBanPhapQuyIndexUtil (long companyId) {
	...
	private static Log _log = LogFactoryUtil.getLog(VanBanPhapQuyIndexUtil.class);
