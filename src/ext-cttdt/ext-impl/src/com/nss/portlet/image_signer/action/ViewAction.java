...
public class ViewAction extends PortletAction {
		...
		try {
			...
			if(check==false){
				...
				if (imageIdSign != 0 && imageIdUnSign != 0) {
					System.out.println("add image signer");
				...
				System.out.println("update image signer");
				imageSigner.setImageIdSign(imageIdSign);
				imageSigner.setImageIdUnSign(imageIdUnSign);
			...
			System.out.println("loi upload "+e.getMessage());
			_log.error(e);
		}
	}
	...
	public ActionForward render(ActionMapping mapping, ActionForm form,
		...
		if (getForward(req) != null && !getForward(req).equals("")) {
			...
			return mapping.findForward("portlet.nss.image_signer.view");
		}
	}
