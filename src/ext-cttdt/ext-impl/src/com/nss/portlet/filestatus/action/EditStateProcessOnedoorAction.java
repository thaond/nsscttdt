...
private static final boolean _CHECK_METHOD_ON_PROCESS_ACTION = false;
	...
	public ActionForward render(
		...
		filestatus_stateprocess_list = PmlFileStatusStateProcessLocalServiceUtil.findByFileStatusId(filestatusId);
		...
		return mapping.findForward("portlet.nss.filestatus.display_stateprocess_onedoor");
