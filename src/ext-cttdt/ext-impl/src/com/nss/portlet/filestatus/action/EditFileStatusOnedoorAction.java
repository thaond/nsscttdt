...
public class EditFileStatusOnedoorAction extends PortletAction{
	...
	public void processAction(
		...
		try {
			if (cmd.equals(Constants.UPDATE)) {
				...
				setForward(actionRequest, "portlet.nss.filestatus.view");
			}
			...
			if (e instanceof PmlFileStatusCanNotDeleteException){
				...
				setForward(actionRequest, "portlet.nss.filestatus.edit_filestatus_onedoor");
				SessionErrors.add(actionRequest, e.getClass().getName());
			}
			else {
				throw e;
	...
	public ActionForward render(
		...
		if (getForward(renderRequest) != null && !getForward(renderRequest).equals("")) {
			...
			return mapping.findForward("portlet.nss.filestatus.edit_filestatus_onedoor");
		}
	}
