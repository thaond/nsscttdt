 ...
 * <code>com.nss.portlet.generatetemplateid.service.http.IdGeneratedServiceJSON</code>
 * to translate objects.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.nss.portlet.generatetemplateid.service.http.IdGeneratedServiceJSON
 *
 */
public class IdGeneratedJSONSerializer {
    ...
    public static JSONArray toJSONArray(
        com.nss.portlet.generatetemplateid.model.IdGenerated[] models) {
    ...
    public static JSONArray toJSONArray(
        List<com.nss.portlet.generatetemplateid.model.IdGenerated> models) {
        JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
