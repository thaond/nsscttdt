 ...
 * <code>com.nss.portlet.filetype.service.http.PmlFileTypeAttachedFileServiceJSON</code>
 * to translate objects.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.nss.portlet.filetype.service.http.PmlFileTypeAttachedFileServiceJSON
 *
 */
public class PmlFileTypeAttachedFileJSONSerializer {
    ...
    public static JSONArray toJSONArray(
        com.nss.portlet.filetype.model.PmlFileTypeAttachedFile[] models) {
    ...
    public static JSONArray toJSONArray(
        List<com.nss.portlet.filetype.model.PmlFileTypeAttachedFile> models) {
        JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
