 ...
 * <code>com.nss.portlet.department.service.http.DepartmentServiceJSON</code>
 * to translate objects.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.nss.portlet.department.service.http.DepartmentServiceJSON
 *
 */
public class DepartmentJSONSerializer {
    ...
    public static JSONArray toJSONArray(
        com.nss.portlet.department.model.Department[] models) {
    ...
    public static JSONArray toJSONArray(
        List<com.nss.portlet.department.model.Department> models) {
        JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
