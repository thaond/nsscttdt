...
<%
	...
	if ("".equals(dataForSearchB)) {
		redirectURL.setParameter("struts_action", "/nss/onedoorprocess/view");
	} else {
		redirectURL.setParameter("struts_action", "/nss/onedoorprocess/searchresult");
	}
	...
	backURL.setParameter("struts_action", "/nss/onedoorprocess/view");
	...
	forWardURL.setParameter("struts_action", "/nss/onedoorprocess/searchresult");
...
<portlet:renderURL var="search" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
		<portlet:param name="struts_action" value="/nss/onedoorprocess/search"/>
	</portlet:renderURL>
	...
	<portlet:renderURL var="searchFile">
		<portlet:param name="struts_action" value="/nss/onedoorprocess/searchresult"/>
