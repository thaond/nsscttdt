...
<%@page import="com.nss.portlet.filestatus.util.PmlFileStatusUtil"%>
...
<%@page import="com.nss.portlet.filestatus.search.PmlFileStatusStateProcessSearch"%>
<%@page import="com.nss.portlet.onedoor.PmlFileStatusStateProcessCanNotDeleteException"%>
...
<%
	...
	displayURL.setParameter("struts_action", "/nss/filestatus/display_stateprocess_onedoor");
...
<portlet:actionURL var="display_process">
	...
	<liferay-ui:error exception="<%= PmlFileStatusStateProcessCanNotDeleteException.class %>" message="can-not-delete-pml-do-quan-trong" />
		...
		<%
			...
			addfilestatusStateProcessURL.setParameter("struts_action", "/nss/filestatus/add_stateprocess_onedoor");
			...
			backURL.setParameter("struts_action", "/nss/filestatus/view");
		...
		<%
			...
			for(int i=0; i<listFileStatusStateProcess.size(); i++){
				...
				rowURLEdit.setParameter("struts_action","/nss/filestatus/edit_stateprocess_onedoor");
				...
				rowURLDelete.setParameter("struts_action","/nss/filestatus/display_stateprocess_onedoor");
