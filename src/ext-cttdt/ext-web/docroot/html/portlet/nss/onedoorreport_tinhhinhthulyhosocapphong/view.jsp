...
<%@page import="com.nss.portlet.onedoorreport_tinhhinhthulyhosocapphong.search.HoSoCapPhongSearch"%>
<%@page import="com.liferay.portal.kernel.util.OrderByComparator"%>
<%@page import="java.util.List"%>
<%@page import="com.nss.portlet.onedoor.dto.TinhHinhThuLyHoSoCapPhongDTO"%>
...
<portlet:actionURL var="report">
	<portlet:param name="struts_action" value="/nss/onedoorreport_tinhhinhthulyhosocapphong/view" />
</portlet:actionURL>
...
<%
	...
	portletURL.setParameter("struts_action","/nss/onedoorreport_tinhhinhthulyhosocapphong/view" );
	...
	List<PmlUser> users = PmlUserLocalServiceUtil.findUserListByDepartment(pmlDepartmentId, start1 , end1);
	int total1 = PmlUserLocalServiceUtil.countUserListByDepartment(pmlDepartmentId);
...
<div class="parent-title"><liferay-ui:message key="bao-cao-ho-so-cap-phong"/></div>
...
<%
		...
		for ( int i=0; i< users.size(); i++) {
			...
			chuyenVienURL.setParameter("struts_action","/nss/onedoorreport_tinhhinhthulyhosocapphong/filedetails" );
			...
			tonTruocURL.setParameter("struts_action","/nss/onedoorreport_tinhhinhthulyhosocapphong/filedetails" );
			...
			daNhanURL.setParameter("struts_action","/nss/onedoorreport_tinhhinhthulyhosocapphong/filedetails" );
			...
			chuaNhanURL.setParameter("struts_action","/nss/onedoorreport_tinhhinhthulyhosocapphong/filedetails" );
			...
			tongCanXuLyURL.setParameter("struts_action","/nss/onedoorreport_tinhhinhthulyhosocapphong/filedetails" );
			...
			tuGiaiQuyetURL.setParameter("struts_action","/nss/onedoorreport_tinhhinhthulyhosocapphong/filedetails" );
			...
			nguoiKhacXuLyURL.setParameter("struts_action","/nss/onedoorreport_tinhhinhthulyhosocapphong/filedetails" );
			...
			hsGiaiQuyetURL.setParameter("struts_action","/nss/onedoorreport_tinhhinhthulyhosocapphong/filedetails" );
			...
			trongHanISOURL.setParameter("struts_action","/nss/onedoorreport_tinhhinhthulyhosocapphong/filedetails" );
			...
			quaHanISOURL.setParameter("struts_action","/nss/onedoorreport_tinhhinhthulyhosocapphong/filedetails" );
			...
			tongTonDongURL.setParameter("struts_action","/nss/onedoorreport_tinhhinhthulyhosocapphong/filedetails" );
