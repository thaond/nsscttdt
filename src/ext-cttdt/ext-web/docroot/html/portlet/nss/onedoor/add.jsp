...
<%@page import="com.nss.workflowonedoor.OneDoorProcessPortletAction"%>
<%@page import="javax.portlet.WindowState"%>
<%@page import="com.liferay.portal.util.PortletKeys"%>
<liferay-util:include page="/html/portlet/nss/onedoor/js/pccc-onedoorreceipt.jsp"></liferay-util:include>
<%
	Date date = new Date();
...
<portlet:actionURL var="add">
	<portlet:param name="struts_action" value="/nss/onedoor/add" />
...
<ul>
	...
	<fieldset class="filborder">
		...
		<%
		PortletURL currentURL = new PortletURLImpl(request, "SGS_ONEDOORPCCCPROCESS", 89356, PortletRequest.RENDER_PHASE);
