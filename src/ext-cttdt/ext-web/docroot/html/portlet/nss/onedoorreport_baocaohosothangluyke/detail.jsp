...
<%
	...
	PmlOneDoorReceiveFile file = PmlOneDoorReceiveFileLocalServiceUtil.getPmlOneDoorReceiveFile(filePcccDTO.getFileId());
...
<ul>
	<li style="width: 49.6%; margin-right: 0.8%" >
		<fieldset><fieldset class="filborder">
			...
			<table cellspacing="0" width="100%" class="bor_rgh">
				...
				<logic:iterate id="filePCCCAttachedFile" name="filePCCCAttachedFileList" type="com.nss.portlet.onedoor.model.PmlFilePCCCAttachedFile" indexId="p">
					<tr>
						...
						<td class="td-right"><a href="#" onclick="getHostName(this,'<%= filePCCCAttachedFile.getPath()%>' )"><u><%=filePCCCAttachedFile.getAttachedFileName() %></u></a></td>
					</tr>
				</logic:iterate>
				<%
					}
	...
	<li style="width: 49.6%;">
		...
		<label class="laborder"><liferay-ui:message key="pccc-TN-thongtinquanly"/></label>
			...
			<tr valign="top">
				...
				<td class="td-right"><textarea class="textarea-display" readonly="" rows="3" cols="45"><%=filePcccDTO.getNoteInformationManagement() %></textarea></td>
			</tr>
			</table>
		</fieldset>
		<fieldset class="filborder">
		<label class="laborder"><liferay-ui:message key="pccc-TN-thongtintrahoso"/></label>
			...
			<tr valign="top">
				<td class="td-left"><liferay-ui:message key="pccc-TN-ghichu"/>:</td>
				<td class="td-right"><textarea class="textarea-display" readonly="" rows="3" cols="45"><%=fileReturningInfo != null ? fileReturningInfo.getNote() : "" %></textarea></td>
			</tr>
			</table>
		</fieldset>
		<fieldset class="filborder">
	...
	<li style="width: 100%">
		...
		<label class="laborder"><liferay-ui:message key="pccc-TN-hosodinhkem"/></label>
			<table class="taglib-search-iterator table-pml" cellspacing="0" width="100%">	
					...
					<tr class="portlet-section-header results-header" >
						<td width="35px" align="center"><liferay-ui:message key="pccc-TN-stt"/></td>
						<td width="25%"><liferay-ui:message key="pccc-TN-tentailieubanve"/></td>
						<td align="center"><liferay-ui:message key="pccc-TN-soluong"/></td>
						<td width="50%"><liferay-ui:message key="pccc-TN-ghichu"/></td>
					</tr>
