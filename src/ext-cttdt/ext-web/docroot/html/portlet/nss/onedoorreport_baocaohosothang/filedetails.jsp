...
<%@page import="com.nss.portlet.onedoorreport_baocaohosothang.searchfiledetail.PmlOneDoorReceiveFileSearch"%>
...
<div id="listdiv" >
	...
	<ul>
		...
		<li style="width: 22%">
					<div class="btpre_hs" align="left"><liferay-util:include page="/html/portlet/nss/onedoorreport_baocaohosothang/button.jsp"></liferay-util:include></div>
		</li>
	</ul>
	</form>		
</div>
...
<div id="outer-1" class="outer-1">
						...
						%>
								...
								<portlet:renderURL var="detail"	windowState="<%= LiferayWindowState.EXCLUSIVE.toString() %>">
									<portlet:param name="struts_action"	value="/nss/onedoorreport_baocaohosothang/filedetails_detail" />
