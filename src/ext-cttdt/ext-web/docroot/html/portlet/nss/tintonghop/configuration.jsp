...
<c:choose>
				...
				>
					<liferay-ui:section>
						...
						for (int i = 0; i < results.size(); i++) {
							...
							row.addJSP("right", SearchEntry.DEFAULT_VALIGN, "/html/portlet/nss/tintonghop/asset_selection_action.jsp");
	...
	<c:when test="<%= typeSelection.equals(BlogsEntry.class.getName()) %>">
		...
		<%@ include file="/html/portlet/nss/tintonghop/select_blogs_entry.jspf" %>
	</c:when>
	<c:when test="<%= typeSelection.equals(BookmarksEntry.class.getName()) %>">
		...
		<%@ include file="/html/portlet/nss/tintonghop/select_bookmarks_entry.jspf" %>
	</c:when>
	<c:when test="<%= typeSelection.equals(DLFileEntry.class.getName()) %>">
		...
		<%@ include file="/html/portlet/nss/tintonghop/select_document_library_file_entry.jspf" %>
	</c:when>
	<c:when test="<%= typeSelection.equals(IGImage.class.getName()) %>">
		...
		<%@ include file="/html/portlet/nss/tintonghop/select_image_gallery_image_entry.jspf" %>
	</c:when>
	<c:when test="<%= typeSelection.equals(JournalArticle.class.getName()) %>">
		...
		<%@ include file="/html/portlet/nss/tintonghop/select_journal_article.jspf" %>
	</c:when>
</c:choose>
