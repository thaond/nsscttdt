...
<table width="100%" cellspacing="0">
		<tr>
			<td width="25%"><liferay-ui:message key="ten-thu-tuc-hanh-chinh" />:&nbsp;</td>
			<td>
				<input name="<portlet:namespace/><%= ThuTucHanhChinhDisplayTerms.TEN_THU_TUC_HANH_CHINH %>" style="width: 90%;" type="text" value="<%= HtmlUtil.escape(displayTerms.getTenThuTucHanhChinh()) %>" />
			</td>
		</tr>
		<tr style="display: none;">
			<td><liferay-ui:message key="linh-vuc" />:&nbsp;</td>
			<td>
				<select name="<portlet:namespace /><%= ThuTucHanhChinhDisplayTerms.LINH_VUC_THU_TUC %>" id="select2" style="width: 92%;">
		...
		<tr>
		    ...
		    <td >
				<select name="<portlet:namespace /><%= ThuTucHanhChinhDisplayTerms.CAP_DON_VI_THU_TUC%>" id="<portlet:namespace/>radioCapDV" style="width: 92%;" onchange="selectCapDonVi(this.value)">
		...
		<tr>
		    ...
		    <td >
		    	<div id="donViOnChange">
		    		<select name="<portlet:namespace /><%= ThuTucHanhChinhDisplayTerms.DON_VI_THU_TUC%>" id='maDonViThuTuc' style="width: 92%;" onchange="setDisplayTermsMaDV(this.value)">
