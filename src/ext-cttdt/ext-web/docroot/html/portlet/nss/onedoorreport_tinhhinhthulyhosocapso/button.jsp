...
%>	  
	...
	<portlet:renderURL var="search" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
		<portlet:param name="struts_action" value="/nss/onedoorreport_tinhhinhthulyhosocapso/search"/>
	</portlet:renderURL>
...
<script type="text/javascript">
	...
	<portlet:renderURL var="searchFile">
		<portlet:param name="struts_action" value="/nss/onedoorreport_tinhhinhthulyhosocapso/searchresult"/>
