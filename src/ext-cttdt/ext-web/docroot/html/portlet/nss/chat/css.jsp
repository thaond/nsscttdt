...
<%@ include file="/html/portlet/nss/chat/css_init.jsp" %>
...
%>
.chat-bar {
	background: url(<%= contextPath %>/images/btm-dock_bg.png);
...
.chat-bar div ul li.waiting .panel-trigger {
	background-image: url(<%= contextPath %>/images/message_waiting_indicator.gif);
}

.chat-bar div ul li .panel-trigger .unread {
	background: url(<%= contextPath %>/images/unread-messages.png);
	color: #fff;
	display: none;
...
.typing-status {
	...
	width: 16px;
	height: 16px;
	background: url(<%= contextPath %>/images/typing.png) no-repeat 0 0;
	display: none;
	position: absolute;
	top: 5px;
	left: 4px;
...
.panel-button.close {
	background: url(<%= contextPath %>/images/chat-close_button.png) left bottom;
	position: absolute;
	right: 4px;
	top: 6px;
}
...
.panel-button.minimize {
	background: url(<%= contextPath %>/images/chat-minimize_button.png) left bottom;
	position: absolute;
	right: 20px;
	top: 6px;
}
