	...
	<div class="parent-title"><liferay-ui:message key="cap-nhat"/></div>
 	...
 	<table cellspacing="0" width="100%">
		<tr>
			...
			<td><input type="text" name="<portlet:namespace />tenLinhVucThuTucHanhChinh" style="width: 90%;" id="<portlet:namespace/>tenLinhVucThuTucHanhChinh" value="<%= linhVucThuTuc.getTenLinhVucThuTucHanhChinh()%>" /></td>
		</tr>
		...
		<tr>
			...
			<td><textarea name="<portlet:namespace />description" style="width: 90%;" id="description" rows="3"><%= linhVucThuTuc.getDescription() %></textarea></td>
		</tr>
