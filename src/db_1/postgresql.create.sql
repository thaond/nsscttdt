...
(
  journalprocessdefinitionid bigint NOT NULL,
  "name" text,
  "version" character varying(75),
  "content" text,
  CONSTRAINT processdefinition_pkey PRIMARY KEY (journalprocessdefinitionid)
)
WITH (OIDS=FALSE);
ALTER TABLE journalprocessdefinition OWNER TO postgres;
...
(
  ...
  articleid bigint,
  categoryid bigint,
  previousnode character varying(75),
  status character varying(75),
  createuserid bigint,
  finish boolean,
  CONSTRAINT instancebean_pkey PRIMARY KEY (processinstanceid)
)
WITH (OIDS=FALSE);
ALTER TABLE instancebean OWNER TO postgres;