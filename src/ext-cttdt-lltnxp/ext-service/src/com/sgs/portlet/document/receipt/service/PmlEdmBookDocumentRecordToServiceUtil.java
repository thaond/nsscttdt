...
/**
 * <a href="PmlEdmBookDocumentRecordToServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class PmlEdmBookDocumentRecordToServiceUtil {
    private static PmlEdmBookDocumentRecordToService _service;

    public static PmlEdmBookDocumentRecordToService getService() {
        if (_service == null) {
            throw new RuntimeException(
                "PmlEdmBookDocumentRecordToService is not set");
        }
