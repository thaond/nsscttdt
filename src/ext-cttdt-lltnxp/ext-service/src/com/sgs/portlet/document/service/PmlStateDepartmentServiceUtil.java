...
/**
 * <a href="PmlStateDepartmentServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class PmlStateDepartmentServiceUtil {
    private static PmlStateDepartmentService _service;

    public static PmlStateDepartmentService getService() {
        if (_service == null) {
            throw new RuntimeException("PmlStateDepartmentService is not set");
        }
