...
public interface PmlFileTypeFinder {
    ...
    public java.util.List<com.sgs.portlet.filetype.model.PmlFileType> findByKeywords(
        java.lang.String keywords, int start, int end,
        com.liferay.portal.kernel.util.OrderByComparator obc)
        throws com.liferay.portal.SystemException;

    public java.util.List<com.sgs.portlet.filetype.model.PmlFileType> findByFileType(
    ...
    public java.util.List<com.sgs.portlet.filetype.model.PmlFileType> findAllFileTypes(
        int start, int end, com.liferay.portal.kernel.util.OrderByComparator obc)
        throws com.liferay.portal.SystemException;

    public int countAllFileTypes() throws com.liferay.portal.SystemException;
}
