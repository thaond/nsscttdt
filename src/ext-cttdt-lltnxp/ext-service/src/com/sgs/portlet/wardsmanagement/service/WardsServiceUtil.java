...
/**
 * <a href="WardsServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class WardsServiceUtil {
    private static WardsService _service;

    public static WardsService getService() {
        if (_service == null) {
            throw new RuntimeException("WardsService is not set");
        }
