...
<%@page import="com.sgs.portlet.onedoorpcccreport_baocaohosothangluyke.searchfiledetail.PmlOneDoorReceiveFileSearch"%>

<%@page import="javax.portlet.PortletURL"%>
<%@page import="javax.portlet.WindowState"%>

<liferay-util:include page="/html/portlet/ext/onedoorpcccreport_baocaohosothangluyke/js/onedoorpcccreport_baocaohosothangluyke-js.jsp"></liferay-util:include>
...
<link type="text/css" rel="stylesheet" href="/html/portlet/ext/onedoorpcccreport_baocaohosothangluyke/css/style.css" />
<link type="text/css" rel="stylesheet" href="/html/portlet/ext/onedoorpcccreport_baocaohosothangluyke/css/ex.css" />
		...
		<div id="listdivpccc">
			<div id="listdiv" >
				...
				<ul>
					...
					<li style="width: 22%">
							<div class="btpre_hs" align="left"><liferay-util:include page="/html/portlet/ext/onedoorpcccreport_baocaohosothangluyke/button.jsp"></liferay-util:include></div>
						</li>
			</ul>
			</div>
			...
			<div id="outer-1" class="outer-1">
					<table class="taglib-search-iterator table-pml" cellspacing="0" width="100%">	
							...
							<%
								...
								portletURL.setParameter("struts_action", "/sgs/onedoorpcccreport_baocaohosothangluyke/filedetails");
						...
						%>
								...
								<portlet:renderURL var="detail"	windowState="<%= LiferayWindowState.EXCLUSIVE.toString() %>">
									<portlet:param name="struts_action"	value="/sgs/onedoorpcccreport_baocaohosothangluyke/filedetails_detail" />
									...
									<td width="20%"><%= pmlFilePcccDTO.getFileName() %></td>
									<td width="35%"><%= pmlFilePcccDTO.getFiletype() %></td>
