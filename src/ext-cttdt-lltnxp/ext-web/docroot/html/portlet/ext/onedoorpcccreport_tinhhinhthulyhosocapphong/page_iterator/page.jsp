...
<%
searchContainer = (HoSoCapPhongSearch)request.getAttribute("liferay-ui:search:searchContainer");
...
<%@ include file="/html/portlet/ext/onedoorpcccreport_tinhhinhthulyhosocapphong/search_paginator/start.jsp" %>