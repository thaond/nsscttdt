...
<%@page import="com.sgs.portlet.onedoorpcccreport_tinhhinhthulyhosocapphong.searchfiledetail.PmlOneDoorReceiveFileSearch"%>
...
<liferay-util:include page="/html/portlet/ext/onedoorpcccreport_tinhhinhthulyhosocapphong/js/onedoorpcccreport_tinhhinhthulyhosocapphong-js.jsp"></liferay-util:include>
...
<link type="text/css" rel="stylesheet" href="/html/portlet/ext/onedoorpcccreport_tinhhinhthulyhosocapphong/css/style.css" />
<link type="text/css" rel="stylesheet" href="/html/portlet/ext/onedoorpcccreport_tinhhinhthulyhosocapphong/css/ex.css" />
...
<portlet:actionURL var="filter">
	...
	<portlet:param name="id"	value="<%= id.toString() %>" />
...
<ul>
	...
	<li style="width: 22%"><div class="btpre_hs" align="left"><liferay-util:include page="/html/portlet/ext/onedoorpcccreport_tinhhinhthulyhosocapphong/button.jsp"></liferay-util:include></div></li>
	</form>
</ul>
</div>
...
<div id="outer-1" class="outer-1">
		<table class="taglib-search-iterator table-pml" cellspacing="0" width="100%">	
							...
							<%
								...
								portletURL.setParameter("struts_action", "/sgs/onedoorpcccreport_tinhhinhthulyhosocapphong/filedetails");
						...
						%>
								...
								<portlet:renderURL var="detail"	windowState="<%= LiferayWindowState.EXCLUSIVE.toString() %>">
									<portlet:param name="struts_action"	value="/sgs/onedoorpcccreport_tinhhinhthulyhosocapphong/filedetails_detail" />
