...
%>	  
	...
	<portlet:renderURL var="search" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
		<portlet:param name="struts_action" value="/sgs/onedoorpcccreport_baocaohosothang/search"/>
	</portlet:renderURL>
...
<portlet:renderURL var="searchFile">
	<portlet:param name="struts_action" value="/sgs/onedoorpcccreport_baocaohosothang/searchresult"/>
