...
window.onload = function () {
	...
	//changeDocumentRecordTypeUpdate(); // phmphuc close 11/11/2010 thay the bang function ben duoi
...
<tr>
    ...
    <%-- phmphuc close and change follow under code - 11/11/2010
    ...
    --%>
    <!-- phmphuc update 11/11/2010 - chuyen loai cong van ra truoc so cong van, lay so cong van theo loai cong van -->
