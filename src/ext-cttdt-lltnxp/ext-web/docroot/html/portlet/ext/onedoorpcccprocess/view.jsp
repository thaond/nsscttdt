...
<%@page import="com.sgs.portlet.onedoorpcccprocess.search.PmlOneDoorReceiveFileSearch"%>
<%@page import="com.sgs.portlet.onedoorpcccprocess.searchDelegated.PmlOneDoorReceiveFileSearchDelegated"%>
<%@page import="com.sgs.portlet.onedoorpcccprocess.SearchIsDelegated.PmlOneDoorReceiveFileSearchIsDelegated"%><liferay-util:include page="/html/portlet/ext/onedoorpcccprocess/js/onedoorpcccprocess-js.jsp"></liferay-util:include>
...
function <portlet:namespace />processReport() 
{
	...
	form.action = "/sgs/onedoorpcccprocess/view?action=report"; 
}
...
<div class="boxcontent">
	<div id="listdivpccc">
			...
			<form id="filter" action="<%=filter %>" onsubmit="return checkBeginEndDate()" method="post">
				...
				<li style="width: 22%">
					<div class="btpre_hs" align="left"><liferay-util:include page="/html/portlet/ext/onedoorpcccprocess/button.jsp"></liferay-util:include></div>
				</li>
			</ul>
