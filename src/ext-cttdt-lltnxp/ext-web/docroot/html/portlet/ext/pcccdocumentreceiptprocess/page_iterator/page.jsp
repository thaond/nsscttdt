<%
searchContainer = (PcccDocumentReceiptProcessSearch)request.getAttribute("liferay-ui:search:searchContainer");
...
<%@ include file="/html/portlet/ext/pcccdocumentreceiptprocess/search_paginator/start.jsp" %>