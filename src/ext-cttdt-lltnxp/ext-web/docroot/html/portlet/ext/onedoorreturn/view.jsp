...
<%@page import="com.sgs.portlet.onedoorreturn.search.PmlFileReturnSearch"%>

<liferay-util:include page="/html/portlet/ext/onedoorreturn/js/onedoorreturn-js.jsp"></liferay-util:include>
...
<link type="text/css" rel="stylesheet" href="/html/portlet/ext/onedoorreturn/css/ex.css" />
...
<%
	...
	portletURLView.setParameter("struts_action","/sgs/onedoorreturn/view");
		...
		<div id="listdivpccc">
			<div id="listdiv">
				<ul>
						...
						<li style="width: 22%;">
							<div class="btpre_hs" align="left"><liferay-util:include page="/html/portlet/ext/onedoorreturn/button.jsp"></liferay-util:include></div>
						</li>
			...
			<div id="outer-1" class="outer-1">
					<table class="taglib-search-iterator table-pml" cellspacing="0" width="100%">
						...
						<portlet:renderURL var="detail"	windowState="<%= LiferayWindowState.EXCLUSIVE.toString() %>">
							<portlet:param name="struts_action"	value="/sgs/onedoorreturn/detail" />
