...
public class DocumentSendViewListAction extends DocumentSendPortletAction {
	private final static Logger _log = Logger.getLogger(DocumentSendViewListAction.class);
	...
	public ActionForward renderStruts(ActionMapping mapping, ActionForm form,
		...
		if (getForward(req) != null && !getForward(req).equals("")) {
			...
			return mapping.findForward("portlet.sgs.home_report.documentsendviewlist");
		}
	}
