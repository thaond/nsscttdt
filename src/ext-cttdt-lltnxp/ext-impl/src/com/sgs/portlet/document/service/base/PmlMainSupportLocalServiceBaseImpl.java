...
public abstract class PmlMainSupportLocalServiceBaseImpl
    implements PmlMainSupportLocalService {
    ...
    public PmlMainSupport addPmlMainSupport(PmlMainSupport pmlMainSupport)
        throws SystemException {
        pmlMainSupport.setNew(true);

        return pmlMainSupportPersistence.update(pmlMainSupport, false);
    }

    public PmlMainSupport createPmlMainSupport(long processId) {
        return pmlMainSupportPersistence.create(processId);
    }

    public void deletePmlMainSupport(long processId)
        throws PortalException, SystemException {
        pmlMainSupportPersistence.remove(processId);
    }

    public void deletePmlMainSupport(PmlMainSupport pmlMainSupport)
        throws SystemException {
        pmlMainSupportPersistence.remove(pmlMainSupport);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlMainSupportPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlMainSupport getPmlMainSupport(long processId)
        throws PortalException, SystemException {
        return pmlMainSupportPersistence.findByPrimaryKey(processId);
    }

    public List<PmlMainSupport> getPmlMainSupports(int start, int end)
        throws SystemException {
        return pmlMainSupportPersistence.findAll(start, end);
    }

    public int getPmlMainSupportsCount() throws SystemException {
        return pmlMainSupportPersistence.countAll();
    }

    public PmlMainSupport updatePmlMainSupport(PmlMainSupport pmlMainSupport)
        throws SystemException {
        pmlMainSupport.setNew(false);

        return pmlMainSupportPersistence.update(pmlMainSupport, true);
    }
