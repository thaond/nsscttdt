...
public abstract class PmlEdmDocumentRelationLocalServiceBaseImpl
    implements PmlEdmDocumentRelationLocalService {
    ...
    public PmlEdmDocumentRelation addPmlEdmDocumentRelation(
        ...
        return pmlEdmDocumentRelationPersistence.update(pmlEdmDocumentRelation,
            false);
    }

    public PmlEdmDocumentRelation createPmlEdmDocumentRelation(
        long documentRelationId) {
        return pmlEdmDocumentRelationPersistence.create(documentRelationId);
    }

    public void deletePmlEdmDocumentRelation(long documentRelationId)
        throws PortalException, SystemException {
        pmlEdmDocumentRelationPersistence.remove(documentRelationId);
    }

    public void deletePmlEdmDocumentRelation(
        PmlEdmDocumentRelation pmlEdmDocumentRelation)
        throws SystemException {
        pmlEdmDocumentRelationPersistence.remove(pmlEdmDocumentRelation);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlEdmDocumentRelationPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlEdmDocumentRelation getPmlEdmDocumentRelation(
        long documentRelationId) throws PortalException, SystemException {
        return pmlEdmDocumentRelationPersistence.findByPrimaryKey(documentRelationId);
    }

    public List<PmlEdmDocumentRelation> getPmlEdmDocumentRelations(int start,
        int end) throws SystemException {
        return pmlEdmDocumentRelationPersistence.findAll(start, end);
    }

    public int getPmlEdmDocumentRelationsCount() throws SystemException {
        return pmlEdmDocumentRelationPersistence.countAll();
    }

    public PmlEdmDocumentRelation updatePmlEdmDocumentRelation(
        PmlEdmDocumentRelation pmlEdmDocumentRelation)
        throws SystemException {
