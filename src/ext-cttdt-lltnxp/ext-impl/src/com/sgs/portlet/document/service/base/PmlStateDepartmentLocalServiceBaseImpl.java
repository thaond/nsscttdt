...
public abstract class PmlStateDepartmentLocalServiceBaseImpl
    implements PmlStateDepartmentLocalService {
    ...
    public PmlStateDepartment addPmlStateDepartment(
        PmlStateDepartment pmlStateDepartment) throws SystemException {
        pmlStateDepartment.setNew(true);

        return pmlStateDepartmentPersistence.update(pmlStateDepartment, false);
    }

    public PmlStateDepartment createPmlStateDepartment(
        PmlStateDepartmentPK pmlStateDepartmentPK) {
        return pmlStateDepartmentPersistence.create(pmlStateDepartmentPK);
    }

    public void deletePmlStateDepartment(
        PmlStateDepartmentPK pmlStateDepartmentPK)
        throws PortalException, SystemException {
        pmlStateDepartmentPersistence.remove(pmlStateDepartmentPK);
    }

    public void deletePmlStateDepartment(PmlStateDepartment pmlStateDepartment)
        throws SystemException {
        pmlStateDepartmentPersistence.remove(pmlStateDepartment);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlStateDepartmentPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlStateDepartment getPmlStateDepartment(
        PmlStateDepartmentPK pmlStateDepartmentPK)
        throws PortalException, SystemException {
        return pmlStateDepartmentPersistence.findByPrimaryKey(pmlStateDepartmentPK);
    }

    public List<PmlStateDepartment> getPmlStateDepartments(int start, int end)
        throws SystemException {
        return pmlStateDepartmentPersistence.findAll(start, end);
    }

    public int getPmlStateDepartmentsCount() throws SystemException {
        return pmlStateDepartmentPersistence.countAll();
    }

    public PmlStateDepartment updatePmlStateDepartment(
        PmlStateDepartment pmlStateDepartment) throws SystemException {
        pmlStateDepartment.setNew(false);

        return pmlStateDepartmentPersistence.update(pmlStateDepartment, true);
    }
