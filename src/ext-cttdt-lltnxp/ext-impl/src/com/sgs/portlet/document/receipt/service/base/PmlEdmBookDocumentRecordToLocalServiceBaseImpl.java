...
public abstract class PmlEdmBookDocumentRecordToLocalServiceBaseImpl
    implements PmlEdmBookDocumentRecordToLocalService {
    ...
    public PmlEdmBookDocumentRecordTo addPmlEdmBookDocumentRecordTo(
        PmlEdmBookDocumentRecordTo pmlEdmBookDocumentRecordTo)
        throws SystemException {
        pmlEdmBookDocumentRecordTo.setNew(true);

        return pmlEdmBookDocumentRecordToPersistence.update(pmlEdmBookDocumentRecordTo,
            false);
    }

    public PmlEdmBookDocumentRecordTo createPmlEdmBookDocumentRecordTo(
        PmlEdmBookDocumentRecordToPK pmlEdmBookDocumentRecordToPK) {
        return pmlEdmBookDocumentRecordToPersistence.create(pmlEdmBookDocumentRecordToPK);
    }

    public void deletePmlEdmBookDocumentRecordTo(
        PmlEdmBookDocumentRecordToPK pmlEdmBookDocumentRecordToPK)
        throws PortalException, SystemException {
        pmlEdmBookDocumentRecordToPersistence.remove(pmlEdmBookDocumentRecordToPK);
    }

    public void deletePmlEdmBookDocumentRecordTo(
        PmlEdmBookDocumentRecordTo pmlEdmBookDocumentRecordTo)
        throws SystemException {
        pmlEdmBookDocumentRecordToPersistence.remove(pmlEdmBookDocumentRecordTo);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlEdmBookDocumentRecordToPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlEdmBookDocumentRecordTo getPmlEdmBookDocumentRecordTo(
        PmlEdmBookDocumentRecordToPK pmlEdmBookDocumentRecordToPK)
        throws PortalException, SystemException {
        return pmlEdmBookDocumentRecordToPersistence.findByPrimaryKey(pmlEdmBookDocumentRecordToPK);
    }

    public List<PmlEdmBookDocumentRecordTo> getPmlEdmBookDocumentRecordTos(
        int start, int end) throws SystemException {
        return pmlEdmBookDocumentRecordToPersistence.findAll(start, end);
    }

    public int getPmlEdmBookDocumentRecordTosCount() throws SystemException {
        return pmlEdmBookDocumentRecordToPersistence.countAll();
    }

    public PmlEdmBookDocumentRecordTo updatePmlEdmBookDocumentRecordTo(
        PmlEdmBookDocumentRecordTo pmlEdmBookDocumentRecordTo)
        throws SystemException {
