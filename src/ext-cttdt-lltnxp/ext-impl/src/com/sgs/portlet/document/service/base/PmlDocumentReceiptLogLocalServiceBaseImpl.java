...
public abstract class PmlDocumentReceiptLogLocalServiceBaseImpl
    implements PmlDocumentReceiptLogLocalService {
    ...
    public PmlDocumentReceiptLog addPmlDocumentReceiptLog(
        PmlDocumentReceiptLog pmlDocumentReceiptLog) throws SystemException {
        pmlDocumentReceiptLog.setNew(true);

        return pmlDocumentReceiptLogPersistence.update(pmlDocumentReceiptLog,
            false);
    }

    public PmlDocumentReceiptLog createPmlDocumentReceiptLog(
        long documentReceiptLogId) {
        return pmlDocumentReceiptLogPersistence.create(documentReceiptLogId);
    }

    public void deletePmlDocumentReceiptLog(long documentReceiptLogId)
        throws PortalException, SystemException {
        pmlDocumentReceiptLogPersistence.remove(documentReceiptLogId);
    }

    public void deletePmlDocumentReceiptLog(
        PmlDocumentReceiptLog pmlDocumentReceiptLog) throws SystemException {
        pmlDocumentReceiptLogPersistence.remove(pmlDocumentReceiptLog);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlDocumentReceiptLogPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlDocumentReceiptLog getPmlDocumentReceiptLog(
        long documentReceiptLogId) throws PortalException, SystemException {
        return pmlDocumentReceiptLogPersistence.findByPrimaryKey(documentReceiptLogId);
    }

    public List<PmlDocumentReceiptLog> getPmlDocumentReceiptLogs(int start,
        int end) throws SystemException {
        return pmlDocumentReceiptLogPersistence.findAll(start, end);
    }

    public int getPmlDocumentReceiptLogsCount() throws SystemException {
        return pmlDocumentReceiptLogPersistence.countAll();
    }

    public PmlDocumentReceiptLog updatePmlDocumentReceiptLog(
        PmlDocumentReceiptLog pmlDocumentReceiptLog) throws SystemException {
