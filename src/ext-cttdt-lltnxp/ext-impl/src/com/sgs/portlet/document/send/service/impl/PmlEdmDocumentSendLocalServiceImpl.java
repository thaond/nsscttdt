...
public class PmlEdmDocumentSendLocalServiceImpl extends
	...
	public List<PmlEdmDocumentSend> filterByIssuingPlace(
		...
		for (PmlEdmDocumentSend item : list) {
			if (item.getReceivingPlace() != null) {
				if (item.getReceivingPlace().toUpperCase().indexOf(
						receivingPlace.toUpperCase()) != -1) {
	...
	public List<PmlEdmDocumentSend> filterByDocumentReference(
		...
		for (PmlEdmDocumentSend item : list) {
			if (item.getDocumentReference() != null) {
				if (item.getDocumentReference().toUpperCase().indexOf(
						documentReference.toUpperCase()) != -1) {
					pmlEdmDocumentSend = item;
					retValue.add(pmlEdmDocumentSend);
				}
			}
	...
	public Hits search(long companyId, String soPhatHanh, long loaiCongVan,
		...
		return search(companyId, soPhatHanh, loaiCongVan, traLoiCongVanSo,
				...
				trichYeu, active, nguoiSoanThao, "ngayPhatHanh", Sort.LONG_TYPE, start, end);
	}
	...
	public Hits search(long companyId, String soPhatHanh, long loaiCongVan,
		...
		try {
			...
			if (nguoiSoanThao > 0) {
				nguoiSoanThaoQuery.addTerm(PmlEdmDocumentSendDisplayTerms.NGUOI_SOAN_THAO, 
						nguoiSoanThao);
	...
	public Hits search(long companyId, String soPhatHanh, long loaiCongVan,
			String traLoiCongVanSo, String phongSoanThao, String noiNhan,
			String nguoiKy, Date tuNgay, Date denNgay, long soHSCV,
			String trichYeu, String active, long nguoiSoanThao, String sortField, 
	...
	public int countTonDauKyChuyenVien_CVDi(long userId,
		...
		return pmlEdmDocumentSendFinder.countTonDauKyChuyenVien_CVDi(userId, documentRecordTypeId, loaiVB, doMat, fromDate, toDate);
	}
	...
	public int countNhanTrongThangChuyenVien_CVDi(long userId,
			int documentRecordTypeId,  int loaiVB, Date fromDate,
			Date toDate) throws Exception {
		
		return pmlEdmDocumentSendFinder.countNhanTrongThangChuyenVien_CVDi(userId, 
				documentRecordTypeId, loaiVB, fromDate, toDate);
	}
	
	public List<PmlEdmDocumentSend> listNhanTrongThangChuyenVien_CVDi(long userId,
			int documentRecordTypeId,  int loaiVB, Date fromDate,
			Date toDate, int start, int end, OrderByComparator obc)
			throws Exception {
		
		return pmlEdmDocumentSendFinder.listNhanTrongThangChuyenVien_CVDi(userId, 
	...
	public List<PmlEdmDocumentSend> listTonDauKyPhongBan_CVDi(
			String departmentId, int documentRecordTypeId, 
	...
	// ton dau ky
	public int countTonDauKySo_CVDi(int documentRecordTypeId,
	...
	// nhan trong ky
	public int countNhanTrongKySo_CVDi(int documentRecordTypeId,
			int loaiVB, String doMat, Date fromDate, Date toDate) throws Exception {
	...
	// da giai quyet dung han
	public int countDungHanDaXuLySo_CVDi(int documentRecordTypeId, 
			int loaiVB, String doMat, Date fromDate, Date toDate) throws Exception {
	...
	// da giai quyet tre han
	public int countTreHanDaXuLySo_CVDi(int documentRecordTypeId,
			int loaiVB, String doMat, Date fromDate, Date toDate) throws Exception {
	...
	// tong da giai quyet
	public int countTongDaXuLySo_CVDi(int documentRecordTypeId, 
			int loaiVB, String doMat, Date fromDate, Date toDate) throws Exception {
	...
	// dang giai quyet tre han
	public int countTreHanDangXuLySo_CVDi(int documentRecordTypeId, 
			int loaiVB, String doMat, Date fromDate, Date toDate) throws Exception {
	...
	// tong dang giai quyet
	public int countTongDangXuLySo_CVDi(int documentRecordTypeId,
			int loaiVB, String doMat, Date fromDate, Date toDate) throws Exception {
	...
	/**
	 * @author phmphuc 02/04/2010
	 * portlet congvandidahoanthanh
	 * lay danh sach cong van di da hoan thanh theo tung loai so cong van
	 */
	public List<PmlEdmDocumentSend> getListPmlEdmDocumentSend(int loaiSoCongVan, 
				String fromDate, String toDate, int start, int end, OrderByComparator obc) throws Exception {
		
		return pmlEdmDocumentSendFinder.getListPmlEdmDocumentSend(loaiSoCongVan, fromDate, toDate, start, end, obc);
	}
	
	// cho search container
	public List<PmlEdmDocumentSend> getListPmlEdmDocumentSendByLoaiSoCV(String loaiSoCongVan, 
				String fromDate, String toDate, int start, int end, OrderByComparator obc) throws Exception {
		
		return pmlEdmDocumentSendFinder.getListPmlEdmDocumentSendByLoaiSoCV(loaiSoCongVan, fromDate, toDate, start, end, obc);
	}
	
	public int countListPmlEdmDocumentSendByLoaiSoCV(String loaiSoCongVan, String fromDate, String toDate) throws SystemException{
		
		return pmlEdmDocumentSendFinder.countListPmlEdmDocumentSendByLoaiSoCV(loaiSoCongVan, fromDate, toDate);
	}
	/**
	 * yenlt 09/04/2010
	 * CV DI DA XU LY
	 */
	public int countListCVDiDaXuLyTuXuLy(long userId, String year, String loaisocongvan) throws SystemException {
		return pmlEdmDocumentSendFinder.countListCVDiDaXuLyTuXuLy(userId, year, loaisocongvan);
	}
	
	public List<PmlEdmDocumentSend> getListCVDiDaXuLyTuXuLy(long userId, String year, String loaisocongvan, int start, int end, OrderByComparator obc) throws SystemException {
		return pmlEdmDocumentSendFinder.getListCVDiDaXuLyTuXuLy(userId, year, loaisocongvan, start, end, obc);
	}
	
	public int countListCVDiDaXuLyChung(long userId, String year, String loaisocongvan) throws SystemException {
		return pmlEdmDocumentSendFinder.countListCVDiDaXuLyChung(userId, year, loaisocongvan);
	}
	
	public List<PmlEdmDocumentSend> getListCVDiDaXuLyChung(long userId, String year, String loaisocongvan, int start, int end, OrderByComparator obc) throws SystemException {
		return pmlEdmDocumentSendFinder.getListCVDiDaXuLyChung(userId, year, loaisocongvan, start, end, obc);
	}
	
	public List<PmlEdmDocumentSend> getListCVDiDaXuLyChung_treHan(long userId, String year, String loaisocongvan, int start, int end, OrderByComparator obc) throws SystemException {
		return pmlEdmDocumentSendFinder.getListCVDiDaXuLyChung_treHan(userId, year, loaisocongvan, start, end, obc);
	}
	
	public int countListCVDiDaXuLyChung_treHan(long userId, String year, String loaisocongvan) throws SystemException {
		return pmlEdmDocumentSendFinder.countListCVDiDaXuLyChung_treHan(userId, year, loaisocongvan);
	}
	
	public List<PmlEdmDocumentSend> getListCVDiDaXuLyTuXuLy_treHan(long userId, String year, String loaisocongvan, int start, int end, OrderByComparator obc) throws SystemException {
		return pmlEdmDocumentSendFinder.getListCVDiDaXuLyTuXuLy_treHan(userId, year, loaisocongvan, start, end, obc);
	}
	
	public int countListCVDiDaXuLyTuXuLy_treHan(long userId, String year, String loaisocongvan) throws SystemException {
		return pmlEdmDocumentSendFinder.countListCVDiDaXuLyTuXuLy_treHan(userId, year, loaisocongvan);
	}
	
	public int countByD_I_D_R_D_S_E_B(String soPH, int ngayPHMonth, int ngayPHYear, 
			String phongST, String noiNhan, long loaiVB, String tenNguoiKy, 
			long nguoiST, String trichYeu) 
		throws SystemException {
		
		return pmlEdmDocumentSendFinder.countByD_I_D_R_D_S_E_B(soPH, ngayPHMonth, 
				ngayPHYear, phongST, noiNhan, loaiVB, tenNguoiKy, nguoiST, trichYeu);
	}
	...
	public List<PmlEdmDocumentSend> findByD_I_D_R_D_S_E_B(String soPH, 
		...
		return pmlEdmDocumentSendFinder.findByD_I_D_R_D_S_E_B(soPH, ngayPHMonth, 
				ngayPHYear, phongST, noiNhan, loaiVB, tenNguoiKy, nguoiST, trichYeu, start, end, obc);
	}
	;
	// YENLT 19-06-2010 
	...
	public int countByLOAIVB_NGUOIKY(long loaiVB, String nguoiKy, boolean andOperator) throws SystemException{
		return pmlEdmDocumentSendFinder.countByLOAIVB_NGUOIKY(loaiVB, nguoiKy, andOperator);
	}
	
	public List<PmlEdmDocumentSend> findByKeywords(String keywords,int start, int end, OrderByComparator obc) throws SystemException{
		return pmlEdmDocumentSendFinder.findByKeywords(keywords, start, end, obc);
	}
	
	public List<PmlEdmDocumentSend> findByLOAIVB_NGUOIKY(long loaiVB, String nguoiKy, boolean andOperator, int start, int end,
			OrderByComparator obc) throws SystemException {
		return pmlEdmDocumentSendFinder.findByLOAIVB_NGUOIKY(loaiVB, nguoiKy, andOperator, start, end, obc);
	}
	//end yenlt 19-06-2010
	
	/**
	 * yenlt 20101023 == TIM THEO SEARCH FORM
	 * CONG VAN DI DA XU LY
	 * @throws SystemException 
	 */
	public List<PmlEdmDocumentSend> getListCVDiDaXuLyChung(long userId, long loaiVB, String soKyHieu, String donViSoanThao, String nguoiKy,
			String trichYeu, String coQuanNhan, String tuNgay, String denNgay, int start, int end, OrderByComparator obc) throws SystemException {
		return pmlEdmDocumentSendFinder.getListCVDiDaXuLyChung(userId, loaiVB, soKyHieu, donViSoanThao, nguoiKy, trichYeu, coQuanNhan, tuNgay, denNgay, start, end, obc);
	}
	
	public int countListCVDiDaXuLyChung(long userId, long loaiVB, String soKyHieu, String donViSoanThao, String nguoiKy,
			String trichYeu, String coQuanNhan, String tuNgay, String denNgay) throws SystemException {
		return pmlEdmDocumentSendFinder.countListCVDiDaXuLyChung(userId, loaiVB, soKyHieu, donViSoanThao, nguoiKy, trichYeu, coQuanNhan, tuNgay, denNgay);
	}
	
	public List<PmlEdmDocumentSend> getListCVDiDaXuLyTuXuLy(long userId, long loaiVB, String soKyHieu, String donViSoanThao, String nguoiKy,
			String trichYeu, String coQuanNhan, String tuNgay, String denNgay, int start, int end, OrderByComparator obc) throws SystemException {
		return pmlEdmDocumentSendFinder.getListCVDiDaXuLyTuXuLy(userId, loaiVB, soKyHieu, donViSoanThao, nguoiKy, trichYeu, coQuanNhan, tuNgay, denNgay, start, end, obc);
	}
	
	public int countListCVDiDaXuLyTuXuLy(long userId, long loaiVB, String soKyHieu, String donViSoanThao, String nguoiKy,
			String trichYeu, String coQuanNhan, String tuNgay, String denNgay) throws SystemException {
		return pmlEdmDocumentSendFinder.countListCVDiDaXuLyTuXuLy(userId, loaiVB, soKyHieu, donViSoanThao, nguoiKy, trichYeu, coQuanNhan, tuNgay, denNgay);
	}
	
	public List<PmlEdmDocumentSend> getListCVDiDaXuLyChung_treHan(long userId, long loaiVB, String soKyHieu, String donViSoanThao, String nguoiKy,
			String trichYeu, String coQuanNhan, String tuNgay, String denNgay, int start, int end, OrderByComparator obc) throws SystemException {
		return pmlEdmDocumentSendFinder.getListCVDiDaXuLyChung_treHan(userId, loaiVB, soKyHieu, donViSoanThao, nguoiKy, trichYeu, coQuanNhan, tuNgay, denNgay, start, end, obc);
	}
	
	public int countListCVDiDaXuLyChung_treHan(long userId, long loaiVB, String soKyHieu, String donViSoanThao, String nguoiKy,
			String trichYeu, String coQuanNhan, String tuNgay, String denNgay) throws SystemException {
		return pmlEdmDocumentSendFinder.countListCVDiDaXuLyChung_treHan(userId, loaiVB, soKyHieu, donViSoanThao, nguoiKy, trichYeu, coQuanNhan, tuNgay, denNgay);
	}
	
	public List<PmlEdmDocumentSend> getListCVDiDaXuLyTuXuLy_treHan(long userId, long loaiVB, String soKyHieu, String donViSoanThao, String nguoiKy,
			String trichYeu, String coQuanNhan, String tuNgay, String denNgay, int start, int end, OrderByComparator obc) throws SystemException {
		return pmlEdmDocumentSendFinder.getListCVDiDaXuLyTuXuLy_treHan(userId, loaiVB, soKyHieu, donViSoanThao, nguoiKy, trichYeu, coQuanNhan, tuNgay, denNgay, start, end, obc);
	}
	
	public int countListCVDiDaXuLyTuXuLy_treHan(long userId, long loaiVB, String soKyHieu, String donViSoanThao, String nguoiKy,
			String trichYeu, String coQuanNhan, String tuNgay, String denNgay) throws SystemException {
		return pmlEdmDocumentSendFinder.countListCVDiDaXuLyTuXuLy_treHan(userId, loaiVB, soKyHieu, donViSoanThao, nguoiKy, trichYeu, coQuanNhan, tuNgay, denNgay);
	}
	
	public int countByDocumentSend_Users_Status_DangXuLy(List<Long> userIds, long statusId, long loaiVB, String soKyHieu, String donViSoanThao, String nguoiKy,
			String trichYeu, String coQuanNhan, String tuNgay, String denNgay) throws Exception {
		return pmlEdmDocumentSendFinder.countByDocumentSend_Users_Status_DangXuLy(userIds, statusId, loaiVB, soKyHieu, donViSoanThao, nguoiKy, trichYeu, coQuanNhan, tuNgay, denNgay);
	}
	
	public List<PmlEdmDocumentSend> findByDocumentSend_Users_Status_DangXuLy(List<Long> userIds, long statusId, long loaiVB, String soKyHieu, String donViSoanThao, String nguoiKy,
			String trichYeu, String coQuanNhan, String tuNgay, String denNgay, int start, int end, OrderByComparator obc)
			throws Exception {
		return pmlEdmDocumentSendFinder.findByDocumentSend_Users_Status_DangXuLy(userIds, statusId, loaiVB, soKyHieu, donViSoanThao, nguoiKy, trichYeu, coQuanNhan, tuNgay, denNgay, start, end, obc);
	}
	
	public int countByDocumentSend_Users_Status_DangXuLy_TreHan(List<Long> userIds, long statusId, long loaiVB, String soKyHieu, String donViSoanThao, String nguoiKy,
			String trichYeu, String coQuanNhan, String tuNgay, String denNgay) throws Exception {
		return pmlEdmDocumentSendFinder.countByDocumentSend_Users_Status_DangXuLy_TreHan(userIds, statusId, loaiVB, soKyHieu, donViSoanThao, nguoiKy, trichYeu, coQuanNhan, tuNgay, denNgay);
	}
	
	public List<PmlEdmDocumentSend> findByDocumentSend_Users_Status_DangXuLy_TreHan(List<Long> userIds, long statusId, long loaiVB, String soKyHieu, String donViSoanThao, String nguoiKy,
			String trichYeu, String coQuanNhan, String tuNgay, String denNgay, int start, int end, OrderByComparator obc)
			throws Exception {
		return pmlEdmDocumentSendFinder.findByDocumentSend_Users_Status_DangXuLy_TreHan(userIds, statusId, loaiVB, soKyHieu, donViSoanThao, nguoiKy, trichYeu, coQuanNhan, tuNgay, denNgay, start, end, obc);
	}
	
	/**
	 * YENLT UPDATE XU LY THAY 20101028
	 */
	public List<PmlEdmDocumentSend> findByDocumentSend_Users(List<Long> userIds, long loaiVB, String donViSoanThao, String nguoiKy,
			String trichYeu, String coQuanNhan, String tuNgay, String denNgay, int start, int end, OrderByComparator obc) throws Exception {
		return pmlEdmDocumentSendFinder.findByDocumentSend_Users(userIds, loaiVB, donViSoanThao, nguoiKy, trichYeu, coQuanNhan, tuNgay, denNgay, start, end, obc);
	}
	
	public int countByDocumentSend_Users(List<Long> userIds, long loaiVB, String donViSoanThao, String nguoiKy,
			String trichYeu, String coQuanNhan, String tuNgay, String denNgay) throws Exception {
		return pmlEdmDocumentSendFinder.countByDocumentSend_Users(userIds, loaiVB, donViSoanThao, nguoiKy, trichYeu, coQuanNhan, tuNgay, denNgay);
	}
	
	/**
	 * phmphuc them cac phuong thuc lay ds log tuong tu nhu documentsend
	 * muc dich lay noi dung yeu cau xu ly cho tung documentsend
	 * 12/11/2010
	 */
	// chuyen vien dang xu ly
	public List<PmlDocumentSendLog> findByDocumentSendLog_Users_Status_DangXuLy(List<Long> userIds, long statusId, 
			long loaiVB, String soKyHieu, String donViSoanThao, String nguoiKy, String trichYeu, String coQuanNhan, 
			String tuNgay, String denNgay, int start, int end, OrderByComparator obc) throws Exception {
		
		return pmlEdmDocumentSendFinder.findByDocumentSendLog_Users_Status_DangXuLy(userIds, statusId, loaiVB, 
				soKyHieu, donViSoanThao, nguoiKy, trichYeu, coQuanNhan, tuNgay, denNgay, start, end, obc);
	}
	
	// chuyen vien xu ly tre han
	public List<PmlDocumentSendLog> findByDocumentSendLog_Users_Status_DangXuLy_TreHan(List<Long> userIds, long statusId, 
			long loaiVB, String soKyHieu, String donViSoanThao, String nguoiKy, String trichYeu, String coQuanNhan, 
			String tuNgay, String denNgay, int start, int end, OrderByComparator obc) throws Exception {
		
		return pmlEdmDocumentSendFinder.findByDocumentSendLog_Users_Status_DangXuLy_TreHan(userIds, statusId, loaiVB, 
				soKyHieu, donViSoanThao, nguoiKy, trichYeu, coQuanNhan, tuNgay, denNgay, start, end, obc);
	}
	
	// van thu xu ly thay
	public List<PmlDocumentSendLog> findByDocumentSendLog_Users(List<Long> userIds, long loaiVB, 
			String donViSoanThao, String nguoiKy, String trichYeu, String coQuanNhan, String tuNgay, 
			String denNgay, int start, int end, OrderByComparator obc) throws Exception {
		
		return pmlEdmDocumentSendFinder.findByDocumentSendLog_Users(userIds, loaiVB, donViSoanThao, 
	...
	// phmphuc update 27/12/2010 - lay so phat hanh vb di co kem theo so giam doc hoac so phong ban
	public long getSoPhatHanhVBDi(long docTypeId, int issuingYear, boolean numOfDirector) throws SystemException {

		try {
			return pmlEdmDocumentSendFinder.getSoPhatHanhVBDi(docTypeId, issuingYear, numOfDirector);
		} catch (Exception ex) {
			return 0;
		} // end catch
	}
	...
	public Hits timKiemVBDi(long companyId, int numOfDirector, String soPhatHanh, long loaiCongVan,
				String traLoiCongVanSo, String phongSoanThao, String noiNhan, String nguoiKy, 
				Date tuNgay, Date denNgay, long soHSCV,String trichYeu, String active, long nguoiSoanThao, 
				String sortField, int sortType, boolean reverse, int start, int end) throws SystemException {
		...
		try {
			...
			BooleanQuery contextQuery = BooleanQueryFactoryUtil.create();
			contextQuery.addRequiredTerm(Field.PORTLET_ID, SendIndexer.PORTLET_ID);

			BooleanQuery soPhatHanhQuery = BooleanQueryFactoryUtil.create();
			BooleanQuery loaiCongVanQuery = BooleanQueryFactoryUtil.create();
			BooleanQuery traLoiCongVanSoQuery = BooleanQueryFactoryUtil.create();
			BooleanQuery phongSoanThaoQuery = BooleanQueryFactoryUtil.create();
			BooleanQuery noiNhanQuery = BooleanQueryFactoryUtil.create();
			BooleanQuery nguoiKyQuery = BooleanQueryFactoryUtil.create();
			BooleanQuery rangeQuery = BooleanQueryFactoryUtil.create();
			...
			if (Validator.isNotNull(soPhatHanh)) {
				soPhatHanhQuery.addTerm(PmlEdmDocumentSendDisplayTerms.SO_PHAT_HANH, soPhatHanh);
				booleanQueries.add(soPhatHanhQuery);
			}
			if (loaiCongVan > 0) {
			...
			if (Validator.isNotNull(traLoiCongVanSo)) {
				traLoiCongVanSoQuery.addTerm(PmlEdmDocumentSendDisplayTerms.TRA_LOI_CONG_VAN_SO, traLoiCongVanSo);
				booleanQueries.add(traLoiCongVanSoQuery);
			}
			if (Validator.isNotNull(phongSoanThao)) {
				phongSoanThaoQuery.addTerm(PmlEdmDocumentSendDisplayTerms.PHONG_SOAN_THAO, phongSoanThao);
				booleanQueries.add(phongSoanThaoQuery);
			}
			if (Validator.isNotNull(noiNhan)) {
				noiNhanQuery.addTerm(PmlEdmDocumentSendDisplayTerms.NOI_NHAN, noiNhan);
				booleanQueries.add(noiNhanQuery);
			}
			if (Validator.isNotNull(nguoiKy)) {
				nguoiKyQuery.addTerm(PmlEdmDocumentSendDisplayTerms.NGUOI_KY, nguoiKy.replace(" ", ""));
				booleanQueries.add(nguoiKyQuery);
			}
			if (sb.length() > 6) {
				rangeQuery.addTerm("ngayPhatHanh", sb.toString());
			...
			if (Validator.isNotNull(soHSCV)) {
				soHSCVQuery.addTerm(PmlEdmDocumentSendDisplayTerms.SO_HSCV, soHSCV);
				booleanQueries.add(soHSCVQuery);
			}
			if (Validator.isNotNull(trichYeu)) {
				trichYeuQuery.addTerm(PmlEdmDocumentSendDisplayTerms.TRICH_YEU, trichYeu);
				booleanQueries.add(trichYeuQuery);
			}
			if (Validator.isNotNull(active)) {
				activeQuery.addTerm("active", active);
			...
			switch (numOfDirector) {
				case (1):
					numOfDirectorQuery.addTerm(PmlEdmDocumentSendDisplayTerms.NUMOFDIRECTOR, "true");
					booleanQueries.add(numOfDirectorQuery);
					break;
				case (2):
					numOfDirectorQuery.addTerm(PmlEdmDocumentSendDisplayTerms.NUMOFDIRECTOR, "false");
					booleanQueries.add(numOfDirectorQuery);
					break;
				default:
					break;
	...
	/**
	 * phmphuc update - 06/01/2011
	 * So van ban di cua phong
	 */
	public int countByVBDi_SoVBDiCuaPhong(String soPH, int ngayPHMonth, int ngayPHYear, 
			String phongST, String noiNhan, long loaiVB, String tenNguoiKy, long nguoiST, 
			String trichYeu, String vanBanPH) throws SystemException {
		
		return pmlEdmDocumentSendFinder.countByVBDi_SoVBDiCuaPhong(soPH, ngayPHMonth, ngayPHYear, 
						phongST, noiNhan, loaiVB, tenNguoiKy, nguoiST, trichYeu, vanBanPH);
	}
	
	public List<PmlEdmDocumentSend> findByVBDi_SoVBDiCuaPhong(String soPH, int ngayPHMonth,
			int ngayPHYear, String phongST, String noiNhan, long loaiVB, String tenNguoiKy, 
			long nguoiST, String trichYeu, String vanBanPH, int start, int end, 
			OrderByComparator obc) throws SystemException {
		
		return pmlEdmDocumentSendFinder.findByVBDi_SoVBDiCuaPhong(soPH, ngayPHMonth, ngayPHYear, 
				phongST, noiNhan, loaiVB, tenNguoiKy, nguoiST, trichYeu, vanBanPH, start, end, obc);
	}
	...
	public int kiemTraSoVaKyHieuVBPhatHanh(String soVBPhatHanh, int issuingYear, long documentSendId) throws SystemException {
		
		return pmlEdmDocumentSendFinder.kiemTraSoVaKyHieuVBPhatHanh(soVBPhatHanh, issuingYear, documentSendId);
	}
