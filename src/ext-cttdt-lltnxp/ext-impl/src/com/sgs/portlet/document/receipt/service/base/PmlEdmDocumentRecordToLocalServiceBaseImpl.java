...
public abstract class PmlEdmDocumentRecordToLocalServiceBaseImpl
    implements PmlEdmDocumentRecordToLocalService {
    ...
    public PmlEdmDocumentRecordTo addPmlEdmDocumentRecordTo(
        PmlEdmDocumentRecordTo pmlEdmDocumentRecordTo)
        throws SystemException {
        pmlEdmDocumentRecordTo.setNew(true);

        return pmlEdmDocumentRecordToPersistence.update(pmlEdmDocumentRecordTo,
            false);
    }

    public PmlEdmDocumentRecordTo createPmlEdmDocumentRecordTo(
        long documentRecordToId) {
        return pmlEdmDocumentRecordToPersistence.create(documentRecordToId);
    }
    ...
    public void deletePmlEdmDocumentRecordTo(
        PmlEdmDocumentRecordTo pmlEdmDocumentRecordTo)
        throws SystemException {
        pmlEdmDocumentRecordToPersistence.remove(pmlEdmDocumentRecordTo);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlEdmDocumentRecordToPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlEdmDocumentRecordTo getPmlEdmDocumentRecordTo(
        long documentRecordToId) throws PortalException, SystemException {
        return pmlEdmDocumentRecordToPersistence.findByPrimaryKey(documentRecordToId);
    }

    public List<PmlEdmDocumentRecordTo> getPmlEdmDocumentRecordTos(int start,
        int end) throws SystemException {
        return pmlEdmDocumentRecordToPersistence.findAll(start, end);
    }

    public int getPmlEdmDocumentRecordTosCount() throws SystemException {
        return pmlEdmDocumentRecordToPersistence.countAll();
    }

    public PmlEdmDocumentRecordTo updatePmlEdmDocumentRecordTo(
        PmlEdmDocumentRecordTo pmlEdmDocumentRecordTo)
        throws SystemException {
