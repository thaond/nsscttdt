...
public abstract class PmlEdmDocumentReceiptExtendLocalServiceBaseImpl
    implements PmlEdmDocumentReceiptExtendLocalService {
    ...
    public PmlEdmDocumentReceiptExtend addPmlEdmDocumentReceiptExtend(
        PmlEdmDocumentReceiptExtend pmlEdmDocumentReceiptExtend)
        throws SystemException {
        pmlEdmDocumentReceiptExtend.setNew(true);

        return pmlEdmDocumentReceiptExtendPersistence.update(pmlEdmDocumentReceiptExtend,
            false);
    }

    public PmlEdmDocumentReceiptExtend createPmlEdmDocumentReceiptExtend(
        long documentReceiptExtendId) {
        return pmlEdmDocumentReceiptExtendPersistence.create(documentReceiptExtendId);
    }

    public void deletePmlEdmDocumentReceiptExtend(long documentReceiptExtendId)
        throws PortalException, SystemException {
        pmlEdmDocumentReceiptExtendPersistence.remove(documentReceiptExtendId);
    }

    public void deletePmlEdmDocumentReceiptExtend(
        PmlEdmDocumentReceiptExtend pmlEdmDocumentReceiptExtend)
        throws SystemException {
        pmlEdmDocumentReceiptExtendPersistence.remove(pmlEdmDocumentReceiptExtend);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlEdmDocumentReceiptExtendPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlEdmDocumentReceiptExtend getPmlEdmDocumentReceiptExtend(
        long documentReceiptExtendId) throws PortalException, SystemException {
        return pmlEdmDocumentReceiptExtendPersistence.findByPrimaryKey(documentReceiptExtendId);
    }

    public List<PmlEdmDocumentReceiptExtend> getPmlEdmDocumentReceiptExtends(
        int start, int end) throws SystemException {
        return pmlEdmDocumentReceiptExtendPersistence.findAll(start, end);
    }

    public int getPmlEdmDocumentReceiptExtendsCount() throws SystemException {
        return pmlEdmDocumentReceiptExtendPersistence.countAll();
    }

    public PmlEdmDocumentReceiptExtend updatePmlEdmDocumentReceiptExtend(
        PmlEdmDocumentReceiptExtend pmlEdmDocumentReceiptExtend)
        throws SystemException {
