...
public abstract class PmlDocumentSendWFLocalServiceBaseImpl
    implements PmlDocumentSendWFLocalService {
    ...
    public PmlDocumentSendWF addPmlDocumentSendWF(
        PmlDocumentSendWF pmlDocumentSendWF) throws SystemException {
        pmlDocumentSendWF.setNew(true);

        return pmlDocumentSendWFPersistence.update(pmlDocumentSendWF, false);
    }

    public PmlDocumentSendWF createPmlDocumentSendWF(long documentSendId) {
        return pmlDocumentSendWFPersistence.create(documentSendId);
    }

    public void deletePmlDocumentSendWF(long documentSendId)
        throws PortalException, SystemException {
        pmlDocumentSendWFPersistence.remove(documentSendId);
    }

    public void deletePmlDocumentSendWF(PmlDocumentSendWF pmlDocumentSendWF)
        throws SystemException {
        pmlDocumentSendWFPersistence.remove(pmlDocumentSendWF);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlDocumentSendWFPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlDocumentSendWF getPmlDocumentSendWF(long documentSendId)
        throws PortalException, SystemException {
        return pmlDocumentSendWFPersistence.findByPrimaryKey(documentSendId);
    }

    public List<PmlDocumentSendWF> getPmlDocumentSendWFs(int start, int end)
        throws SystemException {
        return pmlDocumentSendWFPersistence.findAll(start, end);
    }

    public int getPmlDocumentSendWFsCount() throws SystemException {
        return pmlDocumentSendWFPersistence.countAll();
    }

    public PmlDocumentSendWF updatePmlDocumentSendWF(
        PmlDocumentSendWF pmlDocumentSendWF) throws SystemException {
        pmlDocumentSendWF.setNew(false);

        return pmlDocumentSendWFPersistence.update(pmlDocumentSendWF, true);
    }
