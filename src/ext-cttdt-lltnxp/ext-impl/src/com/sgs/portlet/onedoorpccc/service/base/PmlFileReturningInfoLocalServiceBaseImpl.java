...
public abstract class PmlFileReturningInfoLocalServiceBaseImpl
    implements PmlFileReturningInfoLocalService {
    ...
    public PmlFileReturningInfo addPmlFileReturningInfo(
        PmlFileReturningInfo pmlFileReturningInfo) throws SystemException {
        pmlFileReturningInfo.setNew(true);

        return pmlFileReturningInfoPersistence.update(pmlFileReturningInfo,
            false);
    }

    public PmlFileReturningInfo createPmlFileReturningInfo(
        long fileReturningInfoId) {
        return pmlFileReturningInfoPersistence.create(fileReturningInfoId);
    }

    public void deletePmlFileReturningInfo(long fileReturningInfoId)
        throws PortalException, SystemException {
        pmlFileReturningInfoPersistence.remove(fileReturningInfoId);
    }

    public void deletePmlFileReturningInfo(
        PmlFileReturningInfo pmlFileReturningInfo) throws SystemException {
        pmlFileReturningInfoPersistence.remove(pmlFileReturningInfo);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlFileReturningInfoPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlFileReturningInfo getPmlFileReturningInfo(
        long fileReturningInfoId) throws PortalException, SystemException {
        return pmlFileReturningInfoPersistence.findByPrimaryKey(fileReturningInfoId);
    }

    public List<PmlFileReturningInfo> getPmlFileReturningInfos(int start,
        int end) throws SystemException {
        return pmlFileReturningInfoPersistence.findAll(start, end);
    }

    public int getPmlFileReturningInfosCount() throws SystemException {
        return pmlFileReturningInfoPersistence.countAll();
    }

    public PmlFileReturningInfo updatePmlFileReturningInfo(
        PmlFileReturningInfo pmlFileReturningInfo) throws SystemException {
        pmlFileReturningInfo.setNew(false);

        return pmlFileReturningInfoPersistence.update(pmlFileReturningInfo, true);
    }
