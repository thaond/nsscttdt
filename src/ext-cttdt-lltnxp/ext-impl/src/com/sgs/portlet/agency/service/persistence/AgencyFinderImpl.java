...
public class AgencyFinderImpl extends BasePersistenceImpl implements AgencyFinder{
	...
	public int countByTEN_MA_COQUAN(String[] leaderLastNames,String[] leaderFirstNames,
		...
		try {
			...
			sql = CustomSQLUtil.replaceKeywords(sql, "lower(contact_.lastname)", StringPool.LIKE, false, leaderLastNames);
			sql = CustomSQLUtil.replaceKeywords(sql, "lower(contact_.firstname)", StringPool.LIKE, false, leaderFirstNames);
