...
//		 bookDocumentRecordTo(documentReceiptId, userId, dateArrive);
	...
	/* xuancong close start vi khong su dung 
	private  void bookDocumentRecordTo(long documentReceiptId, long userId, Date dateArrive) {
		//get year current
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(new Date());		
		String yearInUse = String.valueOf(calendar.get(calendar.YEAR));
		
		PmlDepartment department = null;
		try {
			...
			department = PmlDepartmentUtil.findByPrimaryKey(departmentId);
	 ...
	 * @param dateArrive
	 */
	/* xuancong close start vi chua su dung
