...
public class DocumentRecordPBDisplayTerms extends DisplayTerms {
	public static final String LOAI_SO_CV = "loaiSoCV";
	public static final String SO_PB = "phongBan";
	
	protected String loaiSoCV;
	protected String soPB;

	public DocumentRecordPBDisplayTerms(RenderRequest renderRequest) {
		super(renderRequest);
