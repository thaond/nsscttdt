 ...
 *
 */
public class EditFileStatusDocumentAction extends PortletAction {
	...
	public void processAction(
		...
		try {
			...
			if (Validator.isNotNull(cmd)) {
				String documentStatusURL = ParamUtil.getString(actionRequest, "documentStatusURL");
				sendRedirect(actionRequest, actionResponse, documentStatusURL);
			}
			...
			if (e instanceof PmlFileStatusCanNotDeleteException){
				...
				setForward(actionRequest, "portlet.sgs.pmledm_filestatus.edit_filestatus_document");
				SessionErrors.add(actionRequest, e.getClass().getName());
			}
			else {
				throw e;
	...
	public ActionForward render(
		...
		String tabs = ParamUtil.getString(renderRequest, "tabs", "cong-van" );
		...
		if (getForward(renderRequest) != null && !getForward(renderRequest).equals("")) {
			...
			return mapping.findForward("portlet.sgs.pmledm_filestatus.edit_filestatus_document");
