 ...
 *
 */
public class DisplayAction extends PortletAction {
	...
	public void processAction(
		...
		try {
			...
			if (Validator.isNotNull(cmd)) {
				String documentStateURL = ParamUtil.getString(actionRequest, "documentStateURL");
				sendRedirect(actionRequest, actionResponse, documentStateURL);
			}
		} catch (Exception e) {
	...
	public ActionForward render(
		...
		return mapping.findForward("portlet.sgs.pmledm_filestatus.display_stateprocess_document");
	...
	public void deleteFileStatusStateProcess(ActionRequest req, ActionResponse res) throws Exception{
		...
		long statusId = ParamUtil.getLong(req, "statusId");
		List<PmlFileStatusStateProcess> fileStatusStateProcessList = new ArrayList<PmlFileStatusStateProcess>();
