...
//import com.sgs.portlet.onedoorpccc.model.PmlFileAttachReturnInfo;
...
//import com.sgs.portlet.onedoorpccc.service.PmlFileAttachReturnInfoLocalServiceUtil;
...
//		service.updateReceiveDate(fileId, PortalUtil.getUserId(renderRequest));
		
		
		return mapping.findForward("portlet.sgs.onedoorfileprocessed.detail");
	}
	/**
	 * @param req
	 * @param fileId
	...
	private void initDataForRender(PortletRequest req, String fileId) throws Exception {
		...
		//Properties
		// yenlt close 16/10/2010 == ben pmlnew ko co cac truong nay
		/*
		filePcccDTO.setLevelSendId(filePCCC.getLevelSendId());
		filePcccDTO.SetIssuingPlaceId(filePCCC.getIssuingPlaceId());
		filePcccDTO.setIssuingPlaceOrtherName(filePCCC.getIssuingPlaceOrtherName());
		filePcccDTO.setAsignDate(filePCCC.getAsignDate());
		filePcccDTO.setTrate(filePCCC.getTrate());
		filePcccDTO.setDisPraise(filePCCC.getDisPraise());
		filePcccDTO.setContentHSKT(filePCCC.getContentHSKT());
		filePcccDTO.setNumberDoc(filePCCC.getNumberDoc());
		*/
		// end yenlt close 16/10/2010
