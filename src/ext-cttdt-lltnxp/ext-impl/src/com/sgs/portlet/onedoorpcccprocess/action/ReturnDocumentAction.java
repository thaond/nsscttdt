...
import com.sgs.portlet.onedoorpccc.service.PmlFileReturningInfoLocalServiceUtil;
...
public class ReturnDocumentAction extends OneDoorProcessPortletAction {
	...
	public ActionForward renderStruts(ActionMapping mapping, ActionForm form,
		...
		if (getForward(req) != null && !getForward(req).equals("")) {
			...
			initData(req, res);
			return mapping.findForward("portlet.sgs.onedoorpcccprocess.returndocument");
		}
	}
	...
	private boolean saveReturnDocumentInfo(ActionRequest req) throws Exception {
		...
		try {
			...
			//pmlFileReturningInfo.setLicenseNumber(ParamUtil.getString(req, ""));
			//pmlFileReturningInfo.setIssuingDateLicense(ParamUtil.getDate(req, "", DateFormat.getInstance()));
			...
			//pmlFileReturningInfo.setConclude(ParamUtil.getString(req, ""));
