...
public class MeetingCalendarSoap implements Serializable {
    ...
    public static MeetingCalendarSoap[] toSoapModels(MeetingCalendar[] models) {
        MeetingCalendarSoap[] soapModels = new MeetingCalendarSoap[models.length];
    ...
    public static MeetingCalendarSoap[][] toSoapModels(
        MeetingCalendar[][] models) {
        MeetingCalendarSoap[][] soapModels = null;

        if (models.length > 0) {
            soapModels = new MeetingCalendarSoap[models.length][models[0].length];
        } else {
            soapModels = new MeetingCalendarSoap[0][0];
        }
