 ...
 * <code>com.nss.portlet.onedoor.service.http.PmlOneDoorReceiveFileServiceSoap</code>.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.nss.portlet.onedoor.service.http.PmlOneDoorReceiveFileServiceSoap
 *
 */
public class PmlOneDoorReceiveFileSoap implements Serializable {
    ...
    public static PmlOneDoorReceiveFileSoap[] toSoapModels(
        PmlOneDoorReceiveFile[] models) {
        PmlOneDoorReceiveFileSoap[] soapModels = new PmlOneDoorReceiveFileSoap[models.length];
    ...
    public static PmlOneDoorReceiveFileSoap[][] toSoapModels(
        PmlOneDoorReceiveFile[][] models) {
        PmlOneDoorReceiveFileSoap[][] soapModels = null;

        if (models.length > 0) {
            soapModels = new PmlOneDoorReceiveFileSoap[models.length][models[0].length];
        } else {
            soapModels = new PmlOneDoorReceiveFileSoap[0][0];
        }
