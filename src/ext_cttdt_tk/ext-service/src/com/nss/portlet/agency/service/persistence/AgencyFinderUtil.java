...
public class AgencyFinderUtil {
    ...
    public static java.util.List<com.nss.portlet.agency.model.Agency> findByKeywords(
    ...
    public static java.util.List<com.nss.portlet.agency.model.Agency> findTEN_MA_COQUAN(
