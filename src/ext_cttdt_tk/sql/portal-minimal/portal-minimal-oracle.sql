...
create table log_workflow_journal_article (
	logWorkflowJournalArticleId number(30,0) not null primary key,
	resourcePrimkey number(30,0),
	transition number(30,0),
	groupId number(30,0),
	companyId number(30,0),
	userId number(30,0),
	userIds varchar2(75) null,
	dateReceiptOfUserReceipt timestamp null,
	dateProcessOfUserReceipt timestamp null,
	dateSendOfUserReceipt timestamp null,
	useridProcess number(30,0),
	userIdsProcess varchar2(75) null,
	processInformation varchar2(75) null,
	workflowStatusBefore varchar2(75) null,
	workflowStatusAfter varchar2(75) null
);
...
create table nss_contact_book (
	contactBookId number(30,0) not null primary key,
	contactBookCode varchar2(75) null,
	contactBookName varchar2(75) null,
	contactDescription varchar2(75) null,
	contactActive number(1, 0),
	companyid number(30,0),
	userid number(30,0)
);

create table nss_detail_book (
	detailBookId number(30,0) not null primary key,
	detailBookCode varchar2(75) null,
	detailBookName varchar2(75) null,
	detailDescription varchar2(75) null,
	detailActive number(1, 0),
	zip varchar2(75) null,
	internal_ varchar2(75) null,
	home varchar2(75) null,
	mobile varchar2(75) null,
	contactBookId number(30,0),
	companyid number(30,0),
	userid number(30,0)
);
...
create table nss_quan_ly_quy_trinh_duyet_tin (
	managementWorkflowJournalId number(30,0) not null primary key,
	groupId number(30,0),
	companyId number(30,0),
	userId number(30,0),
	processDefinitionId number(30,0),
...
create table nss_workflow_journal_article (
	workflowJournalArticleId number(30,0) not null primary key,
	groupId number(30,0),
	companyId number(30,0),
	userId number(30,0),
	userIds varchar2(75) null,
	...
	resourcePrimkey number(30,0),
	countImageOfArticle number(30,0),
	datecomplete timestamp null,
	statuscurrent varchar2(75) null
);
