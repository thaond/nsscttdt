...
create table InstanceBean (
	processInstanceId int8 not null primary key,
	businessProcessId int8,
	articleId int8,
	categoryId int8,
...
create table JournalProcessDefinition (
	journalProcessDefinitionId int8 not null primary key,
	name varchar(75),
	version varchar(75),
	content varchar(75)
)
...
create table nss_contact_book (
	contactBookId int8 not null primary key,
...
create table nss_detail_book (
	detailBookId int8 not null primary key,
