...
<%@page import="com.nss.portlet.onedoorreport_baocaohosothangluyke.search.BaoCaoHoSoLuyKeSearch"%>
<%@page import="com.nss.portlet.onedoorreport_baocaohosothangluyke.search.BaoCaoHoSoLuyKeSearchTerms"%>
...
<%@page import="com.nss.portlet.onedoor.dto.LoaiHoSoDTO"%>
...
<%@page import="com.nss.portlet.onedoor.dto.BaoCaoHoSoThangLuyKeDTO"%>
<%@page import="com.liferay.portal.kernel.dao.search.ResultRow"%>
<%@page import="com.liferay.portal.kernel.dao.search.SearchContainer"%>
<%@page import="com.nss.portlet.department.model.impl.DepartmentImpl"%>

<portlet:actionURL var="report">
	<portlet:param name="struts_action" value="/nss/onedoorreport_baocaohosothangluyke/view" />
</portlet:actionURL>
...
<%
	...
	portletURL.setParameter("struts_action", "/nss/onedoorreport_baocaohosothangluyke/view" );
...
<div class="parent-title"><liferay-ui:message key="bao-cao-ho-so-luy-ke"/></div>

	<liferay-ui:search-form
			page="/html/portlet/nss/onedoorreport_baocaohosothangluyke/baocaohosoluyke_search.jsp"
	...
	<%
		...
		List<Department> departmentList = DepartmentLocalServiceUtil.search(start1, end1, baoCaoHoSoLuyKeSearch.getOrderByComparator());
		...
		if (departmentList.size() > 0) {
			for ( int i=0; i < baoCaoHoSoThangLuyKeList.size(); i++) {
				...
				tenPBURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
				...
				tonDauKyURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
				...
				hsNhanTrongThangURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
				...
				tongCongURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
				...
				hsNhanTrongNamURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
				...
				giaiQuyetTrongThangURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
				...
				giaiQuyetTrongNamURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
				...
				hsTonURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
				...
				for(int index = 0; index < loaiHoSoSize; index ++) {
					...
					tenLoaiHSURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
					...
					tonDauKyHSURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
					...
					hsNhanTrongThangHSURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
					...
					tongCongHSURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
					...
					hsNhanTrongNamHSURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
					...
					giaiQuyetTrongThangHSURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
					...
					giaiQuyetTrongNamHSURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
					...
					hsTonHSURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
		...
		tongTonDauKyURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
		...
		tonghsNhanTrongThangURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
		...
		tongTongCongURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
		...
		tonghsNhanTrongNamURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
		...
		tongGiaiQuyetTrongThangURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
		...
		tongGiaiQuyetTrongNamURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
		...
		tonghsTonURL.setParameter("struts_action","/nss/onedoorreport_baocaohosothangluyke/filedetails");
