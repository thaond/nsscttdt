...
<%@page import="com.nss.portlet.onedoorreport_tinhhinhthulyhosocapphong.searchfiledetail.PmlOneDoorReceiveFileSearch"%>

<liferay-util:include page="/html/portlet/nss/onedoorreport_tinhhinhthulyhosocapphong/js/onedoorreport_tinhhinhthulyhosocapphong-js.jsp"></liferay-util:include>

<link type="text/css" rel="stylesheet" href="/html/css/changeColorRow.css" />
<link type="text/css" rel="stylesheet" href="/html/portlet/nss/onedoorreport_tinhhinhthulyhosocapphong/css/ex.css" />
...
<portlet:actionURL var="filter">
	<portlet:param name="struts_action"	value="/nss/onedoorreport_tinhhinhthulyhosocapphong/filedetails" />
...
<ul>
	...
	<li style="width: 22%"><div class="btpre_hs" align="left"><liferay-util:include page="/html/portlet/nsst/onedoorreport_tinhhinhthulyhosocapphong/button.jsp"></liferay-util:include></div></li>
	</form>
</ul>
</div>
		...
		<table class="taglib-search-iterator table-pml" cellspacing="0" width="100%">	
						...
						%>
								...
								<portlet:renderURL var="detail"	windowState="<%= LiferayWindowState.EXCLUSIVE.toString() %>">
									<portlet:param name="struts_action"	value="/nss/onedoorreport_tinhhinhthulyhosocapphong/filedetails_detail" />
