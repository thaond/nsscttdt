...
<tr bgcolor="#dbeafc">
	...
	<td>
		<div align="left"><liferay-util:include page="/html/portlet/nss/onedoorreport_tinhhinhthulyhosocapphong/button.jsp"></liferay-util:include></div>
	</td>
</tr>
</table>
</div>
...
type="com.nss.portlet.onedoorprocess.dto.PmlFilePcccDTO" indexId="i">
<%
	String style = "";
	if (i%2 == 0) {
		style = "row3";
