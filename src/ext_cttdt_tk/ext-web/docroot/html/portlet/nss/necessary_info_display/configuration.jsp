		...
		<tr>
			...
			<td align="left">
				<select name="<portlet:namespace />displayStyle" id="<portlet:namespace/>displayStyle" style="width: 71%;">
					...
					<option <%= displayStyleInfo.equals("select") ? "selected" : "" %> value="select"><liferay-ui:message key="select-display" /></option>
					<option <%= displayStyleInfo.equals("image") ? "selected" : "" %> value="image"><liferay-ui:message key="image-display" /></option>
					<option <%= displayStyleInfo.equals("up") ? "selected" : "" %> value="up"><liferay-ui:message key="up-display" /></option>
					<option <%= displayStyleInfo.equals("right") ? "selected" : "" %> value="right"><liferay-ui:message key="right-display" /></option>
		    	</select>
		    </td>
			<td>&nbsp;</td>
		</tr>
