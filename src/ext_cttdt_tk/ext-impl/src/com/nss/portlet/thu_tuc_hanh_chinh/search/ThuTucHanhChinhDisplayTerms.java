...
public class ThuTucHanhChinhDisplayTerms extends DisplayTerms{
	...
	public ThuTucHanhChinhDisplayTerms(PortletRequest portletRequest) {
	...
	public static String getCAP_DON_VI_THU_TUC() {
		return CAP_DON_VI_THU_TUC;
	}
