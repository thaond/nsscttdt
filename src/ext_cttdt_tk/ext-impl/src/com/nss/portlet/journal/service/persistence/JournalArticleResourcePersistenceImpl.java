...
import com.nss.portlet.journal.model.impl.JournalArticleResourceImpl;
import com.nss.portlet.journal.model.impl.JournalArticleResourceModelImpl;
    ...
    public List<JournalArticleResource> findByGroupId(long groupId)
        ...
        if (list == null) {
            ...
            try {
                ...
                query.append(
                    "FROM com.nss.portlet.journal.model.JournalArticleResource WHERE ");
    ...
    public List<JournalArticleResource> findAll(int start, int end,
        ...
        if (list == null) {
            ...
            try {
                ...
                query.append(
                    "FROM com.nss.portlet.journal.model.JournalArticleResource ");
        ...
        if (count == null) {
            ...
            try {
                ...
                Query q = session.createQuery(
                        "SELECT COUNT(*) FROM com.nss.portlet.journal.model.JournalArticleResource");
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.portal.util.PropsUtil.get(
                        "value.object.listener.com.nss.portlet.journal.model.JournalArticleResource")));
