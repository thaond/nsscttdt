...
import com.nss.portlet.journal.model.JournalFeedSoap;
...
public class JournalFeedModelImpl extends BaseModelImpl<JournalFeed> {
    ...
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.portal.util.PropsUtil.get(
                "value.object.entity.cache.enabled.com.nss.portlet.journal.model.JournalFeed"),
            true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.portal.util.PropsUtil.get(
                "value.object.finder.cache.enabled.com.nss.portlet.journal.model.JournalFeed"),
            true);
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.portal.util.PropsUtil.get(
                "lock.expiration.time.com.nss.portlet.journal.model.JournalFeed"));
    ...
    public JournalFeed toEscapedModel() {
        if (isEscapedModel()) {
            ...
            model.setFeedId(HtmlUtil.escape(getFeedId()));
    ...
    public String toXmlString() {
        ...
        sb.append("com.nss.portlet.journal.model.JournalFeed");
