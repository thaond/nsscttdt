...
import com.nss.portlet.journal.model.impl.JournalArticleImageImpl;
import com.nss.portlet.journal.model.impl.JournalArticleImageModelImpl;
    ...
    public List<JournalArticleImage> findByGroupId(long groupId)
        ...
        if (list == null) {
            ...
            try {
                ...
                query.append(
                    "FROM com.nss.portlet.journal.model.JournalArticleImage WHERE ");
    ...
    public List<JournalArticleImage> findAll(int start, int end,
        ...
        if (list == null) {
            ...
            try {
                ...
                query.append(
                    "FROM com.nss.portlet.journal.model.JournalArticleImage ");
        ...
        if (count == null) {
            ...
            try {
                ...
                Query q = session.createQuery(
                        "SELECT COUNT(*) FROM com.nss.portlet.journal.model.JournalArticleImage");
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.portal.util.PropsUtil.get(
                        "value.object.listener.com.nss.portlet.journal.model.JournalArticleImage")));
