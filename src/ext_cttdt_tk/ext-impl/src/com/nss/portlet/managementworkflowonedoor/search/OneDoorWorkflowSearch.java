 ...
 * 
 */
package com.nss.portlet.managementworkflowonedoor.search;
...
import com.nss.portlet.managementworkflowonedoor.util.OneDoorWorkflowUtil;
	...
	public OneDoorWorkflowSearch(RenderRequest renderRequest, PortletURL iteratorURL){
		...
		try {
			 ...
			 if(Validator.isNotNull(orderByCol)&& Validator.isNotNull(orderByType)){
				 ...
				 preferences.setValue("NSS_WORKFLOW_ADMIN", "onedoorworkflow-order-by-column",orderByCol);
				 preferences.setValue("NSS_WORKFLOW_ADMIN", "onedoorworkflow-order-by-type",orderByType);
			 }else{
				 preferences.setValue("NSS_WORKFLOW_ADMIN", "onedoorworkflow-order-by-column", "sgs_filetype_filetypeName");
				 preferences.setValue("NSS_WORKFLOW_ADMIN", "onedoorworkflow-order-by-type", "asc");
			 }
