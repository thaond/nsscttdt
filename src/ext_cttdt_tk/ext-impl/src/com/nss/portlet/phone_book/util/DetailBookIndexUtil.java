...
public class DetailBookIndexUtil implements Runnable{
	public DetailBookIndexUtil (long companyId) {
	...
	private static Log _log = LogFactoryUtil.getLog(DetailBookIndexUtil.class);
