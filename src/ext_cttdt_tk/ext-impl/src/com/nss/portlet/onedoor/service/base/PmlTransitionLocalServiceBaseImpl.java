...
public abstract class PmlTransitionLocalServiceBaseImpl
    implements PmlTransitionLocalService {
    ...
    public PmlTransition addPmlTransition(PmlTransition pmlTransition)
        throws SystemException {
        pmlTransition.setNew(true);

        return pmlTransitionPersistence.update(pmlTransition, false);
    }

    public PmlTransition createPmlTransition(long transitionId) {
        return pmlTransitionPersistence.create(transitionId);
    }

    public void deletePmlTransition(long transitionId)
        throws PortalException, SystemException {
        pmlTransitionPersistence.remove(transitionId);
    }

    public void deletePmlTransition(PmlTransition pmlTransition)
        throws SystemException {
        pmlTransitionPersistence.remove(pmlTransition);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlTransitionPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlTransition getPmlTransition(long transitionId)
        throws PortalException, SystemException {
        return pmlTransitionPersistence.findByPrimaryKey(transitionId);
    }

    public List<PmlTransition> getPmlTransitions(int start, int end)
        throws SystemException {
        return pmlTransitionPersistence.findAll(start, end);
    }

    public int getPmlTransitionsCount() throws SystemException {
        return pmlTransitionPersistence.countAll();
    }

    public PmlTransition updatePmlTransition(PmlTransition pmlTransition)
        throws SystemException {
        pmlTransition.setNew(false);

        return pmlTransitionPersistence.update(pmlTransition, true);
    }
    ...
    public PmlTransition updatePmlTransition(PmlTransition pmlTransition,
        ...
        return pmlTransitionPersistence.update(pmlTransition, merge);
    }
