...
public class PmlFileStatusFinderImpl extends BasePersistenceImpl implements PmlFileStatusFinder{
	 ...
	 * @throws SystemException
	 */
	public List<com.nss.portlet.onedoor.model.PmlFileStatus> findByKeywordsMC(String keywords,int start, int end, OrderByComparator obc) throws SystemException{
		String[] fileStatusCodes = null;
		String[] fileStatusNames = null;
