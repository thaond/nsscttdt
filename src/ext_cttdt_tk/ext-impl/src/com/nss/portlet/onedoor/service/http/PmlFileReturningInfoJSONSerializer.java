 ...
 * <code>com.nss.portlet.onedoor.service.http.PmlFileReturningInfoServiceJSON</code>
 * to translate objects.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.nss.portlet.onedoor.service.http.PmlFileReturningInfoServiceJSON
 *
 */
public class PmlFileReturningInfoJSONSerializer {
    ...
    public static JSONArray toJSONArray(
        com.nss.portlet.onedoor.model.PmlFileReturningInfo[] models) {
    ...
    public static JSONArray toJSONArray(
        List<com.nss.portlet.onedoor.model.PmlFileReturningInfo> models) {
        JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
