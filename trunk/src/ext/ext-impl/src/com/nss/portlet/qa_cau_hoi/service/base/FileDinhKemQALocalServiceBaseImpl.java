...
public abstract class FileDinhKemQALocalServiceBaseImpl
    implements FileDinhKemQALocalService {
    ...
    public FileDinhKemQA addFileDinhKemQA(FileDinhKemQA fileDinhKemQA)
        throws SystemException {
        fileDinhKemQA.setNew(true);

        return fileDinhKemQAPersistence.update(fileDinhKemQA, false);
    }

    public FileDinhKemQA createFileDinhKemQA(long maFileDinhKemQA) {
        return fileDinhKemQAPersistence.create(maFileDinhKemQA);
    }

    public void deleteFileDinhKemQA(long maFileDinhKemQA)
        throws PortalException, SystemException {
        fileDinhKemQAPersistence.remove(maFileDinhKemQA);
    }

    public void deleteFileDinhKemQA(FileDinhKemQA fileDinhKemQA)
        throws SystemException {
        fileDinhKemQAPersistence.remove(fileDinhKemQA);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return fileDinhKemQAPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public FileDinhKemQA getFileDinhKemQA(long maFileDinhKemQA)
        throws PortalException, SystemException {
        return fileDinhKemQAPersistence.findByPrimaryKey(maFileDinhKemQA);
    }

    public List<FileDinhKemQA> getFileDinhKemQAs(int start, int end)
        throws SystemException {
        return fileDinhKemQAPersistence.findAll(start, end);
    }

    public int getFileDinhKemQAsCount() throws SystemException {
        return fileDinhKemQAPersistence.countAll();
    }

    public FileDinhKemQA updateFileDinhKemQA(FileDinhKemQA fileDinhKemQA)
        throws SystemException {
        fileDinhKemQA.setNew(false);

        return fileDinhKemQAPersistence.update(fileDinhKemQA, true);
    }
    ...
    public FileDinhKemQA updateFileDinhKemQA(FileDinhKemQA fileDinhKemQA,
        ...
        return fileDinhKemQAPersistence.update(fileDinhKemQA, merge);
    }
