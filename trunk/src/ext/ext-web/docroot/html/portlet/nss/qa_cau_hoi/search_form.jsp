...
<table class="vanbanphapquy-table">
		...
		<tr>
			...
			<td align="left">
				<select name="<portlet:namespace /><%= CauHoiQADisplayTerms.MA_CHU_DE_CAU_HOI%>" id="select2" style="width: 89%;">
		...
		<tr>
			...
			<td align="left">
				<input name="<portlet:namespace/><%= CauHoiQADisplayTerms.TIEU_DE_CAU_HOI %>" size="20" type="text" value="<%= HtmlUtil.escape(displayTerms.getTieuDeCauHoi()) %>" />
			</td>
		</tr>
	</table>	
<br/>
