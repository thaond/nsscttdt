...
<table class="ltr-table" width="100%" style="margin-bottom:10px;">
	<tr valign="top">
		<td width="50%" rowspan="2">
			<c:choose>
				<c:when test='<%= tabs1_.equals("calendar-release") %>'>
...
%>
	...
	<table width="100%">
		<tr>
			...
			<td align="center"><span style='font-size:14.0pt;line-height:115%;font-family:"Times New Roman"'><b>PH&#7908; L&#7908;C L&#7882;CH C&#212;NG T&#193;C TU&#7846;N DO C&#193;C PH&#210;NG BAN</b></span></td>
		</tr>
		<tr>
			<td></td>
...
<table background="/html/portlet/ext/meeting_calendar/bg.gif"  border="1" bordercolor="#0a8d31" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" width="100%">
	<tr bgcolor="#087329" height="25" >
		...
		<td class= "titleCal" align="center">
			<font color="white" ><%= LanguageUtil.get(pageContext, "chieu-toi").toUpperCase() %></font>
		</td>
	</tr>
<%
for (int i = 0; i < 7; i++) {
...
<table class="lfr-table">
	...
	<tr>
		<td class="focusWeek" valign="top" width="10%"><liferay-ui:message key ="luu-y"/> :</td>
		<td>
		<%= note %>			
		</td>
	</tr>
	...
	<tr>
		<td class="focusWeek" valign="top" width="10%"><liferay-ui:message key ="noi-nhan"/> :</td>
		<td>
		<br/><%= receive %>			
		</td>
	</tr>
