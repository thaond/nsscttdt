...
<div class="commom-form">
 <form action="<%= portletURL.toString() %>" enctype="multipart/form-data" method="post" name="<portlet:namespace />fm" onsubmit="return checkFormAddMediaLibrary();">
		...
		<table width="100%" border="0" class="common-table">
		    ...
		    <tr>
			    ...
			    <td align="left">
						...
						%>
						<option value="<%= mediaChuDe.getMaMediaChuDe() %>" ><%= mediaChuDe.getTenMediaChuDe() %></option>
						<%
							}
						%>
			    	</select>
			...
			<tr>
				...
				<td>
					<input type="text" name="<portlet:namespace />tieuDe" class="form-input-box" /></td>
				<td>&nbsp;</td>
			</tr>
		    ...
		    <tr>
				...
				<td><input type="checkbox" name="<portlet:namespace />active" checked="checked"></td>
				<td>&nbsp;</td>
			</tr>
