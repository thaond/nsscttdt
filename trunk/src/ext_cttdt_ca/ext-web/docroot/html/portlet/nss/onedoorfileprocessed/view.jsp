...
<%@page import="com.nss.portlet.onedoorfileprocessed.search.OneDoorFileProcessedSearch"%>

<liferay-util:include page="/html/portlet/nss/onedoorfileprocessed/js/onedoorfileprocessed-js.jsp"></liferay-util:include>
...
<%
	...
	portletURLView.setParameter("struts_action","/nss/onedoorfileprocessed/view");
	...
	<div id="listdiv">
		<ul>
				<form id="filter" name="<portlet:namespace/>fm" action="<%=filter %>" onsubmit="return checkBeginEndDate()" method="post">
					...
					<li style="width: 20%;">
						<div class="btpre_hs" align="left"><liferay-util:include page="/html/portlet/nss/onedoorfileprocessed/button.jsp"></liferay-util:include></div>
					</li>
	...
	<div id="outer-1" class="outer-1">
					...
					<tr class="portlet-section-header results-header" >
							...
							<%
								...
								portletURL.setParameter("struts_action", "/nss/onedoorfileprocessed/view");
						...
						<portlet:renderURL var="detail"	windowState="<%= LiferayWindowState.EXCLUSIVE.toString() %>">
							<portlet:param name="struts_action"	value="/nss/onedoorfileprocessed/detail" />
