...
<%@page import="com.nss.portlet.onedoorprocess.searchresult.PmlOneDoorReceiveFileSearchResult"%>
		...
		<div id="listdivpccc">
			<div id="listdiv" >
				...
				<tr>
					...
					<td><div align="center"><%@ include file="/html/portlet/nss/onedoorprocess/button.jsp" %></div></td>
				</tr>
			</table>
		</div>	
					...
					<div >
						...
						<tr class="portlet-section-header results-header" >
							...
							<%
								...
								portletURL.setParameter("struts_action", "/nss/onedoorprocess/searchresult");
