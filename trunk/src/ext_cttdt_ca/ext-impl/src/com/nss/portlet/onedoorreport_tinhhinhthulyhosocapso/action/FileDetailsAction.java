...
import com.nss.portlet.department.service.persistence.PmlUserUtil;
...
import com.nss.portlet.onedoorreport_tinhhinhthulyhosocapso.searchfiledetail.PmlOneDoorReceiveFileSearch;
...
public class FileDetailsAction extends PortletAction {
	...
	public ActionForward render(ActionMapping mapping, ActionForm form,
		...
		if (getForward(req) != null && !getForward(req).equals("")) {
			...
			return mapping.findForward("portlet.nss.onedoorreport_tinhhinhthulyhosocapso.filedetails");
		}
	}
