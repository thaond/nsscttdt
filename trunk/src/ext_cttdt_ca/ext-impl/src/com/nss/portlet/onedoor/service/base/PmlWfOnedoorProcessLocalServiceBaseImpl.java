...
public abstract class PmlWfOnedoorProcessLocalServiceBaseImpl
    implements PmlWfOnedoorProcessLocalService {
    ...
    public PmlWfOnedoorProcess addPmlWfOnedoorProcess(
        PmlWfOnedoorProcess pmlWfOnedoorProcess) throws SystemException {
        pmlWfOnedoorProcess.setNew(true);

        return pmlWfOnedoorProcessPersistence.update(pmlWfOnedoorProcess, false);
    }

    public PmlWfOnedoorProcess createPmlWfOnedoorProcess(String fileId) {
        return pmlWfOnedoorProcessPersistence.create(fileId);
    }

    public void deletePmlWfOnedoorProcess(String fileId)
        throws PortalException, SystemException {
        pmlWfOnedoorProcessPersistence.remove(fileId);
    }

    public void deletePmlWfOnedoorProcess(
        PmlWfOnedoorProcess pmlWfOnedoorProcess) throws SystemException {
        pmlWfOnedoorProcessPersistence.remove(pmlWfOnedoorProcess);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlWfOnedoorProcessPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlWfOnedoorProcess getPmlWfOnedoorProcess(String fileId)
        throws PortalException, SystemException {
        return pmlWfOnedoorProcessPersistence.findByPrimaryKey(fileId);
    }

    public List<PmlWfOnedoorProcess> getPmlWfOnedoorProcesses(int start, int end)
        throws SystemException {
        return pmlWfOnedoorProcessPersistence.findAll(start, end);
    }

    public int getPmlWfOnedoorProcessesCount() throws SystemException {
        return pmlWfOnedoorProcessPersistence.countAll();
    }

    public PmlWfOnedoorProcess updatePmlWfOnedoorProcess(
        PmlWfOnedoorProcess pmlWfOnedoorProcess) throws SystemException {
        pmlWfOnedoorProcess.setNew(false);

        return pmlWfOnedoorProcessPersistence.update(pmlWfOnedoorProcess, true);
    }

    public PmlWfOnedoorProcess updatePmlWfOnedoorProcess(
        PmlWfOnedoorProcess pmlWfOnedoorProcess, boolean merge)
        throws SystemException {
        pmlWfOnedoorProcess.setNew(false);

        return pmlWfOnedoorProcessPersistence.update(pmlWfOnedoorProcess, merge);
    }
