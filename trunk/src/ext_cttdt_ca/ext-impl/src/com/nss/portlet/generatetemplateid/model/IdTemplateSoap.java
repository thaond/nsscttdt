 ...
 * <code>com.nss.portlet.generatetemplateid.service.http.IdTemplateServiceSoap</code>.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.nss.portlet.generatetemplateid.service.http.IdTemplateServiceSoap
 *
 */
public class IdTemplateSoap implements Serializable {
    ...
    public static IdTemplateSoap[] toSoapModels(IdTemplate[] models) {
        IdTemplateSoap[] soapModels = new IdTemplateSoap[models.length];
    ...
    public static IdTemplateSoap[][] toSoapModels(IdTemplate[][] models) {
        IdTemplateSoap[][] soapModels = null;

        if (models.length > 0) {
            soapModels = new IdTemplateSoap[models.length][models[0].length];
        } else {
            soapModels = new IdTemplateSoap[0][0];
        }
