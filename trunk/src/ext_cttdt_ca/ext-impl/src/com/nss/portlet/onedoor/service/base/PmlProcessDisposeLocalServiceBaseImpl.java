...
public abstract class PmlProcessDisposeLocalServiceBaseImpl
    implements PmlProcessDisposeLocalService {
    ...
    public PmlProcessDispose addPmlProcessDispose(
        PmlProcessDispose pmlProcessDispose) throws SystemException {
        pmlProcessDispose.setNew(true);

        return pmlProcessDisposePersistence.update(pmlProcessDispose, false);
    }

    public PmlProcessDispose createPmlProcessDispose(long processDisposeId) {
        return pmlProcessDisposePersistence.create(processDisposeId);
    }

    public void deletePmlProcessDispose(long processDisposeId)
        throws PortalException, SystemException {
        pmlProcessDisposePersistence.remove(processDisposeId);
    }

    public void deletePmlProcessDispose(PmlProcessDispose pmlProcessDispose)
        throws SystemException {
        pmlProcessDisposePersistence.remove(pmlProcessDispose);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlProcessDisposePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlProcessDispose getPmlProcessDispose(long processDisposeId)
        throws PortalException, SystemException {
        return pmlProcessDisposePersistence.findByPrimaryKey(processDisposeId);
    }

    public List<PmlProcessDispose> getPmlProcessDisposes(int start, int end)
        throws SystemException {
        return pmlProcessDisposePersistence.findAll(start, end);
    }

    public int getPmlProcessDisposesCount() throws SystemException {
        return pmlProcessDisposePersistence.countAll();
    }

    public PmlProcessDispose updatePmlProcessDispose(
        PmlProcessDispose pmlProcessDispose) throws SystemException {
        pmlProcessDispose.setNew(false);

        return pmlProcessDisposePersistence.update(pmlProcessDispose, true);
    }

    public PmlProcessDispose updatePmlProcessDispose(
        PmlProcessDispose pmlProcessDispose, boolean merge)
        throws SystemException {
        pmlProcessDispose.setNew(false);

        return pmlProcessDisposePersistence.update(pmlProcessDispose, merge);
    }
