...
import com.nss.portlet.onedoor.dto.BaoCaoHoSoThangLuyKeDTO;
import com.nss.portlet.onedoor.dto.LoaiHoSoDTO;
import com.nss.portlet.onedoor.service.PmlOneDoorReceiveFileLocalServiceUtil;
import com.nss.portlet.onedoor.util.BaoCaoHoSoThangLuyKeUtil;
import com.nss.portlet.onedoorreport_baocaohosothangluyke.search.BaoCaoHoSoLuyKeDisplayTerms;
...
public class ViewAction extends PortletAction {
	...
	public ActionForward render(ActionMapping mapping, ActionForm form,
			...
			if (getForward(req) != null && !getForward(req).equals("")) {
				...
				return mapping.findForward("portlet.nss.onedoorreport_baocaohosothangluyke.view");
			}
	}
	...
	public List<BaoCaoHoSoThangLuyKeDTO> getBaoCaoHoSoThangLuyKeReport(String fromDate, String toDate, List<String> typeList, List<String> valueTypeList, int start, int end , OrderByComparator obc) throws Exception {
		...
		for(int index = 0; index < pmlDepartmentList.size(); index ++) {
			...
			try {
				pmlUserList = PmlUserLocalServiceUtil.findByDepartmentsId(pmlDepartmentId);
			} catch (Exception e) {
