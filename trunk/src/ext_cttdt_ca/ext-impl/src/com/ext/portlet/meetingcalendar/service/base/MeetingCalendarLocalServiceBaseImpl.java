...
public abstract class MeetingCalendarLocalServiceBaseImpl
    implements MeetingCalendarLocalService {
    ...
    public MeetingCalendar addMeetingCalendar(MeetingCalendar meetingCalendar)
        throws SystemException {
        meetingCalendar.setNew(true);

        return meetingCalendarPersistence.update(meetingCalendar, false);
    }

    public MeetingCalendar createMeetingCalendar(long mcalId) {
        return meetingCalendarPersistence.create(mcalId);
    }

    public void deleteMeetingCalendar(long mcalId)
        throws PortalException, SystemException {
        meetingCalendarPersistence.remove(mcalId);
    }

    public void deleteMeetingCalendar(MeetingCalendar meetingCalendar)
        throws SystemException {
        meetingCalendarPersistence.remove(meetingCalendar);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return meetingCalendarPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public MeetingCalendar getMeetingCalendar(long mcalId)
        throws PortalException, SystemException {
        return meetingCalendarPersistence.findByPrimaryKey(mcalId);
    }

    public List<MeetingCalendar> getMeetingCalendars(int start, int end)
        throws SystemException {
        return meetingCalendarPersistence.findAll(start, end);
    }

    public int getMeetingCalendarsCount() throws SystemException {
        return meetingCalendarPersistence.countAll();
    }

    public MeetingCalendar updateMeetingCalendar(
        MeetingCalendar meetingCalendar) throws SystemException {
        meetingCalendar.setNew(false);

        return meetingCalendarPersistence.update(meetingCalendar, true);
    }

    public MeetingCalendar updateMeetingCalendar(
        MeetingCalendar meetingCalendar, boolean merge)
        throws SystemException {
        meetingCalendar.setNew(false);

        return meetingCalendarPersistence.update(meetingCalendar, merge);
    }
