...
public abstract class MeetingDetailWeekLocalServiceBaseImpl
    implements MeetingDetailWeekLocalService {
    ...
    public MeetingDetailWeek addMeetingDetailWeek(
        MeetingDetailWeek meetingDetailWeek) throws SystemException {
        meetingDetailWeek.setNew(true);

        return meetingDetailWeekPersistence.update(meetingDetailWeek, false);
    }

    public MeetingDetailWeek createMeetingDetailWeek(long mdweekId) {
        return meetingDetailWeekPersistence.create(mdweekId);
    }

    public void deleteMeetingDetailWeek(long mdweekId)
        throws PortalException, SystemException {
        meetingDetailWeekPersistence.remove(mdweekId);
    }

    public void deleteMeetingDetailWeek(MeetingDetailWeek meetingDetailWeek)
        throws SystemException {
        meetingDetailWeekPersistence.remove(meetingDetailWeek);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return meetingDetailWeekPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public MeetingDetailWeek getMeetingDetailWeek(long mdweekId)
        throws PortalException, SystemException {
        return meetingDetailWeekPersistence.findByPrimaryKey(mdweekId);
    }

    public List<MeetingDetailWeek> getMeetingDetailWeeks(int start, int end)
        throws SystemException {
        return meetingDetailWeekPersistence.findAll(start, end);
    }

    public int getMeetingDetailWeeksCount() throws SystemException {
        return meetingDetailWeekPersistence.countAll();
    }

    public MeetingDetailWeek updateMeetingDetailWeek(
        MeetingDetailWeek meetingDetailWeek) throws SystemException {
        meetingDetailWeek.setNew(false);

        return meetingDetailWeekPersistence.update(meetingDetailWeek, true);
    }

    public MeetingDetailWeek updateMeetingDetailWeek(
        MeetingDetailWeek meetingDetailWeek, boolean merge)
        throws SystemException {
        meetingDetailWeek.setNew(false);

        return meetingDetailWeekPersistence.update(meetingDetailWeek, merge);
    }
