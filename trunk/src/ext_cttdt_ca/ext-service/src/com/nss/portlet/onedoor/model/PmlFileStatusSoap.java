 ...
 * <code>com.nss.portlet.onedoor.service.http.PmlFileStatusServiceSoap</code>.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.nss.portlet.onedoor.service.http.PmlFileStatusServiceSoap
 *
 */
public class PmlFileStatusSoap implements Serializable {
    ...
    public static PmlFileStatusSoap[] toSoapModels(PmlFileStatus[] models) {
        PmlFileStatusSoap[] soapModels = new PmlFileStatusSoap[models.length];
    ...
    public static PmlFileStatusSoap[][] toSoapModels(PmlFileStatus[][] models) {
        PmlFileStatusSoap[][] soapModels = null;

        if (models.length > 0) {
            soapModels = new PmlFileStatusSoap[models.length][models[0].length];
        } else {
            soapModels = new PmlFileStatusSoap[0][0];
        }
