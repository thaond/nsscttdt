 ...
 * <code>com.nss.portlet.onedoor.service.http.PmlStateWorkFlowServiceSoap</code>.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.nss.portlet.onedoor.service.http.PmlStateWorkFlowServiceSoap
 *
 */
public class PmlStateWorkFlowSoap implements Serializable {
    ...
    public static PmlStateWorkFlowSoap[] toSoapModels(PmlStateWorkFlow[] models) {
        PmlStateWorkFlowSoap[] soapModels = new PmlStateWorkFlowSoap[models.length];
    ...
    public static PmlStateWorkFlowSoap[][] toSoapModels(
        PmlStateWorkFlow[][] models) {
        PmlStateWorkFlowSoap[][] soapModels = null;

        if (models.length > 0) {
            soapModels = new PmlStateWorkFlowSoap[models.length][models[0].length];
        } else {
            soapModels = new PmlStateWorkFlowSoap[0][0];
        }
