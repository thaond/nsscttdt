...
<%@page import="com.nss.portlet.holidaymanagement.model.PmlHoliday"%>
<%@page import="com.nss.portlet.holidaymanagement.service.PmlHolidayLocalServiceUtil"%>
<%@page import="com.nss.portlet.holidaymanagement.search.HolidaySearch"%>

<portlet:renderURL var="add">
	<portlet:param name="struts_action" value="/nss/holidaymanagement/view" />
...
<%
	...
	displayURL.setParameter("struts_action", "/nss/holidaymanagement/view");
%>
...
<div class="parent-title"><liferay-ui:message key="javax.portlet.title.NSS_HOLIDAYMANAGEMENT"/></div>
	<%
		HolidaySearch holidaySearch = new HolidaySearch(renderRequest, displayURL);
		// URL add
		PortletURL addURL = renderResponse.createRenderURL();
		addURL.setWindowState(WindowState.NORMAL);
		addURL.setParameter("struts_action", "/nss/holidaymanagement/view");
	...
	<%
		...
		List<PmlHoliday> listHoliday = PmlHolidayLocalServiceUtil.getPmlHolidaies(holidaySearch.getStart(), holidaySearch.getEnd());
		int total = PmlHolidayLocalServiceUtil.getPmlHolidaiesCount();
		...
		for (int i = 0; i <listHoliday.size(); i++) {
			...
			rowURLEdit.setParameter("struts_action", "/nss/holidaymanagement/view");
			...
			rowURLDelete.setParameter("struts_action", "/nss/holidaymanagement/view");
