...
<liferay-util:include page="/html/portlet/nss/holidaymanagement/js/holidaymanagement.jsp"></liferay-util:include>
...
<div class="parent-title"><liferay-ui:message key="holiday-ngay-nghi-trong-tuan"/></div>
	<table cellspacing="0" width="100%">	
			<tr>
			<td  width="35px" align="center"><liferay-ui:message key="STT" /></td>
		...
		<tr>
			...
			<td><liferay-ui:message key="calendar.add_personalevent.monday"/></td>
...
<fieldset>
		<label><liferay-ui:message key="holiday-ngay-nghi-le" /></label>
		<input type="hidden" id="stt" value="1" />
		<input type="hidden" id="arr_ngaynghile" name="arr_ngaynghile" value="" />

		<table id="holidayTable" cellspacing="0" width="100%">	
			<tr>
