...
<%@page import="com.nss.portlet.agency.search.AgencySearchTerms"%>
<%@page import="com.nss.portlet.agency.service.AgencyLocalServiceUtil"%>
<%@page import="com.nss.portlet.agency.service.AgencyLocalServiceUtil"%>
<%@page import="com.liferay.portal.service.UserLocalServiceUtil"%>
<%@page import="com.nss.portlet.agency.AgencyCanNotDeleteException"%>
...
<%@page import="com.nss.portlet.agency.NoSuchPmlAgencyLeaderException"%><script type="text/javascript">
...
%>
	...
	<div class="parent-title"><liferay-ui:message key="agency"/></div>
	...
	%>
		<liferay-ui:search-form	page="/html/portlet/nss/agency/search_form.jsp"	searchContainer="<%= agencySearch %>" />	
		<portlet:renderURL var="add">
			<portlet:param name="struts_action" value="/nss/agency/view" />
	...
	<%
		...
		for (int i = 0; i < results.size(); i++) {
			...
			rowURLEdit.setParameter("struts_action","/nss/agency/view");
			...
			rowURLDelete.setParameter("struts_action","/nss/agency/view");
			...
			rowURLActive.setParameter("struts_action","/nss/agency/view");
