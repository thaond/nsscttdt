...
public abstract class PmlFileStatusLocalServiceBaseImpl
    implements PmlFileStatusLocalService {
    ...
    public PmlFileStatus addPmlFileStatus(PmlFileStatus pmlFileStatus)
        throws SystemException {
        pmlFileStatus.setNew(true);

        return pmlFileStatusPersistence.update(pmlFileStatus, false);
    }

    public PmlFileStatus createPmlFileStatus(long fileStatusId) {
        return pmlFileStatusPersistence.create(fileStatusId);
    }
    ...
    public void deletePmlFileStatus(PmlFileStatus pmlFileStatus)
        throws SystemException {
        pmlFileStatusPersistence.remove(pmlFileStatus);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlFileStatusPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlFileStatus getPmlFileStatus(long fileStatusId)
        throws PortalException, SystemException {
        return pmlFileStatusPersistence.findByPrimaryKey(fileStatusId);
    }

    public List<PmlFileStatus> getPmlFileStatuses(int start, int end)
        throws SystemException {
        return pmlFileStatusPersistence.findAll(start, end);
    }

    public int getPmlFileStatusesCount() throws SystemException {
        return pmlFileStatusPersistence.countAll();
    }

    public PmlFileStatus updatePmlFileStatus(PmlFileStatus pmlFileStatus)
        throws SystemException {
        pmlFileStatus.setNew(false);

        return pmlFileStatusPersistence.update(pmlFileStatus, true);
    }
    ...
    public PmlFileStatus updatePmlFileStatus(PmlFileStatus pmlFileStatus,
        ...
        return pmlFileStatusPersistence.update(pmlFileStatus, merge);
    }
