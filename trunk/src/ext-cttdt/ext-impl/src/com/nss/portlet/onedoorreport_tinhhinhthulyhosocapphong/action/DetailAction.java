...
public class DetailAction extends OneDoorProcessPortletAction {
	...
	public ActionForward renderStruts(ActionMapping mapping, ActionForm form,
		...
		return mapping.findForward("portlet.nss.onedoorreport_tinhhinhthulyhosocapphong.filedetails_detail");
	}
	...
	private void initDataForRender(PortletRequest req, String fileId) throws Exception {
		...
		List<PmlStateProcess> list = PmlStateProcessLocalServiceUtil.findByStateProcessCode_Name(stateCode, OneDoorProcessLiferayWorkflowService.TYPE_MC); // yenlt update 23/04/2010
		String state = "";
