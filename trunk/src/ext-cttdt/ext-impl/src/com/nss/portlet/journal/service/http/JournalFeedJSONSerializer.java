 ...
 * <code>com.nss.portlet.journal.service.http.JournalFeedServiceJSON</code>
 * to translate objects.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.nss.portlet.journal.service.http.JournalFeedServiceJSON
 *
 */
public class JournalFeedJSONSerializer {
    ...
    public static JSONArray toJSONArray(
        com.nss.portlet.journal.model.JournalFeed[] models) {
    ...
    public static JSONArray toJSONArray(
        List<com.nss.portlet.journal.model.JournalFeed> models) {
        JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
