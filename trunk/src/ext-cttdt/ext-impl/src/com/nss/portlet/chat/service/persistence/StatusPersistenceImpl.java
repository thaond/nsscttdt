...
import com.nss.portlet.chat.NoSuchStatusException;
import com.nss.portlet.chat.model.Status;
import com.nss.portlet.chat.model.impl.StatusImpl;
import com.nss.portlet.chat.model.impl.StatusModelImpl;
...
public class StatusPersistenceImpl extends BasePersistenceImpl
    ...
    protected com.nss.portlet.chat.service.persistence.EntryPersistence entryPersistence;
    @BeanReference(name = "com.nss.portlet.chat.service.persistence.StatusPersistence.impl")
    protected com.nss.portlet.chat.service.persistence.StatusPersistence statusPersistence;
    ...
    public Status updateImpl(com.nss.portlet.chat.model.Status status,
    ...
    public Status fetchByUserId(long userId, boolean retrieveFromCache)
        ...
        if (result == null) {
            ...
            try {
                ...
                query.append("FROM com.nss.portlet.chat.model.Status WHERE ");
    ...
    public List<Status> findAll(int start, int end, OrderByComparator obc)
        ...
        if (list == null) {
            ...
            try {
                ...
                query.append("FROM com.nss.portlet.chat.model.Status ");
        ...
        if (count == null) {
            ...
            try {
                ...
                Query q = session.createQuery(
                        "SELECT COUNT(*) FROM com.nss.portlet.chat.model.Status");
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.portal.util.PropsUtil.get(
                        "value.object.listener.com.nss.portlet.chat.model.Status")));
