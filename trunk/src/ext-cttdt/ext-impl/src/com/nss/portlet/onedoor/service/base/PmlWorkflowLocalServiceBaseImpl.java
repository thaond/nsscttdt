...
public abstract class PmlWorkflowLocalServiceBaseImpl
    implements PmlWorkflowLocalService {
    ...
    public PmlWorkflow addPmlWorkflow(PmlWorkflow pmlWorkflow)
        throws SystemException {
        pmlWorkflow.setNew(true);

        return pmlWorkflowPersistence.update(pmlWorkflow, false);
    }

    public PmlWorkflow createPmlWorkflow(long workflowId) {
        return pmlWorkflowPersistence.create(workflowId);
    }

    public void deletePmlWorkflow(long workflowId)
        throws PortalException, SystemException {
        pmlWorkflowPersistence.remove(workflowId);
    }

    public void deletePmlWorkflow(PmlWorkflow pmlWorkflow)
        throws SystemException {
        pmlWorkflowPersistence.remove(pmlWorkflow);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlWorkflowPersistence.findWithDynamicQuery(dynamicQuery);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery, int start,
        int end) throws SystemException {
        return pmlWorkflowPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }

    public PmlWorkflow getPmlWorkflow(long workflowId)
        throws PortalException, SystemException {
        return pmlWorkflowPersistence.findByPrimaryKey(workflowId);
    }

    public List<PmlWorkflow> getPmlWorkflows(int start, int end)
        throws SystemException {
        return pmlWorkflowPersistence.findAll(start, end);
    }

    public int getPmlWorkflowsCount() throws SystemException {
        return pmlWorkflowPersistence.countAll();
    }

    public PmlWorkflow updatePmlWorkflow(PmlWorkflow pmlWorkflow)
        throws SystemException {
        pmlWorkflow.setNew(false);

        return pmlWorkflowPersistence.update(pmlWorkflow, true);
    }

    public PmlWorkflow updatePmlWorkflow(PmlWorkflow pmlWorkflow, boolean merge)
        throws SystemException {
        pmlWorkflow.setNew(false);

        return pmlWorkflowPersistence.update(pmlWorkflow, merge);
    }
