 ...
 * <code>com.nss.portlet.onedoor.service.http.PmlWorkflowServiceJSON</code>
 * to translate objects.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.nss.portlet.onedoor.service.http.PmlWorkflowServiceJSON
 *
 */
public class PmlWorkflowJSONSerializer {
    ...
    public static JSONArray toJSONArray(
        com.nss.portlet.onedoor.model.PmlWorkflow[] models) {
    ...
    public static JSONArray toJSONArray(
        List<com.nss.portlet.onedoor.model.PmlWorkflow> models) {
        JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
