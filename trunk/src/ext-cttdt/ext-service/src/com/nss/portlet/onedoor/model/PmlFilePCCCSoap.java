 ...
 * <code>com.nss.portlet.onedoor.service.http.PmlFilePCCCServiceSoap</code>.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.nss.portlet.onedoor.service.http.PmlFilePCCCServiceSoap
 *
 */
public class PmlFilePCCCSoap implements Serializable {
    ...
    public static PmlFilePCCCSoap[] toSoapModels(PmlFilePCCC[] models) {
        PmlFilePCCCSoap[] soapModels = new PmlFilePCCCSoap[models.length];
    ...
    public static PmlFilePCCCSoap[][] toSoapModels(PmlFilePCCC[][] models) {
        PmlFilePCCCSoap[][] soapModels = null;

        if (models.length > 0) {
            soapModels = new PmlFilePCCCSoap[models.length][models[0].length];
        } else {
            soapModels = new PmlFilePCCCSoap[0][0];
        }
