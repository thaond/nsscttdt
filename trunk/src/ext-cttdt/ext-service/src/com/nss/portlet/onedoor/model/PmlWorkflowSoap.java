 ...
 * <code>com.nss.portlet.onedoor.service.http.PmlWorkflowServiceSoap</code>.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.nss.portlet.onedoor.service.http.PmlWorkflowServiceSoap
 *
 */
public class PmlWorkflowSoap implements Serializable {
    ...
    public static PmlWorkflowSoap[] toSoapModels(PmlWorkflow[] models) {
        PmlWorkflowSoap[] soapModels = new PmlWorkflowSoap[models.length];
    ...
    public static PmlWorkflowSoap[][] toSoapModels(PmlWorkflow[][] models) {
        PmlWorkflowSoap[][] soapModels = null;

        if (models.length > 0) {
            soapModels = new PmlWorkflowSoap[models.length][models[0].length];
        } else {
            soapModels = new PmlWorkflowSoap[0][0];
        }
