...
/**
 * <a href="MeetingDetailWeekServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class MeetingDetailWeekServiceUtil {
    private static MeetingDetailWeekService _service;

    public static MeetingDetailWeekService getService() {
        if (_service == null) {
            throw new RuntimeException("MeetingDetailWeekService is not set");
        }
