...
public class MeetingCalComponentUtil {
    ...
    public static void cacheResult(
        ...
        getPersistence().cacheResult(meetingCalComponent);
    }

    public static void cacheResult(
        java.util.List<com.ext.portlet.meetingcalendar.model.MeetingCalComponent> meetingCalComponents) {
        getPersistence().cacheResult(meetingCalComponents);
    }
    ...
    public static com.ext.portlet.meetingcalendar.model.MeetingCalComponent fetchBymcalId(
        ...
        throws com.liferay.portal.SystemException {
        return getPersistence().fetchBymcalId(mcalId, retrieveFromCache);
    }
