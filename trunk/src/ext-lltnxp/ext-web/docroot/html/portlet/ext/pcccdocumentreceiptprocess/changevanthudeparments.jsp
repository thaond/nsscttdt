...
<table cellspacing="0" width="100%">
	...
	<tr valign="top">
		...
		<div id="tabs">
			...
			<ul>
				<li><a href="#tabs-1"><liferay-ui:message key="van-thu-phong" /></a></li>
			...
			<div id="tabs-1">
					<div style="width: 99%" class="Scrollbarauto">
						...
						%>
								...
								<logic:iterate  id="pmlUser" name="vathuDepartmentList" type="com.sgs.portlet.pmluser.model.PmlUser" scope="request" indexId="k">
								<%
