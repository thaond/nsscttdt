...
<table cellspacing="0" width="100%">
	...
	<tr >
		...
		<td>
			<input name="<portlet:namespace /><%= displayTerms.NGAYMOHSCV %>" style="width:35%;" type="text" value='<%= displayTerms.getNgayMoHSCV() != null ? df.format(displayTerms.getNgayMoHSCV()) : "" %>' id="ngaymohscv" />
