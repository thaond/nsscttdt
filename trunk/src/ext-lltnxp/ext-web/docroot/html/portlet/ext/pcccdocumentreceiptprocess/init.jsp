...
int processDateNumberNew = PrefsParamUtil.getInteger(prefs, request, "processDateNumber",0);

String[] dangXuLyChung = prefs.getValues("dangXuLyChung", new String[0]);
String[] dangXuLyTuXuLy = prefs.getValues("dangXuLyTuXuLy", new String[0]);
String[] daXuLyChung = prefs.getValues("daXuLyChung", new String[0]);
String[] daXuLyTuXuLy = prefs.getValues("daXuLyTuXuLy", new String[0]);
