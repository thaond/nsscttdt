...
<table width="100%" cellspacing="0">
	...
	<tr>
		...
		<td width="35%">
	   		...
	   		--%>
	   		<input type="hidden" id="sohieuHidden" value="<%= documentDTO.getDocumentReference() %>">    
	    ...
	    <td >
			<select disabled="disabled" style="width: 99%" name="<portlet:namespace/>documentRecordTypeId" id="socongvancvdtn" onchange="changeDocumentRecordTypeUpdate()">
	...
	<tr>
	    ...
	    <td>
		    <select disabled="disabled" name="<portlet:namespace/>documentTypeId" id="loaicongvancvdtn" style="width:99%" onchange="changeDocumentTypeSend();">
