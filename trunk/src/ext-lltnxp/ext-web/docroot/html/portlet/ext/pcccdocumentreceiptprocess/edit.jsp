...
<input type="hidden" id="soCVdencvdtnHidden" value="<%= numberDocumentReceipt %>"/>
...
<table width="100%" cellspacing="0">
	...
	<tr>
		...
		<td>
			<input type="text" name="<portlet:namespace/>numberDocumentReceipt" id="soCVdencvdtn" style="width:92%" 
					value='<%= numberDocumentReceipt != null ? numberDocumentReceipt : "" %>' readonly="readonly">
		</td>
	...
	<tr valign="top">
  	...
  	<tr>
		...
		<td>
			<input style="width:92%" type="text" name="<portlet:namespace/>signer" id="nguoikycvdtn" value='<%= documentReceiptDTO.getSigner() != null ? documentReceiptDTO.getSigner() : ""%>'>
		</td>
