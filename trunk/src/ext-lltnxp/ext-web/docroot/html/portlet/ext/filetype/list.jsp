...
<%@page import="com.sgs.portlet.filetype.search.FileTypeSearchTerms"%>
...
<%@page import="com.sgs.portlet.filetype.FileTypeCanNotDeleteException"%>
...
<div class="title_categ"><liferay-ui:message key="file-type"/></div>
 <div class="boxcontent">
	...
	<liferay-ui:search-form
		page="/html/portlet/ext/filetype/search_form_filetype.jsp"
	...
	<%
		...
		for (int i = 0; i < results.size(); i ++) {
			...
			/* Yenlt 10/03/2010 close start
			if (Integer.parseInt(fileType.getActive()) == 1) {
				active = "<img src='/html/images/checked.gif' border='0' title='active' />";
			} else {
				active = "<img src='/html/images/unchecked.gif' border='0' title='unactive' /></div>";
			}
			Yenlt close end */
			...
			rowURLActive.setParameter("struts_action","/sgs/filetype/view");
			...
			attFileURL = "<a  href='" + rowURLAttFile.toString() + "'><u>" + "<img src='/html/images/iconAttachFile.gif' title='" + LanguageUtil.get(pageContext, "pccc-TN-hosodinhkem") + "'/></u></a>";
