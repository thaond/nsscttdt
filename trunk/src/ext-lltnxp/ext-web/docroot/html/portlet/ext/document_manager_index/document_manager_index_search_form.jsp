...
%>
	...
	<table cellspacing="0" width="100%">
		<tr>
			...
			<td><input name="<portlet:namespace/><%=DocumentManagerIndexDisplayTerms.DOCUMENTMANAGERCODE%>" id ="<portlet:namespace/>documentManagerCodeAutoComplete"
			...
			<td><input name="<portlet:namespace/><%=DocumentManagerIndexDisplayTerms.DOCUMENTMANAGERCATEGORY%>" id ="<portlet:namespace/>documentManagerCategoryAutoComplete"
		...
		<tr>
			...
			<td><input name="<portlet:namespace/><%=DocumentManagerIndexDisplayTerms.DOCUMENTMANAGERDESCRIPTION%>" id ="<portlet:namespace/>documentManagerDescriptionAutoComplete"
			...
			<td><input name="<portlet:namespace/><%=DocumentManagerIndexDisplayTerms.DOCUMENTMANAGERTITLE%>" id ="<portlet:namespace/>documentManagerTitleAutoComplete"
