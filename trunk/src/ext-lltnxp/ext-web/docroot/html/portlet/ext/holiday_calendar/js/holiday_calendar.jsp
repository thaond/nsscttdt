...
<script type="text/javascript">
	...
	function checkValidate(){
		if(checkInput() == false || checkFileUpload() == false || checkDateCreate() == false){
			return false;
		}else{
			fileUpload();
		}
	...
	function checkInput(){
		if(document.<portlet:namespace/>fm.<portlet:namespace/>holidayCalendarCode.value == ""){
			alert("<liferay-ui:message key='input-holiday-calendar-code'/>");
			return false;
		}
	}
