...
<%@page
	import="com.sgs.portlet.report_registry_work_index.search.ReportRegistryIndexDisplayTerms"%>
<%@page
	import="com.sgs.portlet.report_registry_work_index.search.ReportRegistryIndexSearch"%>
<%@page
...
<%
	ReportRegistryIndexSearch reportRegistrySearch = (ReportRegistryIndexSearch) request
			.getAttribute("liferay-ui:search:searchContainer");
	ReportRegistryIndexDisplayTerms displayTerms = (ReportRegistryIndexDisplayTerms) reportRegistrySearch
			.getDisplayTerms();
...
<table cellspacing="0" width="100%">
	<tr>
		...
		<td><input
			name="<portlet:namespace/><%=ReportRegistryIndexDisplayTerms.REPORTREGISTRYCODE%>"
		...
		<td><input
			name="<portlet:namespace/><%=ReportRegistryIndexDisplayTerms.RESULTWORK%>"
			style="width: 95%" type="text"
		...
		<td><input
			name="<portlet:namespace/><%=ReportRegistryIndexDisplayTerms.PROGRAMWORK%>"
			style="width: 95%" type="text"
	...
	<tr>
		...
		<td><input
			name="<portlet:namespace/><%=ReportRegistryIndexDisplayTerms.USERCREATE%>"
			style="width: 95%" type="text"
	...
	<tr>
		...
		<td><select
			name="<portlet:namespace/><%=ReportRegistryIndexDisplayTerms.DEPARTMENT%>"
			style="width: 140px;">
