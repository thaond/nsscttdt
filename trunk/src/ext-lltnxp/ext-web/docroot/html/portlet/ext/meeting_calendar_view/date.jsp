...
<div class="title_categ"><liferay-ui:message key="lich-ngay" /></div>
...
<table border="0" cellspacing="0" width="100%">
				<tr>
					<td >
						<table border="0" cellspacing="0" width="100%">
							<tr>
								<td class="maintitle" align="center"><img src="/html/portlet/ext/meeting_calendar_view/Lich_files/tieude.png"></td>
							</tr>
							<tr>
				...
				<tr>								
					<td >
						<div class="bortxtmar">
									<marquee id="slideShow1" behavior="slide" direction="up" height="350" STYLE="filter: revealTrans(TRANSITION=2)"></marquee>
