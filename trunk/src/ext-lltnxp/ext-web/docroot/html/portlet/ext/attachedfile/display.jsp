...
<%@page import="com.sgs.portlet.attachedfile.search.AttachedfileSearchTerms"%>
<%@page import="com.sgs.portlet.attachedfile.service.AttachedFileLocalServiceUtil"%>
<%@page import="com.sgs.portlet.attachedfile.AttachedFileCanNotDeleteException"%>
...
<%
	...
	portletURL.setParameter("struts_action", "/sgs/attachedfile/view");
%>
...
<div class="title_categ"><liferay-ui:message key="attached-file"/></div>
 <div class="boxcontent">
	...
	<liferay-ui:search-form
		page="/html/portlet/ext/attachedfile/search_form.jsp"
	...
	<%
		...
		for ( int i=0; i<results.size(); i++) {
			...
			rowURLEdit.setParameter("struts_action","/sgs/attachedfile/view");
			...
			rowURLDelete.setParameter("struts_action","/sgs/attachedfile/view");
			...
			rowURLActive.setParameter("struts_action","/sgs/attachedfile/view");
