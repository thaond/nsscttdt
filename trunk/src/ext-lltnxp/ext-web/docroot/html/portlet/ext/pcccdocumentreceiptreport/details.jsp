...
<%
	...
	redirectDetail += "&radioTenChuyenVien=" + radioTenChuyenVien + "&radioTenPhongBan=" + radioTenPhongBan;
	//end yenlt 28062010
...
<form method="post" id="<portlet:namespace/>fm" name="<portlet:namespace/>fm">
		...
		<table cellspacing="0" width="100%" class="tabldtail">
				...
				<tr>
					...
					--%>
				    <td class="td-left" nowrap="nowrap"><label><liferay-ui:message key="pccc-cvdtn-loaicongvan"/>:</label></td>
				...
				<tr>
					<td class="td-left" valign="top" rowspan="2"><label><liferay-ui:message key="pccc-cvdtn-hosocongviec"/>:</label></td>
					<td class="td-right" rowspan="2">
						<div class="cvd-filedinhkem">
							<logic:iterate id="pmlHoSoCongViec" name="pmlHoSoCongViecList" indexId="i" type="com.sgs.portlet.pml_ho_so_cong_viec.model.PmlHoSoCongViec"  >
								<span id="stt">- &nbsp;</span><%= pmlHoSoCongViec.getTieuDe() %>
					        </logic:iterate>
						 </div>	 
					</td>
				...
				<tr>
					<td class="td-left">
							<label><liferay-ui:message key="cach-thuc-xu-ly"/>:</label>
					</td>
					<td class="td-right">
							<div class="cvd-filedinhkem" >
										<logic:iterate id="listprocesstype_doc" name="listprocesstype_doc" type="com.ext.portlet.processtype.model.ProcessType" scope="request" indexId="j" >
											<span id="stt">- &nbsp;</span><%= listprocesstype_doc.getName()%>
								        </logic:iterate>
							</div>
					</td>
				</tr>
				...
				<tr height="100">
					...
					<td valign="top" class="td-right"><textarea class="textarea-display" readonly="" rows="6"><%=documentDTO.getBriefContent() %></textarea></td>
					<td class="td-left"></td>
					<td class="td-right"></td>
				</tr>
				
				<tr>
				    <td valign="top" class="td-left" nowrap="nowrap"><label><liferay-ui:message key="pccc-cvdtn-toanvan"/>:</label></td>
				    <td class="td-right">
				...
				<tr>
					...
					<td class="td-right"><%=(expireDateProcess != null && expireDateProcess.trim().length() > 0) ? expireDateProcess : "Kh\u00f4ng gi\u1EDBi h\u1ea1n." %></td>
				</tr>
				
				<tr>
					<td class="td-left" nowrap="nowrap"><label><liferay-ui:message key="pccc-TN-phongbanthulychinh"/>:</label></td>
					<td class="td-right"><%=mainDepartmentName %></td>
					<td class="td-left" nowrap="nowrap"><label><liferay-ui:message key="pccc-TN-nguoithulychinh"/>:</label></td>
				...
				<tr>
					...
					<%
						...
						try {
							...
							documentReceipt = PmlEdmDocumentReceiptLocalServiceUtil.getPmlEdmDocumentReceipt(documentReceiptId);
...
%>
<!-- end phan hien thi chi tiet gia han thoi gian xu ly vb -->
...
<legend class="laborder"><liferay-ui:message key="pccc-XL-thongtinthaydoicachthucxuly"/></legend>
	<div class="Scrollbarauto">
				<table class="taglib-search-iterator table-pml" cellspacing="0" width="100%">	
						<tr class="portlet-section-header results-header" >
							<td width="35px"><liferay-ui:message key="pccc-TN-stt"/></td>
							<td width="15%"><liferay-ui:message key="person-processtype"/></td>
							<td width="15%"><liferay-ui:message key="date-start-processtype"/></td>
...
<legend class="laborder"><liferay-ui:message key="link-document-exist"/></legend>
	...
	<table class="taglib-search-iterator table-pml" cellspacing="0" width="100%">	
			...
			<table class="taglib-search-iterator table-pml" cellspacing="0" width="100%">	
				...
				%>
							<tr style="height: 25px; text-align: left;" class="<%= (k % 2) == 1 ? "results-row" : "tr_two results-row" %>">
								<td>
