...
public class PmlHoSoCongViecLocalServiceUtil {
    ...
    public static int searchCount(long userId, java.lang.String soHieuHSCV,
        ...
        return getService()
                   .searchCount(userId, soHieuHSCV, tieuDe, ngayMoHSCV,
    ...
    public static java.util.List<com.sgs.portlet.pml_ho_so_cong_viec.model.PmlHoSoCongViec> search(
        ...
        throws com.liferay.portal.SystemException {
        return getService()
                   .search(userId, soHieuHSCV, tieuDe, ngayMoHSCV, idLinhVuc,
