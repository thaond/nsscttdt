...
/**
 * <a href="PmlEdmCadreServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class PmlEdmCadreServiceUtil {
    private static PmlEdmCadreService _service;

    public static PmlEdmCadreService getService() {
        if (_service == null) {
            throw new RuntimeException("PmlEdmCadreService is not set");
        }
