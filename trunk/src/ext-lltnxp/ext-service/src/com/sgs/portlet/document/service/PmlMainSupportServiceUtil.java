...
/**
 * <a href="PmlMainSupportServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class PmlMainSupportServiceUtil {
    private static PmlMainSupportService _service;

    public static PmlMainSupportService getService() {
        if (_service == null) {
            throw new RuntimeException("PmlMainSupportService is not set");
        }
