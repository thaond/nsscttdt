...
public interface LoaiVanBanNoiBoFinder {
    ...
    public java.util.List<com.sgs.portlet.loaivanbannoibo.model.LoaiVanBanNoiBo> findByKeywords(
        java.lang.String keywords, int start, int end,
        com.liferay.portal.kernel.util.OrderByComparator obc)
        throws com.liferay.portal.SystemException;

    public java.util.List<com.sgs.portlet.loaivanbannoibo.model.LoaiVanBanNoiBo> find_loai_van_ban_noi_bo(
        java.lang.String kyHieuLoaiVanBanNoiBos,
