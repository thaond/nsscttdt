...
/**
 * <a href="PmlEdmIssuingPlaceServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class PmlEdmIssuingPlaceServiceUtil {
    private static PmlEdmIssuingPlaceService _service;

    public static PmlEdmIssuingPlaceService getService() {
        if (_service == null) {
            throw new RuntimeException("PmlEdmIssuingPlaceService is not set");
        }
