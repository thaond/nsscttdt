...
/**
 * <a href="PmlEdmDocumentReceiptServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class PmlEdmDocumentReceiptServiceUtil {
    private static PmlEdmDocumentReceiptService _service;

    public static PmlEdmDocumentReceiptService getService() {
        if (_service == null) {
            throw new RuntimeException(
                "PmlEdmDocumentReceiptService is not set");
        }
