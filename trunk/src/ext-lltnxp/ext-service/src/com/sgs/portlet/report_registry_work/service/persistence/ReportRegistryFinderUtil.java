...
public class ReportRegistryFinderUtil {
    ...
    public static int count_report_registry_test(
        java.lang.String reportRegistryCodes, java.lang.String userCreates,
        java.lang.String resultWorks, java.lang.String programWorks,
        long departmentId, java.lang.String dateFrom, java.lang.String dateTo,
        boolean andOperator) throws com.liferay.portal.SystemException {
        return getFinder()
                   .count_report_registry_test(reportRegistryCodes,
            userCreates, resultWorks, programWorks, departmentId, dateFrom,
            dateTo, andOperator);
    }
    ...
    public static java.util.List<com.sgs.portlet.report_registry_work.model.ReportRegistry> find_report_registry_test(
        java.lang.String reportRegistryCodes, java.lang.String userCreates,
        java.lang.String resultWorks, java.lang.String programWorks,
        long departmentId, java.lang.String dateFrom, java.lang.String dateTo,
        ...
        throws com.liferay.portal.SystemException {
        return getFinder()
                   .find_report_registry_test(reportRegistryCodes, userCreates,
            resultWorks, programWorks, departmentId, dateFrom, dateTo, start,
            end, andOperator, obc);
    }
    ...
    public static java.util.List<com.sgs.portlet.report_registry_work.model.ReportRegistry> find_report_registry_test(
        ...
        return getFinder()
                   .find_report_registry_test(reportRegistryCodes, userCreates,
            resultWorks, programWorks, departmentId, dateFrom, dateTo,
