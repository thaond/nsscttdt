...
/**
 * <a href="PmlEdmWriteDocumentSendServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class PmlEdmWriteDocumentSendServiceUtil {
    private static PmlEdmWriteDocumentSendService _service;

    public static PmlEdmWriteDocumentSendService getService() {
        if (_service == null) {
            throw new RuntimeException(
                "PmlEdmWriteDocumentSendService is not set");
        }
