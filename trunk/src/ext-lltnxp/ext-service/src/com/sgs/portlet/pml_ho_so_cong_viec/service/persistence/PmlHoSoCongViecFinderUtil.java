...
public class PmlHoSoCongViecFinderUtil {
    ...
    public static int countByS_T_N_I_V_I_I_T_U_H(long userId,
        ...
        throws com.liferay.portal.SystemException {
        return getFinder()
                   .countByS_T_N_I_V_I_I_T_U_H(userId, soHieuHSCV, tieuDe,
            ngayMoHSCV, idLinhVuc, vanDeLienQuan, idDoQuanTrong,
            idTrangThaiHSCV, tomTatNoiDung, hoatDong, andOperator);
    }
    ...
    public static java.util.List<com.sgs.portlet.pml_ho_so_cong_viec.model.PmlHoSoCongViec> findByS_T_N_I_V_I_I_T_U_H(
        ...
        throws com.liferay.portal.SystemException {
        return getFinder()
                   .findByS_T_N_I_V_I_I_T_U_H(userId, soHieuHSCV, tieuDe,
            ngayMoHSCV, idLinhVuc, vanDeLienQuan, idDoQuanTrong,
            idTrangThaiHSCV, tomTatNoiDung, hoatDong, andOperator, start, end,
            obc);
    }
