...
/**
 * <a href="PmlDocumentDelegateServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class PmlDocumentDelegateServiceUtil {
    private static PmlDocumentDelegateService _service;

    public static PmlDocumentDelegateService getService() {
        if (_service == null) {
            throw new RuntimeException("PmlDocumentDelegateService is not set");
        }
