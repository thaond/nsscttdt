...
public class DocumentManagerLocalServiceUtil {
    ...
    public static int countDocumentManagerTest(
        ...
        throws com.liferay.portal.SystemException {
        return getService()
                   .countDocumentManagerTest(documentManagerCodes,
            documentManagerCategorys, documentManagerDescriptions,
            documentManagerTitles, documentManagerStyles, dateFrom, dateTo,
            andOperator);
    }

    public static java.util.List<com.sgs.portlet.document_manager.model.DocumentManager> findDocumentManagerTest(
        java.lang.String documentManagerCodes,
        java.lang.String documentManagerCategorys,
        java.lang.String documentManagerDescriptions,
        java.lang.String documentManagerTitles,
        ...
        throws com.liferay.portal.SystemException {
        return getService()
                   .findDocumentManagerTest(documentManagerCodes,
            documentManagerCategorys, documentManagerDescriptions,
            documentManagerTitles, documentManagerStyles, dateFrom, dateTo,
