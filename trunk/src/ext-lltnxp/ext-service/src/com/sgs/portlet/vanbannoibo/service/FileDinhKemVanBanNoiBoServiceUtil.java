...
/**
 * <a href="FileDinhKemVanBanNoiBoServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class FileDinhKemVanBanNoiBoServiceUtil {
    private static FileDinhKemVanBanNoiBoService _service;

    public static FileDinhKemVanBanNoiBoService getService() {
        if (_service == null) {
            throw new RuntimeException(
                "FileDinhKemVanBanNoiBoService is not set");
        }
