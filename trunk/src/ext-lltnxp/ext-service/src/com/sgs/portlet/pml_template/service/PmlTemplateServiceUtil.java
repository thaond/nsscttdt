...
/**
 * <a href="PmlTemplateServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class PmlTemplateServiceUtil {
    private static PmlTemplateService _service;

    public static PmlTemplateService getService() {
        if (_service == null) {
            throw new RuntimeException("PmlTemplateService is not set");
        }
