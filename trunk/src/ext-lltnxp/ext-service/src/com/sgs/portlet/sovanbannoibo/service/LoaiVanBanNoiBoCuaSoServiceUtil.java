...
/**
 * <a href="LoaiVanBanNoiBoCuaSoServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class LoaiVanBanNoiBoCuaSoServiceUtil {
    private static LoaiVanBanNoiBoCuaSoService _service;

    public static LoaiVanBanNoiBoCuaSoService getService() {
        if (_service == null) {
            throw new RuntimeException("LoaiVanBanNoiBoCuaSoService is not set");
        }
