...
/**
 * <a href="LogVanBanNoiBoServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class LogVanBanNoiBoServiceUtil {
    private static LogVanBanNoiBoService _service;

    public static LogVanBanNoiBoService getService() {
        if (_service == null) {
            throw new RuntimeException("LogVanBanNoiBoService is not set");
        }
