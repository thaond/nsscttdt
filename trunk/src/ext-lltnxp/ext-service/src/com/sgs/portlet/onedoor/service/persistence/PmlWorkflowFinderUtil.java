...
public class PmlWorkflowFinderUtil {
    ...
    public static java.util.List<com.sgs.portlet.onedoor.model.PmlWorkflow> findByKeywords(
    ...
    public static java.util.List<com.sgs.portlet.onedoor.model.PmlWorkflow> findByOneDoorWoorkflow(
