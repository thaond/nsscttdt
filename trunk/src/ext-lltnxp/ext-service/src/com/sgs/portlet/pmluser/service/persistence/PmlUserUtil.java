...
public class PmlUserUtil {
    ...
    public static java.util.List<com.sgs.portlet.pmluser.model.PmlUser> findByIsLeaderMetting(
        boolean isLeaderMetting) throws com.liferay.portal.SystemException {
        return getPersistence().findByIsLeaderMetting(isLeaderMetting);
    }

    public static java.util.List<com.sgs.portlet.pmluser.model.PmlUser> findByIsLeaderMetting(
        boolean isLeaderMetting, int start, int end)
        throws com.liferay.portal.SystemException {
        return getPersistence()
                   .findByIsLeaderMetting(isLeaderMetting, start, end);
    }
    ...
    public static java.util.List<com.sgs.portlet.pmluser.model.PmlUser> findByIsLeaderMetting(
        ...
        throws com.liferay.portal.SystemException {
        return getPersistence()
                   .findByIsLeaderMetting(isLeaderMetting, start, end, obc);
    }

    public static com.sgs.portlet.pmluser.model.PmlUser findByIsLeaderMetting_First(
        boolean isLeaderMetting,
        com.liferay.portal.kernel.util.OrderByComparator obc)
        throws com.liferay.portal.SystemException,
            com.sgs.portlet.pmluser.NoSuchPmlUserException {
        return getPersistence().findByIsLeaderMetting_First(isLeaderMetting, obc);
    }

    public static com.sgs.portlet.pmluser.model.PmlUser findByIsLeaderMetting_Last(
        boolean isLeaderMetting,
        com.liferay.portal.kernel.util.OrderByComparator obc)
        throws com.liferay.portal.SystemException,
            com.sgs.portlet.pmluser.NoSuchPmlUserException {
        return getPersistence().findByIsLeaderMetting_Last(isLeaderMetting, obc);
    }

    public static com.sgs.portlet.pmluser.model.PmlUser[] findByIsLeaderMetting_PrevAndNext(
        long userId, boolean isLeaderMetting,
        com.liferay.portal.kernel.util.OrderByComparator obc)
        throws com.liferay.portal.SystemException,
            com.sgs.portlet.pmluser.NoSuchPmlUserException {
        return getPersistence()
                   .findByIsLeaderMetting_PrevAndNext(userId, isLeaderMetting,
            obc);
    }
    ...
    public static void removeByIsLeaderMetting(boolean isLeaderMetting)
        throws com.liferay.portal.SystemException {
