...
import com.sgs.portlet.sovanbannoibo.NoSuchLoaiPhongVanBanNoiBoException;
import com.sgs.portlet.sovanbannoibo.model.LoaiPhongVanBanNoiBo;
import com.sgs.portlet.sovanbannoibo.model.impl.LoaiPhongVanBanNoiBoImpl;
import com.sgs.portlet.sovanbannoibo.model.impl.LoaiPhongVanBanNoiBoModelImpl;
    ...
    public List<LoaiPhongVanBanNoiBo> findAll(int start, int end,
        ...
        if (result == null) {
            ...
            try {
                ...
                query.append(
                    "FROM com.sgs.portlet.sovanbannoibo.model.LoaiPhongVanBanNoiBo ");
        ...
        if (result == null) {
            ...
            try {
                ...
                Query q = session.createQuery(
                        "SELECT COUNT(*) FROM com.sgs.portlet.sovanbannoibo.model.LoaiPhongVanBanNoiBo");
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.portal.util.PropsUtil.get(
                        "value.object.listener.com.sgs.portlet.sovanbannoibo.model.LoaiPhongVanBanNoiBo")));
