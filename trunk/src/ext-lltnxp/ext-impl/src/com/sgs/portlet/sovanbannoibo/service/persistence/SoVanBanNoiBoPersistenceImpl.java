...
import com.sgs.portlet.sovanbannoibo.NoSuchException;
...
import com.sgs.portlet.sovanbannoibo.model.impl.SoVanBanNoiBoModelImpl;
    ...
    public List<SoVanBanNoiBo> findAll(int start, int end, OrderByComparator obc)
        ...
        if (result == null) {
            ...
            try {
                ...
                query.append(
                    "FROM com.sgs.portlet.sovanbannoibo.model.SoVanBanNoiBo ");
        ...
        if (result == null) {
            ...
            try {
                ...
                Query q = session.createQuery(
                        "SELECT COUNT(*) FROM com.sgs.portlet.sovanbannoibo.model.SoVanBanNoiBo");
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.portal.util.PropsUtil.get(
                        "value.object.listener.com.sgs.portlet.sovanbannoibo.model.SoVanBanNoiBo")));
