 ...
 * 
 */
public class DocumentReceiptProcessTaskNameDispatcher implements
		TaskNameDispatcher {
	public static final String STRUTS_ACTION_TO_FORM_PREFIX = "struts_action.document.receipt.form";
	public static final String STRUTS_ACTION_TO_ACTION_PREFIX = "struts_action.document.receipt.action";
