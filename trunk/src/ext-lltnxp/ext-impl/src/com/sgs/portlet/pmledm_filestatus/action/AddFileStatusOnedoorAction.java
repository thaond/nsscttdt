...
//			}
			...
			if (e instanceof PmlFileStatusCodeSameCodeException) {
				...
				setForward(actionRequest, "portlet.sgs.pmledm_filestatus.add_filestatus_onedoor");
	...
	public ActionForward render(
		...
		return mapping.findForward("portlet.sgs.pmledm_filestatus.add_filestatus_onedoor");
	}
