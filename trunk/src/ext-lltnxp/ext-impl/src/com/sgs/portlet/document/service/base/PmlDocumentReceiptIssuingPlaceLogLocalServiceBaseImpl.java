...
public abstract class PmlDocumentReceiptIssuingPlaceLogLocalServiceBaseImpl
    implements PmlDocumentReceiptIssuingPlaceLogLocalService {
    ...
    public PmlDocumentReceiptIssuingPlaceLog addPmlDocumentReceiptIssuingPlaceLog(
        ...
        return pmlDocumentReceiptIssuingPlaceLogPersistence.update(pmlDocumentReceiptIssuingPlaceLog,
            false);
    }

    public PmlDocumentReceiptIssuingPlaceLog createPmlDocumentReceiptIssuingPlaceLog(
        long documentReceiptIssuingPlaceLogId) {
        return pmlDocumentReceiptIssuingPlaceLogPersistence.create(documentReceiptIssuingPlaceLogId);
    }

    public void deletePmlDocumentReceiptIssuingPlaceLog(
        long documentReceiptIssuingPlaceLogId)
        throws PortalException, SystemException {
        pmlDocumentReceiptIssuingPlaceLogPersistence.remove(documentReceiptIssuingPlaceLogId);
    }

    public void deletePmlDocumentReceiptIssuingPlaceLog(
        PmlDocumentReceiptIssuingPlaceLog pmlDocumentReceiptIssuingPlaceLog)
        throws SystemException {
        pmlDocumentReceiptIssuingPlaceLogPersistence.remove(pmlDocumentReceiptIssuingPlaceLog);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlDocumentReceiptIssuingPlaceLogPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlDocumentReceiptIssuingPlaceLog getPmlDocumentReceiptIssuingPlaceLog(
        long documentReceiptIssuingPlaceLogId)
        throws PortalException, SystemException {
        return pmlDocumentReceiptIssuingPlaceLogPersistence.findByPrimaryKey(documentReceiptIssuingPlaceLogId);
    }

    public List<PmlDocumentReceiptIssuingPlaceLog> getPmlDocumentReceiptIssuingPlaceLogs(
        int start, int end) throws SystemException {
        return pmlDocumentReceiptIssuingPlaceLogPersistence.findAll(start, end);
    }

    public int getPmlDocumentReceiptIssuingPlaceLogsCount()
        throws SystemException {
        return pmlDocumentReceiptIssuingPlaceLogPersistence.countAll();
    }

    public PmlDocumentReceiptIssuingPlaceLog updatePmlDocumentReceiptIssuingPlaceLog(
        PmlDocumentReceiptIssuingPlaceLog pmlDocumentReceiptIssuingPlaceLog)
        throws SystemException {
