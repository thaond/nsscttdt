...
public abstract class PmlEdmAttachedFileLocalServiceBaseImpl
    implements PmlEdmAttachedFileLocalService {
    ...
    public PmlEdmAttachedFile addPmlEdmAttachedFile(
        PmlEdmAttachedFile pmlEdmAttachedFile) throws SystemException {
        pmlEdmAttachedFile.setNew(true);

        return pmlEdmAttachedFilePersistence.update(pmlEdmAttachedFile, false);
    }

    public PmlEdmAttachedFile createPmlEdmAttachedFile(long attachedFileId) {
        return pmlEdmAttachedFilePersistence.create(attachedFileId);
    }

    public void deletePmlEdmAttachedFile(long attachedFileId)
        throws PortalException, SystemException {
        pmlEdmAttachedFilePersistence.remove(attachedFileId);
    }

    public void deletePmlEdmAttachedFile(PmlEdmAttachedFile pmlEdmAttachedFile)
        throws SystemException {
        pmlEdmAttachedFilePersistence.remove(pmlEdmAttachedFile);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlEdmAttachedFilePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlEdmAttachedFile getPmlEdmAttachedFile(long attachedFileId)
        throws PortalException, SystemException {
        return pmlEdmAttachedFilePersistence.findByPrimaryKey(attachedFileId);
    }

    public List<PmlEdmAttachedFile> getPmlEdmAttachedFiles(int start, int end)
        throws SystemException {
        return pmlEdmAttachedFilePersistence.findAll(start, end);
    }

    public int getPmlEdmAttachedFilesCount() throws SystemException {
        return pmlEdmAttachedFilePersistence.countAll();
    }

    public PmlEdmAttachedFile updatePmlEdmAttachedFile(
        PmlEdmAttachedFile pmlEdmAttachedFile) throws SystemException {
        pmlEdmAttachedFile.setNew(false);

        return pmlEdmAttachedFilePersistence.update(pmlEdmAttachedFile, true);
    }
