...
import com.sgs.portlet.sovanbannoibo.NoSuchLoaiVanBanNoiBoException;
...
import com.sgs.portlet.sovanbannoibo.model.impl.LoaiVanBanNoiBoModelImpl;
...
public class LoaiVanBanNoiBoPersistenceImpl extends BasePersistenceImpl
    ...
    public LoaiVanBanNoiBo remove(long loaiVanBanNoiBoId)
        throws NoSuchLoaiVanBanNoiBoException, SystemException {
        ...
        try {
            ...
            if (loaiVanBanNoiBo == null) {
                ...
                throw new NoSuchLoaiVanBanNoiBoException(
                    "No LoaiVanBanNoiBo exists with the primary key " +
                    loaiVanBanNoiBoId);
            }

            return remove(loaiVanBanNoiBo);
        } catch (NoSuchLoaiVanBanNoiBoException nsee) {
            throw nsee;
        } catch (Exception e) {
    ...
    public List<LoaiVanBanNoiBo> findAll(int start, int end,
        ...
        if (result == null) {
            ...
            try {
                ...
                query.append(
                    "FROM com.sgs.portlet.sovanbannoibo.model.LoaiVanBanNoiBo ");
        ...
        if (result == null) {
            ...
            try {
                ...
                Query q = session.createQuery(
                        "SELECT COUNT(*) FROM com.sgs.portlet.sovanbannoibo.model.LoaiVanBanNoiBo");
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.portal.util.PropsUtil.get(
                        "value.object.listener.com.sgs.portlet.sovanbannoibo.model.LoaiVanBanNoiBo")));
