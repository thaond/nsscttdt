...
public class BookRecordPBSearch extends SearchContainer<PmlEdmBookDocumentSend>{
	...
	public BookRecordPBSearch(RenderRequest renderRequest, PortletURL iteratorURL){
		super(renderRequest, new BookRecordPBDisplayTerms(renderRequest), new BookRecordPBSearchTerms(renderRequest),
		...
		try {
			...
			if (Validator.isNotNull(orderByCol) &&
				...
				preferences.setValue(portletName, "bookrecordPB-order-by-col", orderByCol);
				preferences.setValue(portletName, "bookrecordPB-order-by-type", orderByType);
			}
			
			else {
				orderByCol = preferences.getValue(portletName, "bookrecordPB-order-by-col", "pml_departments.departmentsname");
				orderByType = preferences.getValue(portletName, "bookrecordPB-order-by-type", "asc");
			}
	...
	private static Log _log = LogFactoryUtil.getLog(BookRecordPBSearch.class);
}
