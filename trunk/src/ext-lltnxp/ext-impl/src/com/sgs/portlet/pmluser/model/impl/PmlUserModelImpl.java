...
public class PmlUserModelImpl extends BaseModelImpl {
    ...
    private boolean _isLeaderMetting;
    private boolean _isVanThuPhong;
    ...
    public static PmlUser toModel(PmlUserSoap soapModel) {
        ...
        model.setIsLeaderMetting(soapModel.getIsLeaderMetting());
        model.setIsVanThuPhong(soapModel.getIsVanThuPhong());
    ...
    public void setIsLeaderMetting(boolean isLeaderMetting) {
        if (isLeaderMetting != _isLeaderMetting) {
            _isLeaderMetting = isLeaderMetting;
        }
    }

    public boolean getIsVanThuPhong() {
        return _isVanThuPhong;
    }
    ...
    public void setIsVanThuPhong(boolean isVanThuPhong) {
        if (isVanThuPhong != _isVanThuPhong) {
            _isVanThuPhong = isVanThuPhong;
        }
    }
    ...
    public PmlUser toEscapedModel() {
        if (isEscapedModel()) {
            ...
            model.setIsLeaderMetting(getIsLeaderMetting());
            model.setIsVanThuPhong(getIsVanThuPhong());
    ...
    public Object clone() {
        ...
        clone.setIsLeaderMetting(getIsLeaderMetting());
        clone.setIsVanThuPhong(getIsVanThuPhong());
