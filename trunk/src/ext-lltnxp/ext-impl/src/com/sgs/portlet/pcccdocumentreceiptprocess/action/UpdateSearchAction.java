...
public class UpdateSearchAction extends DocumentReceiptPortletAction {
	...
	public ActionForward renderStruts(ActionMapping mapping, ActionForm form,
		...
		List<PmlEdmLevelSend> pmlEdmLevelSendList = PmlEdmLevelSendUtil
				.findAll();
...
//		List<PmlEdmDocumentRecordType> pmlEdmDocumentRecordTypeList = PmlEdmDocumentRecordTypeUtil.findAll();
		...
		List<PmlEdmConfidentialLevel> pmlEdmConfidentialLevelList = PmlEdmConfidentialLevelUtil
				.findAll();

		// get all PmlEdmPrivilegeLevel
		List<PmlEdmPrivilegeLevel> pmlEdmPrivilegeLevelList = PmlEdmPrivilegeLevelUtil
				.findAll();

		// get all issuing place
		List<PmlEdmIssuingPlace> pmlEdmIssuingPlaceList = PmlEdmIssuingPlaceUtil
				.findAll();
		...
		return mapping.findForward("portlet.sgs.pcccdocumentreceiptprocess.updatesearch");
	}
	...
	private List<PmlEdmDocumentType> getDocumentTypes(RenderRequest req)
			throws Exception {
		/* phmphuc close and change 07/01/2011
		long documentReceiptId = ParamUtil.getLong(req, "documentReceiptId");
		...
		*/
		List<PmlEdmDocumentType> documentTypes = PmlEdmDocumentTypeLocalServiceUtil.getPmlEdmDocumentTypes(-1, -1);
	...
	private List<PmlEdmIssuingPlace> getIssuingPlaces(RenderRequest req)
		...
		List<PmlEdmLevelSendDetail> levelSendDetails = PmlEdmLevelSendDetailUtil
				.findByLevelSendId(levelSendId);
		...
		Collections.sort(issuingPlaces, new Comparator<PmlEdmIssuingPlace>(){
			public int compare(PmlEdmIssuingPlace o1, PmlEdmIssuingPlace o2) {						
				return o1.getIssuingPlaceName().compareTo(o2.getIssuingPlaceName());
			}					
		});
