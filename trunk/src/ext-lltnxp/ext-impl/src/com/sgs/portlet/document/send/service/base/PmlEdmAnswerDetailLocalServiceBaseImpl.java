...
public abstract class PmlEdmAnswerDetailLocalServiceBaseImpl
    implements PmlEdmAnswerDetailLocalService {
    ...
    public PmlEdmAnswerDetail addPmlEdmAnswerDetail(
        PmlEdmAnswerDetail pmlEdmAnswerDetail) throws SystemException {
        pmlEdmAnswerDetail.setNew(true);

        return pmlEdmAnswerDetailPersistence.update(pmlEdmAnswerDetail, false);
    }

    public PmlEdmAnswerDetail createPmlEdmAnswerDetail(long documentReceiptId) {
        return pmlEdmAnswerDetailPersistence.create(documentReceiptId);
    }

    public void deletePmlEdmAnswerDetail(long documentReceiptId)
        throws PortalException, SystemException {
        pmlEdmAnswerDetailPersistence.remove(documentReceiptId);
    }

    public void deletePmlEdmAnswerDetail(PmlEdmAnswerDetail pmlEdmAnswerDetail)
        throws SystemException {
        pmlEdmAnswerDetailPersistence.remove(pmlEdmAnswerDetail);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlEdmAnswerDetailPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlEdmAnswerDetail getPmlEdmAnswerDetail(long documentReceiptId)
        throws PortalException, SystemException {
        return pmlEdmAnswerDetailPersistence.findByPrimaryKey(documentReceiptId);
    }

    public List<PmlEdmAnswerDetail> getPmlEdmAnswerDetails(int start, int end)
        throws SystemException {
        return pmlEdmAnswerDetailPersistence.findAll(start, end);
    }

    public int getPmlEdmAnswerDetailsCount() throws SystemException {
        return pmlEdmAnswerDetailPersistence.countAll();
    }

    public PmlEdmAnswerDetail updatePmlEdmAnswerDetail(
        PmlEdmAnswerDetail pmlEdmAnswerDetail) throws SystemException {
        pmlEdmAnswerDetail.setNew(false);

        return pmlEdmAnswerDetailPersistence.update(pmlEdmAnswerDetail, true);
    }
