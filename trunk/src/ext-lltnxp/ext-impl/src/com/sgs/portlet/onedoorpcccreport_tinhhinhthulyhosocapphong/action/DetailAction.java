 ...
 * 
 */
package com.sgs.portlet.onedoorpcccreport_tinhhinhthulyhosocapphong.action;
...
public class DetailAction extends OneDoorProcessPortletAction {
	...
	public ActionForward renderStruts(ActionMapping mapping, ActionForm form,
		...
		return mapping.findForward("portlet.sgs.onedoorpcccreport_tinhhinhthulyhosocapphong.filedetails_detail");
	}
...
//		List<PmlStateProcess> list = PmlStateProcessUtil.findByStateProcessCode(stateCode); // yenlt close 23/04/2010
		List<PmlStateProcess> list = PmlStateProcessUtil.findByStateProcessCode(stateCode, OneDoorProcessLiferayWorkflowService.TYPE_MC); // yenlt update 23/04/2010
		String state = "";
		if (list != null && list.size() > 0) {
			PmlStateProcess stateProcess = list.get(0);
//			state = stateProcess.getStateProcessName();// yenlt close 23/04/2010
