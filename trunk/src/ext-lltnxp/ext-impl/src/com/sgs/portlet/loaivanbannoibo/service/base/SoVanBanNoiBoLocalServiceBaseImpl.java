...
public abstract class SoVanBanNoiBoLocalServiceBaseImpl
    implements SoVanBanNoiBoLocalService {
    ...
    public SoVanBanNoiBo addSoVanBanNoiBo(SoVanBanNoiBo soVanBanNoiBo)
        throws SystemException {
        soVanBanNoiBo.setNew(true);

        return soVanBanNoiBoPersistence.update(soVanBanNoiBo, false);
    }

    public SoVanBanNoiBo createSoVanBanNoiBo(long soVanBanNoiBoId) {
        return soVanBanNoiBoPersistence.create(soVanBanNoiBoId);
    }

    public void deleteSoVanBanNoiBo(long soVanBanNoiBoId)
        throws PortalException, SystemException {
        soVanBanNoiBoPersistence.remove(soVanBanNoiBoId);
    }

    public void deleteSoVanBanNoiBo(SoVanBanNoiBo soVanBanNoiBo)
        throws SystemException {
        soVanBanNoiBoPersistence.remove(soVanBanNoiBo);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return soVanBanNoiBoPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public SoVanBanNoiBo getSoVanBanNoiBo(long soVanBanNoiBoId)
        throws PortalException, SystemException {
        return soVanBanNoiBoPersistence.findByPrimaryKey(soVanBanNoiBoId);
    }

    public List<SoVanBanNoiBo> getSoVanBanNoiBos(int start, int end)
        throws SystemException {
        return soVanBanNoiBoPersistence.findAll(start, end);
    }

    public int getSoVanBanNoiBosCount() throws SystemException {
        return soVanBanNoiBoPersistence.countAll();
    }

    public SoVanBanNoiBo updateSoVanBanNoiBo(SoVanBanNoiBo soVanBanNoiBo)
        throws SystemException {
        soVanBanNoiBo.setNew(false);

        return soVanBanNoiBoPersistence.update(soVanBanNoiBo, true);
    }
