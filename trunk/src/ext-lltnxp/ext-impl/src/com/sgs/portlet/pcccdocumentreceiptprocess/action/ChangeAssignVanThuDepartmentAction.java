...
public class ChangeAssignVanThuDepartmentAction extends DocumentReceiptPortletAction {
	...
	public ActionForward renderStruts(
		...
		if ((getForward(req) != null) && !getForward(req).equals("")) {
			...
			List<PmlUser> vathuDepartmentList = new ArrayList<PmlUser>();
			
			try {
				vathuDepartmentList = PmlUserUtil.findByIsVanThuPhong(true);
			} catch (Exception e) {
				
			}

			req.setAttribute(
				"vathuDepartmentList", vathuDepartmentList);
			...
			req.setAttribute("documentReceiptId",ParamUtil.getLong(req, "documentReceiptId"));
			return mapping.findForward("portlet.sgs.pcccdocumentreceiptprocess.changevanthudeparment");
		}
	}
