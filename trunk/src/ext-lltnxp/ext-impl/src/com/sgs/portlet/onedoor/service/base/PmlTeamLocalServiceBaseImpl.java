...
public abstract class PmlTeamLocalServiceBaseImpl implements PmlTeamLocalService {
    ...
    public PmlTeam addPmlTeam(PmlTeam pmlTeam) throws SystemException {
        pmlTeam.setNew(true);

        return pmlTeamPersistence.update(pmlTeam, false);
    }

    public PmlTeam createPmlTeam(long teamId) {
        return pmlTeamPersistence.create(teamId);
    }

    public void deletePmlTeam(long teamId)
        throws PortalException, SystemException {
        pmlTeamPersistence.remove(teamId);
    }

    public void deletePmlTeam(PmlTeam pmlTeam) throws SystemException {
        pmlTeamPersistence.remove(pmlTeam);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlTeamPersistence.findWithDynamicQuery(dynamicQuery);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery, int start,
        int end) throws SystemException {
        return pmlTeamPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }

    public PmlTeam getPmlTeam(long teamId)
        throws PortalException, SystemException {
        return pmlTeamPersistence.findByPrimaryKey(teamId);
    }

    public List<PmlTeam> getPmlTeams(int start, int end)
        throws SystemException {
        return pmlTeamPersistence.findAll(start, end);
    }

    public int getPmlTeamsCount() throws SystemException {
        return pmlTeamPersistence.countAll();
    }

    public PmlTeam updatePmlTeam(PmlTeam pmlTeam) throws SystemException {
        pmlTeam.setNew(false);

        return pmlTeamPersistence.update(pmlTeam, true);
    }
