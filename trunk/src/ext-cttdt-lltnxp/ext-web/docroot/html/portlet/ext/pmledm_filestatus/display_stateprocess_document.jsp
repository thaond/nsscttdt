...
<script type="text/javascript">
	...
	function deleteDocumentStateProcess(url) {		
...
<%
	...
	displayURL.setParameter("struts_action", "/sgs/pmledm_filestatus/display_stateprocess_document");
	displayURL.setParameter("fileStatusId", String.valueOf(filestatusId));
	displayURL.setParameter("tabs",tabs);
%>
...
<portlet:actionURL var="display_process">
	...
	<input name="<portlet:namespace />documentStateURL" type="hidden" value="<%= displayURL.toString() %>" />
	<liferay-ui:error exception="<%= PmlFileStatusStateProcessCanNotDeleteException.class %>" message="can-not-delete-pml-do-quan-trong" />
		...
		<%
			...
			addfilestatusStateProcessURL.setParameter("struts_action", "/sgs/pmledm_filestatus/add_stateprocess_document");
			addfilestatusStateProcessURL.setParameter("tabs", tabs);
			...
			backURL.setParameter("tabs",tabs);
		...
		<%
			...
			for(int i=0; i<listFileStatusStateProcess.size(); i++){
				...
				rowURLEdit.setParameter("struts_action","/sgs/pmledm_filestatus/edit_stateprocess_document");
				...
				rowURLDelete.setParameter("struts_action","/sgs/pmledm_filestatus/display_stateprocess_document");
				...
				delete = "<a  href='javascript: ;' onclick=deleteDocumentStateProcess('"+ rowURLDelete.toString() +"')><u>"+ "<img src='/html/images/delete.png'/>" +"</u></a>";
