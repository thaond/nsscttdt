...
<%@page import="com.sgs.portlet.onedoorpcccreport_baocaohosothang.searchfiledetail.PmlOneDoorReceiveFileSearch"%>
...
<link type="text/css" rel="stylesheet" href="/html/portlet/ext/onedoorpcccreport_baocaohosothang/css/style.css" />
<link type="text/css" rel="stylesheet" href="/html/portlet/ext/onedoorpcccreport_baocaohosothang/css/ex.css" />
...
<%
	String columeName = (String) renderRequest.getAttribute("columeName");
...
<portlet:actionURL var="filter">
	<portlet:param name="struts_action"	value="/sgs/onedoorpcccreport_baocaohosothang/filedetails" />
	<portlet:param name="columeName"	value="<%= columeName %>" />
...
<div id="listdiv" >
	...
	<ul>
		...
		<li style="width: 22%">
					<div class="btpre_hs" align="left"><liferay-util:include page="/html/portlet/ext/onedoorpcccreport_baocaohosothang/button.jsp"></liferay-util:include></div>
		</li>
	</ul>
	</form>		
</div>
...
<div id="outer-1" class="outer-1">
						<table class="taglib-search-iterator table-pml" cellspacing="0" width="100%">	
							...
							<%
								...
								portletURL.setParameter("struts_action", "/sgs/onedoorpcccreport_baocaohosothang/filedetails");
						...
						%>
								...
								<portlet:renderURL var="detail"	windowState="<%= LiferayWindowState.EXCLUSIVE.toString() %>">
									<portlet:param name="struts_action"	value="/sgs/onedoorpcccreport_baocaohosothang/filedetails_detail" />
									...
									<td align="center"><%= pmlFilePcccDTO.getStatus() %></td>
									<td align="center">
		...
		<div id="<portlet:namespace/>divcontent2" style="display: none;"></div>
