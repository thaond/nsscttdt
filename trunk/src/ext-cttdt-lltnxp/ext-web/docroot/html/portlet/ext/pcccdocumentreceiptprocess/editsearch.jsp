...
<tr>
	...
	<td>
		<select name="<portlet:namespace/>documentRecordToId" id="socongvancvdtn" style="width:92.5%" onchange="changeDocumentRecordType()">
...
<tr>
    ...
    <td>
		...
		<input style="width:45px" type="text" name="dateArriveTime" id="dateArriveTime" size=13 value='<%=documentReceiptDTO.getThoigiannhancvden() != null ? documentReceiptDTO.getThoigiannhancvden() : "" %>'><label><liferay-ui:message key="hour"/>:</label><span style="color:gray;font-size: 9px">(HH:MM:SS)</span>
    </td>
</tr>
<tr>
