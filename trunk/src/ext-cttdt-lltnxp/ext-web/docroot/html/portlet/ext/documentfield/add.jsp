...
<%@page import="com.sgs.portlet.field.FieldCodeSameCodeException"%>
...
<div class="title_categ"><liferay-ui:message key="field-them-linh-vuc-ho-so"/></div>
...
<tr>
	<td></td>
	<td>
		<input style="margin-left: 0;" type='submit'  name='addfieldbtn' value='<liferay-ui:message key="add_new"/>' />
