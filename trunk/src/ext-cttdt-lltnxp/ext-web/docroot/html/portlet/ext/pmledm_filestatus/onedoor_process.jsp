...
<%
	...
	onedoorURL.setParameter("struts_action", "/sgs/pmledm_filestatus/view");
...
%>
	<form name="<portlet:namespace/>fm"  action="<%=onedoorURLString%>" method="post">
	 <div class="boxcontent_Tab">
		...
		<liferay-ui:search-form page="/html/portlet/ext/pmledm_filestatus/search_form_onedoor.jsp"
		...
		<%
			...
			addfilestatusOnedoorURL.setParameter("struts_action", "/sgs/pmledm_filestatus/add_filestatus_onedoor");
		...
		<%
			...
			for(int i=0; i<resultsOnedoor.size();i++){
				...
				rowURLOnedoor.setParameter("struts_action","/sgs/pmledm_filestatus/display_stateprocess_onedoor");
				...
				rowURLEdit.setParameter("struts_action","/sgs/pmledm_filestatus/edit_filestatus_onedoor");
				...
				rowURLDelete.setParameter("struts_action","/sgs/pmledm_filestatus/edit_filestatus_onedoor");
