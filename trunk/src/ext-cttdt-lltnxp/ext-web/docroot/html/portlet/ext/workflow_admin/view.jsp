...
<c:choose>
	<c:when test='<%="list".equals(tab) %>'>
		<liferay-util:include page="/html/portlet/ext/workflow_admin/list.jsp" />
	</c:when>
	<c:when test='<%="add".equals(tab) %>'>
		<liferay-util:include page="/html/portlet/ext/workflow_admin/add.jsp" />
	</c:when>
	<c:when test='<%="edit".equals(tab) %>'>
		<liferay-util:include page="/html/portlet/ext/workflow_admin/edit.jsp" />
	</c:when>
</c:choose>