...
<%	
	...
	for (int i = 0; i < results.size(); i ++) {
		...
		rowURL.setParameter("redirect", portletURLRedirect.toString()+"&statusId="+String.valueOf(statusId)+"&hienTrang="+hienTrang + "&"+ searchContainer.getCurParam() +"="+ searchContainer.getCurValue());
