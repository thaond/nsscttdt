...
%>
	...
	<table cellspacing="0" width="100%">
		<tr>
			...
			<td><input name="<portlet:namespace/><%=DocumentManagerDisplayTerms.DOCUMENTMANAGERCODE%>" 
			...
			<td><input name="<portlet:namespace/><%=DocumentManagerDisplayTerms.DOCUMENTMANAGERCATEGORY%>" 
		...
		<tr>
			...
			<td><input name="<portlet:namespace/><%=DocumentManagerDisplayTerms.DOCUMENTMANAGERDESCRIPTION%>"
			...
			<td><input name="<portlet:namespace/><%=DocumentManagerDisplayTerms.DOCUMENTMANAGERTITLE%>" 
