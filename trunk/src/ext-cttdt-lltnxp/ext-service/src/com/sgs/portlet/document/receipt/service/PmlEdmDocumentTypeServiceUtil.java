...
/**
 * <a href="PmlEdmDocumentTypeServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class PmlEdmDocumentTypeServiceUtil {
    private static PmlEdmDocumentTypeService _service;

    public static PmlEdmDocumentTypeService getService() {
        if (_service == null) {
            throw new RuntimeException("PmlEdmDocumentTypeService is not set");
        }
