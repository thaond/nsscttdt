...
public class AttachedFileFinderUtil {
    ...
    public static java.util.List<com.sgs.portlet.attachedfile.model.AttachedFile> findByKeywords(
    ...
    public static java.util.List<com.sgs.portlet.attachedfile.model.AttachedFile> findTEN_MA(
