...
public class PmlFileTypeLocalServiceUtil {
    ...
    public static com.sgs.portlet.filetype.model.PmlFileType addPmlFileType(
        com.sgs.portlet.filetype.model.PmlFileType pmlFileType)
        throws com.liferay.portal.SystemException {
        return getService().addPmlFileType(pmlFileType);
    }

    public static com.sgs.portlet.filetype.model.PmlFileType createPmlFileType(
    ...
    public static com.sgs.portlet.filetype.model.PmlFileType getPmlFileType(
        java.lang.String fileTypeId)
        throws com.liferay.portal.PortalException,
            com.liferay.portal.SystemException {
    ...
    public static java.util.List<com.sgs.portlet.filetype.model.PmlFileType> getPmlFileTypes(
    ...
    public static com.sgs.portlet.filetype.model.PmlFileType updatePmlFileType(
        com.sgs.portlet.filetype.model.PmlFileType pmlFileType)
        throws com.liferay.portal.SystemException {
    ...
    public static java.util.List<com.sgs.portlet.filetype.model.PmlFileType> search(
    ...
    public static java.util.List<com.sgs.portlet.filetype.model.PmlFileType> getListFileTypeByFieldId(
        ...
        throws com.liferay.portal.PortalException,
            com.liferay.portal.SystemException {
        return getService().getListFileTypeByFieldId(fieldId);
    }

    public static java.util.List<com.sgs.portlet.filetype.model.PmlFileType> getListFileTypeByUserId(
        long userId) {
        return getService().getListFileTypeByUserId(userId);
    }
    ...
    public static com.sgs.portlet.filetype.model.PmlFileType addFileType(
        java.lang.String fileTypeCode, java.lang.String fileTypeName,
    ...
    public static com.sgs.portlet.filetype.model.PmlFileType updateFileType(
