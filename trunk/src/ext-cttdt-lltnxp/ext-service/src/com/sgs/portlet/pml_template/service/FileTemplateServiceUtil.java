...
/**
 * <a href="FileTemplateServiceUtil.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class FileTemplateServiceUtil {
    private static FileTemplateService _service;

    public static FileTemplateService getService() {
        if (_service == null) {
            throw new RuntimeException("FileTemplateService is not set");
        }
