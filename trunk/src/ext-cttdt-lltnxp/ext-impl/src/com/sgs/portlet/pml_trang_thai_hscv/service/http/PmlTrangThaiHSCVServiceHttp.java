...
/**
 * <a href="PmlTrangThaiHSCVServiceHttp.java.html"><b><i>View Source</i></b></a>
 *
 * <p>
 ...
 *
 */
public class PmlTrangThaiHSCVServiceHttp {
    private static Log _log = LogFactoryUtil.getLog(PmlTrangThaiHSCVServiceHttp.class);
    ...
    public static com.sgs.portlet.pml_trang_thai_hscv.model.PmlTrangThaiHSCV addPmlTrangThaiHSCV(
        ...
        try {
            ...
            MethodWrapper methodWrapper = new MethodWrapper(PmlTrangThaiHSCVServiceUtil.class.getName(),
                    "addPmlTrangThaiHSCV", new Object[] { paramObj0 });
            ...
            return (com.sgs.portlet.pml_trang_thai_hscv.model.PmlTrangThaiHSCV) returnObj;
