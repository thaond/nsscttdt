 ...
 *
 */
public class AddFileStatusDocumentAction extends PortletAction {
...
//			}
			...
			if (e instanceof PmlFileStatusCodeSameCodeException) {
				...
				setForward(actionRequest, "portlet.sgs.pmledm_filestatus.add_filestatus_document");
	...
	public ActionForward render(
		...
		return mapping.findForward("portlet.sgs.pmledm_filestatus.add_filestatus_document");
	}
