...
import com.sgs.portlet.onedoorpcccreport_tinhhinhthulyhosocapphong.searchfiledetail.PmlOneDoorReceiveFileSearch;
...
public class FileDetailsAction extends PortletAction {
	...
	public ActionForward render(ActionMapping mapping, ActionForm form,
		...
		if (getForward(req) != null && !getForward(req).equals("")) {
			...
			return mapping.findForward("portlet.sgs.onedoorpcccreport_tinhhinhthulyhosocapphong.filedetails");
			}
	}
	/**
