...
public class DocumentManagerFinderImpl extends BasePersistenceImpl implements DocumentManagerFinder{
	...
	public int count_document_manager(String documentManagerCodes, String documentManagerDescriptions, String documentManagerTitles, boolean andOperator) throws SystemException {
		return count_document_manager(new String[] { documentManagerCodes }, new String[] { documentManagerDescriptions }, new String[] { documentManagerTitles }, andOperator);
	...
	public List<DocumentManager> find_document_manager(String documentManagerCodes, String documentManagerDescriptions, String documentManagerTitles, int start, int end, boolean andOperator, OrderByComparator obc) throws SystemException {
		return find_document_manager(new String[] { documentManagerCodes },new String[] { documentManagerDescriptions }, new String[] { documentManagerTitles }, andOperator, start, end, obc);
	}

	public List<DocumentManager> find_document_manager(String[] documentManagerCodes, String[] documentManagerDescriptions, String[] documentManagerTitles, boolean andOperator, int start, int end, OrderByComparator obc) throws SystemException {
		documentManagerCodes = CustomSQLUtil.keywords(documentManagerCodes);
		documentManagerTitles = CustomSQLUtil.keywords(documentManagerTitles);
		documentManagerTitles = CustomSQLUtil.keywords(documentManagerTitles);
		Session session = null;
