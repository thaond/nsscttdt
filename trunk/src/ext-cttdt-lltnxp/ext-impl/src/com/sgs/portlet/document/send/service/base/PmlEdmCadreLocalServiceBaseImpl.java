...
public abstract class PmlEdmCadreLocalServiceBaseImpl
    implements PmlEdmCadreLocalService {
    ...
    public PmlEdmCadre addPmlEdmCadre(PmlEdmCadre pmlEdmCadre)
        throws SystemException {
        pmlEdmCadre.setNew(true);

        return pmlEdmCadrePersistence.update(pmlEdmCadre, false);
    }

    public PmlEdmCadre createPmlEdmCadre(long userId) {
        return pmlEdmCadrePersistence.create(userId);
    }

    public void deletePmlEdmCadre(long userId)
        throws PortalException, SystemException {
        pmlEdmCadrePersistence.remove(userId);
    }

    public void deletePmlEdmCadre(PmlEdmCadre pmlEdmCadre)
        throws SystemException {
        pmlEdmCadrePersistence.remove(pmlEdmCadre);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlEdmCadrePersistence.findWithDynamicQuery(dynamicQuery);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery, int start,
        int end) throws SystemException {
        return pmlEdmCadrePersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }

    public PmlEdmCadre getPmlEdmCadre(long userId)
        throws PortalException, SystemException {
        return pmlEdmCadrePersistence.findByPrimaryKey(userId);
    }

    public List<PmlEdmCadre> getPmlEdmCadres(int start, int end)
        throws SystemException {
        return pmlEdmCadrePersistence.findAll(start, end);
    }

    public int getPmlEdmCadresCount() throws SystemException {
        return pmlEdmCadrePersistence.countAll();
    }

    public PmlEdmCadre updatePmlEdmCadre(PmlEdmCadre pmlEdmCadre)
        throws SystemException {
        pmlEdmCadre.setNew(false);

        return pmlEdmCadrePersistence.update(pmlEdmCadre, true);
    }
