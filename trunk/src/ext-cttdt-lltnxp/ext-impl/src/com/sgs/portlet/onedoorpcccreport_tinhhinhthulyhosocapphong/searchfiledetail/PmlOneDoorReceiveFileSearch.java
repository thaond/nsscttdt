 ...
 * 
 */
package com.sgs.portlet.onedoorpcccreport_tinhhinhthulyhosocapphong.searchfiledetail;
...
public class PmlOneDoorReceiveFileSearch extends SearchContainer<PmlOneDoorReceiveFile>{
	...
	public PmlOneDoorReceiveFileSearch(RenderRequest renderRequest, PortletURL iteratorURL) {
		...
		try {
			...
			String portletName = "SGS_ONEDOORPCCCREPORT_TINHHINHTHULYHOSOCAPPHONG";
			
			if (Validator.isNotNull(orderByCol) &&
				Validator.isNotNull(orderByType)) {

				preferences.setValue(portletName, "tinhhinhthulyhosocapphongworks-order-by-col",	orderByCol);
				preferences.setValue(portletName, "tinhhinhthulyhosocapphongworks-order-by-type", orderByType);
			}
			
			else {
				orderByCol = preferences.getValue(portletName, "tinhhinhthulyhosocapphongworks-order-by-col", "pccc-DSHS-mahoso");
				orderByType = preferences.getValue(portletName, "tinhhinhthulyhosocapphongworks-order-by-type", "desc");
			}
