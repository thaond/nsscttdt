...
public abstract class PmlFilePCCCAttachedFileLocalServiceBaseImpl
    implements PmlFilePCCCAttachedFileLocalService {
    ...
    public PmlFilePCCCAttachedFile addPmlFilePCCCAttachedFile(
        PmlFilePCCCAttachedFile pmlFilePCCCAttachedFile)
        throws SystemException {
        pmlFilePCCCAttachedFile.setNew(true);

        return pmlFilePCCCAttachedFilePersistence.update(pmlFilePCCCAttachedFile,
            false);
    }

    public PmlFilePCCCAttachedFile createPmlFilePCCCAttachedFile(
        long attachedFileId) {
        return pmlFilePCCCAttachedFilePersistence.create(attachedFileId);
    }

    public void deletePmlFilePCCCAttachedFile(long attachedFileId)
        throws PortalException, SystemException {
        pmlFilePCCCAttachedFilePersistence.remove(attachedFileId);
    }

    public void deletePmlFilePCCCAttachedFile(
        PmlFilePCCCAttachedFile pmlFilePCCCAttachedFile)
        throws SystemException {
        pmlFilePCCCAttachedFilePersistence.remove(pmlFilePCCCAttachedFile);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlFilePCCCAttachedFilePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlFilePCCCAttachedFile getPmlFilePCCCAttachedFile(
        long attachedFileId) throws PortalException, SystemException {
        return pmlFilePCCCAttachedFilePersistence.findByPrimaryKey(attachedFileId);
    }

    public List<PmlFilePCCCAttachedFile> getPmlFilePCCCAttachedFiles(
        int start, int end) throws SystemException {
        return pmlFilePCCCAttachedFilePersistence.findAll(start, end);
    }

    public int getPmlFilePCCCAttachedFilesCount() throws SystemException {
        return pmlFilePCCCAttachedFilePersistence.countAll();
    }

    public PmlFilePCCCAttachedFile updatePmlFilePCCCAttachedFile(
        PmlFilePCCCAttachedFile pmlFilePCCCAttachedFile)
        throws SystemException {
