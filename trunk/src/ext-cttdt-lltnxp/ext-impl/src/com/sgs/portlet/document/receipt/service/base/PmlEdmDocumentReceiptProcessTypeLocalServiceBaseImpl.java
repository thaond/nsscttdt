...
public abstract class PmlEdmDocumentReceiptProcessTypeLocalServiceBaseImpl
    implements PmlEdmDocumentReceiptProcessTypeLocalService {
    ...
    public PmlEdmDocumentReceiptProcessType addPmlEdmDocumentReceiptProcessType(
        PmlEdmDocumentReceiptProcessType pmlEdmDocumentReceiptProcessType)
        throws SystemException {
        pmlEdmDocumentReceiptProcessType.setNew(true);

        return pmlEdmDocumentReceiptProcessTypePersistence.update(pmlEdmDocumentReceiptProcessType,
            false);
    }

    public PmlEdmDocumentReceiptProcessType createPmlEdmDocumentReceiptProcessType(
        long docReceiptProcessTypeId) {
        return pmlEdmDocumentReceiptProcessTypePersistence.create(docReceiptProcessTypeId);
    }

    public void deletePmlEdmDocumentReceiptProcessType(
        long docReceiptProcessTypeId) throws PortalException, SystemException {
        pmlEdmDocumentReceiptProcessTypePersistence.remove(docReceiptProcessTypeId);
    }

    public void deletePmlEdmDocumentReceiptProcessType(
        PmlEdmDocumentReceiptProcessType pmlEdmDocumentReceiptProcessType)
        throws SystemException {
        pmlEdmDocumentReceiptProcessTypePersistence.remove(pmlEdmDocumentReceiptProcessType);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlEdmDocumentReceiptProcessTypePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlEdmDocumentReceiptProcessType getPmlEdmDocumentReceiptProcessType(
        long docReceiptProcessTypeId) throws PortalException, SystemException {
        return pmlEdmDocumentReceiptProcessTypePersistence.findByPrimaryKey(docReceiptProcessTypeId);
    }

    public List<PmlEdmDocumentReceiptProcessType> getPmlEdmDocumentReceiptProcessTypes(
        int start, int end) throws SystemException {
        return pmlEdmDocumentReceiptProcessTypePersistence.findAll(start, end);
    }

    public int getPmlEdmDocumentReceiptProcessTypesCount()
        throws SystemException {
        return pmlEdmDocumentReceiptProcessTypePersistence.countAll();
    }

    public PmlEdmDocumentReceiptProcessType updatePmlEdmDocumentReceiptProcessType(
        PmlEdmDocumentReceiptProcessType pmlEdmDocumentReceiptProcessType)
        throws SystemException {
