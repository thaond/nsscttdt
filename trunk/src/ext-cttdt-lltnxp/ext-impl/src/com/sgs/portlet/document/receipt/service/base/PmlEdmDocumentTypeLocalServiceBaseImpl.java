...
public abstract class PmlEdmDocumentTypeLocalServiceBaseImpl
    implements PmlEdmDocumentTypeLocalService {
    ...
    public PmlEdmDocumentType addPmlEdmDocumentType(
        PmlEdmDocumentType pmlEdmDocumentType) throws SystemException {
        pmlEdmDocumentType.setNew(true);

        return pmlEdmDocumentTypePersistence.update(pmlEdmDocumentType, false);
    }

    public PmlEdmDocumentType createPmlEdmDocumentType(long documentTypeId) {
        return pmlEdmDocumentTypePersistence.create(documentTypeId);
    }
    ...
    public void deletePmlEdmDocumentType(PmlEdmDocumentType pmlEdmDocumentType)
        throws SystemException {
        pmlEdmDocumentTypePersistence.remove(pmlEdmDocumentType);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlEdmDocumentTypePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlEdmDocumentType getPmlEdmDocumentType(long documentTypeId)
        throws PortalException, SystemException {
        return pmlEdmDocumentTypePersistence.findByPrimaryKey(documentTypeId);
    }

    public List<PmlEdmDocumentType> getPmlEdmDocumentTypes(int start, int end)
        throws SystemException {
        return pmlEdmDocumentTypePersistence.findAll(start, end);
    }

    public int getPmlEdmDocumentTypesCount() throws SystemException {
        return pmlEdmDocumentTypePersistence.countAll();
    }

    public PmlEdmDocumentType updatePmlEdmDocumentType(
        PmlEdmDocumentType pmlEdmDocumentType) throws SystemException {
        pmlEdmDocumentType.setNew(false);

        return pmlEdmDocumentTypePersistence.update(pmlEdmDocumentType, true);
    }
