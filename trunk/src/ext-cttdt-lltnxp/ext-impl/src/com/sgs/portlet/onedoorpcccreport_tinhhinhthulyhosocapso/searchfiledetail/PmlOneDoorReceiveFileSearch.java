 ...
 * 
 */
package com.sgs.portlet.onedoorpcccreport_tinhhinhthulyhosocapso.searchfiledetail;
...
public class PmlOneDoorReceiveFileSearch extends SearchContainer<PmlOneDoorReceiveFile>{
	...
	public PmlOneDoorReceiveFileSearch(RenderRequest renderRequest, PortletURL iteratorURL) {
		...
		try {
			...
			String portletName = "SGS_ONEDOORPCCCREPORT_TINHHINHTHULYHOSOCAPSO";
			
			if (Validator.isNotNull(orderByCol) &&
				Validator.isNotNull(orderByType)) {

				preferences.setValue(portletName, "tinhhinhthulyhosocapsoworks-order-by-col",	orderByCol);
				preferences.setValue(portletName, "tinhhinhthulyhosocapsoworks-order-by-type", orderByType);
			}
			
			else {
				orderByCol = preferences.getValue(portletName, "tinhhinhthulyhosocapsoworks-order-by-col", "pccc-DSHS-mahoso");
				orderByType = preferences.getValue(portletName, "tinhhinhthulyhosocapsoworks-order-by-type", "desc");
			}
