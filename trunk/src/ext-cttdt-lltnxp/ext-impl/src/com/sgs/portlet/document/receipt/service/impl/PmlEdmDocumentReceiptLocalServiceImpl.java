...
public class PmlEdmDocumentReceiptLocalServiceImpl extends
	...
	public List<PmlEdmDocumentReceipt> filterByIssuingPlace(
		...
		List<PmlEdmDocumentReceipt> retValue = new ArrayList<PmlEdmDocumentReceipt>();
		PmlEdmDocumentReceipt pmlEdmDocumentReceipt = null;
		List<PmlEdmIssuingPlace> listIssuingPlace = this
				.getListIssuingPlace(list);
		...
		for (PmlEdmIssuingPlace item : listIssuingPlace) {
			if (item.getIssuingPlaceName() != null) {
				...
				String issuingPlaceId = item.getIssuingPlaceId();
				pmlEdmDocumentReceipt = this.getDocumentReceipt(issuingPlaceId);
	...
	public List<PmlEdmDocumentReceipt> filterByBriefContent(
		...
		for (PmlEdmDocumentReceipt item : list) {
			if (item.getBriefContent() != null) {
				if (item.getBriefContent().toUpperCase().indexOf(
						briefContent.toUpperCase()) != -1) {
					pmlEdmDocumentReceipt = item;
					retValue.add(pmlEdmDocumentReceipt);
				}
			}
	...
	public int countTonDauKyChuyenVien_CVDen(long userId,
		...
		return pmlEdmDocumentReceiptFinder.countTonDauKyChuyenVien_CVDen(
				userId, documentRecordTypeId, capGui, loaiVB, doMat, fromDate, toDate);
	}
	...
	public List<PmlEdmDocumentReceipt> listTonDauKyChuyenVien_CVDen(
		...
		return pmlEdmDocumentReceiptFinder.listTonDauKyChuyenVien_CVDen(userId,
				documentRecordTypeId, capGui, loaiVB, doMat, fromDate, toDate, start,
				end, obc);
	}
	...
	public List<PmlEdmDocumentReceipt> listChuaNhanChuyenVien_CVDen(
		...
		return pmlEdmDocumentReceiptFinder.listChuaNhanChuyenVien_CVDen(
				userId, documentRecordTypeId, capGui, loaiVB, doMat, fromDate, toDate,
				start, end, obc);
	}
	...
	public int countTonDauKyPhongBan_CVDen(String departmentId,
		...
		return pmlEdmDocumentReceiptFinder.countTonDauKyPhongBan_CVDen(
				departmentId, documentRecordTypeId, capGui, loaiVB, doMat, fromDate,
				toDate);
	}
	...
	// ton dau ky
	public int countTonDauKySo_CVDen(int documentRecordTypeId, int capGui, int loaiVB, 
			String doMat, Date fromDate, Date toDate) throws Exception {

		return pmlEdmDocumentReceiptFinder.countTonDauKySo_CVDen(documentRecordTypeId, capGui, loaiVB, doMat, fromDate, toDate);
	}

	public List<PmlEdmDocumentReceipt> listTonDauKySo_CVDen(int documentRecordTypeId, int capGui, int loaiVB, 
			String doMat, Date fromDate, Date toDate, int start, int end, OrderByComparator obc)
			throws Exception {

		return pmlEdmDocumentReceiptFinder.listTonDauKySo_CVDen(documentRecordTypeId, capGui, loaiVB, doMat, 
	...
	public List<PmlEdmDocumentReceipt> getListCVDenDaXuLyChung(long userId, String year, String capGui, String loaisocongvan, int start, int end, OrderByComparator obc) throws SystemException {
		return pmlEdmDocumentReceiptFinder.getListCVDenDaXuLyChung(userId, year, capGui, loaisocongvan, start, end, obc);
	}
	
	public int countListCVDenDaXuLyChung (long userId, String year, String capGui, String loaisocongvan) throws SystemException{
		return pmlEdmDocumentReceiptFinder.countListCVDenDaXuLyChung(userId, year, capGui, loaisocongvan);
	}
	...
	public List<PmlEdmDocumentReceipt> getListCVDenDaXuLyTuXuLy(long userId, String year, String capGui, String loaisocongvan, int start, int end, OrderByComparator obc) throws SystemException {
		return pmlEdmDocumentReceiptFinder.getListCVDenDaXuLyTuXuLy(userId, year, capGui, loaisocongvan, start, end, obc);
	}
	
	public int countListCVDenDaXuLyTuXuLy(long userId, String year, String capGui, String loaisocongvan) throws SystemException{
		return pmlEdmDocumentReceiptFinder.countListCVDenDaXuLyTuXuLy(userId, year, capGui, loaisocongvan);
	}
	...
	public List<PmlEdmDocumentReceipt> getListCVDenDaXuLyChung_treHan(long userId, String year, String capGui, String loaisocongvan, int start, int end, OrderByComparator obc) throws SystemException {
		return pmlEdmDocumentReceiptFinder.getListCVDenDaXuLyChung_treHan(userId, year, capGui, loaisocongvan, start, end, obc);
	}
	...
	public int countListCVDenDaXuLyChung_treHan(long userId, String year, String capGui, String loaisocongvan) throws SystemException{
		return pmlEdmDocumentReceiptFinder.countListCVDenDaXuLyChung_treHan(userId, year, capGui, loaisocongvan);
	}
	...
	public List<PmlEdmDocumentReceipt> getListCVDenDaXuLyTuXuLy_treHan(long userId, String year, String capGui, String loaisocongvan, int start, int end, OrderByComparator obc) throws SystemException {
		return pmlEdmDocumentReceiptFinder.getListCVDenDaXuLyTuXuLy_treHan(userId, year, capGui, loaisocongvan, start, end, obc);
	}
	...
	public int countListCVDenDaXuLyTuXuLy_treHan(long userId, String year, String capGui, String loaisocongvan) throws SystemException{
		return pmlEdmDocumentReceiptFinder.countListCVDenDaXuLyTuXuLy_treHan(userId, year, capGui, loaisocongvan);
	}
	//end 08/04/2010
	...
	public List<PmlEdmDocumentReceipt> findByN_D_I_L_I_P_D_D_D_B(
		...
		return pmlEdmDocumentReceiptFinder.findByN_D_I_L_I_P_D_D_D_B(soNoiBo, 
				soHieuGoc, ngayPHDay, ngayPHMonth, ngayPHYear, capGui, noiPhatHanh, 
				uuTien, ngayDenDay, ngayDenMonth, ngayDenYear, loaiVB, phongBan, 
				trichYeu, start, end, obc);
	}
	...
	public List<PmlEdmDocumentReceipt> getListCVDenDaXuLyChung(long userId, String soVBDen, String soHieuGoc, int loaiSoVanBan, String issuingplaceId, String noiBanHanh,
		...
		return pmlEdmDocumentReceiptFinder.getListCVDenDaXuLyChung(userId, soVBDen, soHieuGoc, loaiSoVanBan, issuingplaceId, noiBanHanh, trichYeu, tuNgay, denNgay, ngayHetHan, start, end, obc);
	}
	...
	public int countListCVDenDaXuLyChung(long userId, String soVBDen, String soHieuGoc, int loaiSoVanBan,  String issuingplaceId, String noiBanHanh,
		...
		return pmlEdmDocumentReceiptFinder.countListCVDenDaXuLyChung(userId, soVBDen, soHieuGoc, loaiSoVanBan, issuingplaceId, noiBanHanh, trichYeu, tuNgay, denNgay, ngayHetHan);
	}
	...
	public List<PmlEdmDocumentReceipt> getListCVDenDaXuLyTuXuLy(long userId, String soVBDen, String soHieuGoc, int loaiSoVanBan,  String issuingplaceId, String noiBanHanh,
			String trichYeu, String tuNgay, String denNgay, String ngayHetHan, int start, int end, OrderByComparator obc) throws SystemException {
		return pmlEdmDocumentReceiptFinder.getListCVDenDaXuLyTuXuLy(userId, soVBDen, soHieuGoc, loaiSoVanBan, issuingplaceId, noiBanHanh, trichYeu, tuNgay, denNgay, ngayHetHan, start, end, obc);
	}
	...
	public int countListCVDenDaXuLyTuXuLy(long userId, String soVBDen, String soHieuGoc, int loaiSoVanBan,  String issuingplaceId, String noiBanHanh,
			String trichYeu, String tuNgay, String denNgay, String ngayHetHan) throws SystemException{
		return pmlEdmDocumentReceiptFinder.countListCVDenDaXuLyTuXuLy(userId, soVBDen, soHieuGoc, loaiSoVanBan, issuingplaceId, noiBanHanh, trichYeu, tuNgay, denNgay, ngayHetHan);
	}
	...
	public List<PmlEdmDocumentReceipt> getListCVDenDaXuLyChung_treHan(long userId, String soVBDen, String soHieuGoc, int loaiSoVanBan,  String issuingplaceId, String noiBanHanh,
			String trichYeu, String tuNgay, String denNgay, String ngayHetHan, int start, int end, OrderByComparator obc) throws SystemException {
		return pmlEdmDocumentReceiptFinder.getListCVDenDaXuLyChung_treHan(userId, soVBDen, soHieuGoc, loaiSoVanBan, issuingplaceId, noiBanHanh, trichYeu, tuNgay, denNgay, ngayHetHan, start, end, obc);
	}
	...
	public int countListCVDenDaXuLyChung_treHan(long userId, String soVBDen, String soHieuGoc, int loaiSoVanBan,  String issuingplaceId, String noiBanHanh,
			String trichYeu, String tuNgay, String denNgay, String ngayHetHan) throws SystemException{
		return pmlEdmDocumentReceiptFinder.countListCVDenDaXuLyChung_treHan(userId, soVBDen, soHieuGoc, loaiSoVanBan, issuingplaceId, noiBanHanh, trichYeu, tuNgay, denNgay, ngayHetHan);
	}
	...
	public List<PmlEdmDocumentReceipt> getListCVDenDaXuLyTuXuLy_treHan(long userId, String soVBDen, String soHieuGoc, int loaiSoVanBan,  String issuingplaceId, String noiBanHanh,
			String trichYeu, String tuNgay, String denNgay, String ngayHetHan, int start, int end, OrderByComparator obc) throws SystemException {
		return pmlEdmDocumentReceiptFinder.getListCVDenDaXuLyTuXuLy_treHan(userId, soVBDen, soHieuGoc, loaiSoVanBan, issuingplaceId, noiBanHanh, trichYeu, tuNgay, denNgay, ngayHetHan, start, end, obc);
	}
	...
	public int countListCVDenDaXuLyTuXuLy_treHan(long userId, String soVBDen, String soHieuGoc, int loaiSoVanBan,  String issuingplaceId, String noiBanHanh,
			String trichYeu, String tuNgay, String denNgay, String ngayHetHan) throws SystemException{
		return pmlEdmDocumentReceiptFinder.countListCVDenDaXuLyTuXuLy_treHan(userId, soVBDen, soHieuGoc, loaiSoVanBan, issuingplaceId, noiBanHanh, trichYeu, tuNgay, denNgay, ngayHetHan);
	}
	...
	public List<PmlEdmDocumentReceipt> findByDocumentReceipt_Users_Status_DangXuLy(List<Long> userIds, long statusId, String soVBDen, 
		...
		return pmlEdmDocumentReceiptFinder.findByDocumentReceipt_Users_Status_DangXuLy(userIds, statusId, soVBDen, soHieuGoc, loaiSoVanBan, 
					issuingplaceId, noiBanHanh, trichYeu, tuNgay, denNgay, ngayHetHan, start, end, obc);
	}
	...
	public int countByDocumentReceipt_Users_Status_DangXuLy(List<Long> userIds, long statusId, String soVBDen, String soHieuGoc, 
		...
		return pmlEdmDocumentReceiptFinder.countByDocumentReceipt_Users_Status_DangXuLy(userIds, statusId, soVBDen, soHieuGoc, loaiSoVanBan, 
					issuingplaceId, noiBanHanh, trichYeu, tuNgay, denNgay, ngayHetHan);
	}
	...
	public List<PmlEdmDocumentReceipt> findByDocumentReceipt_Users_Status_DangXuLy_TreHan(List<Long> userIds, long statusId, String soVBDen, String soHieuGoc, 
			...
			int start, int end, OrderByComparator obc) throws Exception {
		return pmlEdmDocumentReceiptFinder.findByDocumentReceipt_Users_Status_DangXuLy_TreHan(userIds, statusId, soVBDen, soHieuGoc, loaiSoVanBan,
					issuingplaceId, noiBanHanh, trichYeu, tuNgay, denNgay, ngayHetHan, start, end, obc);
	}
	...
	public int countByDocumentReceipt_Users_Status_DangXuLy_TreHan(List<Long> userIds,long statusId, String soVBDen, String soHieuGoc, 
			int loaiSoVanBan, String issuingplaceId, String noiBanHanh, String trichYeu, String tuNgay, String denNgay, String ngayHetHan) throws Exception {
		return pmlEdmDocumentReceiptFinder.countByDocumentReceipt_Users_Status_DangXuLy_TreHan(userIds, statusId, soVBDen, soHieuGoc, loaiSoVanBan, issuingplaceId, noiBanHanh, trichYeu, tuNgay, denNgay, ngayHetHan);
	}
	...
	public List<PmlEdmDocumentReceipt> findByDocumentReceipt_Users(List<Long> userIds, String soVBDen, String soHieuGoc, 
			...
			int end, OrderByComparator obc) throws Exception {
		return pmlEdmDocumentReceiptFinder.findByDocumentReceipt_Users(userIds, soVBDen, soHieuGoc, loaiSoVanBan, issuingplaceId, noiBanHanh, trichYeu, tuNgay, denNgay, start, end, obc);
	}
	...
	public int countByDocumentReceipt_Users(List<Long> userIds, String soVBDen, String soHieuGoc, 
		...
		return pmlEdmDocumentReceiptFinder.countByDocumentReceipt_Users(userIds, soVBDen, soHieuGoc, loaiSoVanBan, issuingplaceId, noiBanHanh, trichYeu, tuNgay, denNgay);
	}
	...
	public List<PmlDocumentReceiptLog> findByDocumentReceiptLog_Users_Status_DangXuLy(List<Long> userIds, long statusId, 
		...
		return pmlEdmDocumentReceiptFinder.findByDocumentReceiptLog_Users_Status_DangXuLy(userIds, statusId, 
				soVBDen, soHieuGoc, loaiSoVanBan, issuingplaceId, noiBanHanh, trichYeu, tuNgay, denNgay, 
	...
	public List<PmlDocumentReceiptLog> findByDocumentReceiptLog_Users_Status_DangXuLy_TreHan(List<Long> userIds, long statusId, 
		...
		return pmlEdmDocumentReceiptFinder.findByDocumentReceiptLog_Users_Status_DangXuLy_TreHan(userIds, statusId, 
				soVBDen, soHieuGoc, loaiSoVanBan, issuingplaceId, noiBanHanh, trichYeu, tuNgay, denNgay, 
				ngayHetHan, start, end, obc);
	}
	...
	public List<PmlDocumentReceiptLog> findByDocumentReceiptLog_Users(List<Long> userIds, String soVBDen, String soHieuGoc, 
		...
		return pmlEdmDocumentReceiptFinder.findByDocumentReceiptLog_Users(userIds, soVBDen, soHieuGoc, loaiSoVanBan, 
				issuingplaceId, noiBanHanh, trichYeu, tuNgay, denNgay, start, end, obc);
	}
	 ...
	 */
	/**
	 * Lay danh sach ma so van ban den theo so den, so noi bo, ngay den, noi phat hanh, trich yeu 
	 * 
	 * @param companyId Dung de tim theo lucene
	 * @param soVBDen So van ban den (So hieu goc)
	 * @param soNoiBo So noi bo
	 * @param tuNgay Ngay den tu ngay
	 * @param denNgay Ngay den den ngay
	 * @param noiPhatHanh Noi phat hanh
	 * @param trichYeu Noi dung trich yeu
	 * @param notInDocIdRelation Danh sach ma so van ban khong lay ve trong ket qua tra ve
	 * @param sortField Sap xep theo ten truong
	 * @param sortType Kieu sap xep
	 * @param reverse Dao nguoc hay khong
	 * @return
	 * @throws SystemException
	 */
	public List<Long> searchBySD_SNB_ND_NPH_TY_noRelation(long companyId, String soVBDen, String soNoiBo,
			Date tuNgay, Date denNgay, String noiPhatHanh, String trichYeu, List<Long> notInDocIdRelation,  
			String sortField, int sortType, boolean reverse) throws SystemException {
		...
		try {
			...
			Hits hits = search(companyId, soVBDen, soNoiBo, tuNgay, denNgay, soHSCV, loaiVB, 
					noiPhatHanh, trangThai, nguoiKy, trichYeu, active, sortField, sortType, 
					reverse, start, end);
			...
			if (hits.getLength() > 0) {
				...
				for (int idxH = 0; idxH < hits.getLength(); idxH ++) {
					...
					long docId = GetterUtil.getLong(docItem.get(Field.ENTRY_CLASS_PK));
			...
			if (!notInDocIdRelation.isEmpty()) {
				// Duyet danh sach ma so khong tra ve de remove khoi danh sach tra ve
				for (int idxDIR = 0; idxDIR < notInDocIdRelation.size(); idxDIR ++) {
					if (retVal.contains(notInDocIdRelation.get(idxDIR))) {
						retVal.remove(retVal.indexOf(notInDocIdRelation.get(idxDIR)));
					}
				}
			}
		}
			...
			System.out.println(
					"Co loi trong ham searchBySD_SNB_ND_NPH_TY_noRelation cua file PmlEdmDocumentReceiptLocalServiceImpl.java.");
			ex.printStackTrace();
		}
		return retVal;
	}
	...
	/**
	 * Lay so luong ma so van ban den theo so den, so noi bo, ngay den, noi phat hanh, trich yeu 
	 * 
	 * @param companyId Dung de tim theo lucene
	 * @param soVBDen So van ban den (So hieu goc)
	 * @param soNoiBo So noi bo
	 ...
	 * @throws SystemException
	 */
	public int countBySD_SNB_ND_NPH_TY_noRelation(long companyId, String soVBDen, String soNoiBo,
			Date tuNgay, Date denNgay, String noiPhatHanh, String trichYeu,  
		...
		try {
			...
			List<Long> lstRes = searchBySD_SNB_ND_NPH_TY_noRelation(
					companyId, soVBDen, soNoiBo, tuNgay, denNgay, noiPhatHanh, trichYeu, 
			...
			System.out.println(
					"Co loi trong ham countBySD_SNB_ND_NPH_TY_noRelation cua file PmlEdmDocumentReceiptLocalServiceImpl.java.");
			ex.printStackTrace();
		}
		return retVal;
	}
	 ...
	 * @param sortType Kieu sap xep
	 * @param reverse Dao nguoc hay khong
	 * @param start Vi tri bat dau danh sach con
	 * @param end Vi tri ket thuc danh sach con
	 * @return
	 * @throws SystemException
	 */
	public List<Long> searchBySD_SNB_ND_NPH_TY_noRelation(long companyId, String soVBDen, String soNoiBo,
...
//	
	public List<PmlEdmDocumentReceipt> findBy_isPublic_mainDepartmentProcessId_Date(
		...
		return pmlEdmDocumentReceiptFinder.findBy_isPublic_mainDepartmentProcessId_Date(isPublic, mainDepartmentProcessId, tuNgay, denNgay, listUserId, start, end, order);
	}
	...
	public int countBy_isPublic_mainDepartmentProcessId_Date(String isPublic, String mainDepartmentProcessId, String tuNgay, String denNgay,String listUserId) throws SystemException{
		return pmlEdmDocumentReceiptFinder.countBy_isPublic_mainDepartmentProcessId_Date(isPublic, mainDepartmentProcessId, tuNgay, denNgay, listUserId);
	}
	...
	public int countByNumberDocumentReceipt(String numberDocumentReceipt, int issuingYear, long documentReceiptId) throws SystemException {
		return pmlEdmDocumentReceiptFinder.countByNumberDocumentReceipt(numberDocumentReceipt, issuingYear, documentReceiptId);
	}
	
	// ham kiem tra so hieu trung cho edit
	public int countByDocumentReference(String documentReference, int issuingYear, 
				long documentReceiptId) throws SystemException {
		return pmlEdmDocumentReceiptFinder.countByDocumentReference(documentReference, issuingYear, documentReceiptId);
	}
}