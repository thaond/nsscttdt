...
public abstract class PmlEdmConfidentialLevelLocalServiceBaseImpl
    implements PmlEdmConfidentialLevelLocalService {
    ...
    public PmlEdmConfidentialLevel addPmlEdmConfidentialLevel(
        PmlEdmConfidentialLevel pmlEdmConfidentialLevel)
        throws SystemException {
        pmlEdmConfidentialLevel.setNew(true);

        return pmlEdmConfidentialLevelPersistence.update(pmlEdmConfidentialLevel,
            false);
    }

    public PmlEdmConfidentialLevel createPmlEdmConfidentialLevel(
        String confidentialLevelId) {
        return pmlEdmConfidentialLevelPersistence.create(confidentialLevelId);
    }

    public void deletePmlEdmConfidentialLevel(String confidentialLevelId)
        throws PortalException, SystemException {
        pmlEdmConfidentialLevelPersistence.remove(confidentialLevelId);
    }

    public void deletePmlEdmConfidentialLevel(
        PmlEdmConfidentialLevel pmlEdmConfidentialLevel)
        throws SystemException {
        pmlEdmConfidentialLevelPersistence.remove(pmlEdmConfidentialLevel);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlEdmConfidentialLevelPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlEdmConfidentialLevel getPmlEdmConfidentialLevel(
        String confidentialLevelId) throws PortalException, SystemException {
        return pmlEdmConfidentialLevelPersistence.findByPrimaryKey(confidentialLevelId);
    }

    public List<PmlEdmConfidentialLevel> getPmlEdmConfidentialLevels(
        int start, int end) throws SystemException {
        return pmlEdmConfidentialLevelPersistence.findAll(start, end);
    }

    public int getPmlEdmConfidentialLevelsCount() throws SystemException {
        return pmlEdmConfidentialLevelPersistence.countAll();
    }

    public PmlEdmConfidentialLevel updatePmlEdmConfidentialLevel(
        PmlEdmConfidentialLevel pmlEdmConfidentialLevel)
        throws SystemException {
