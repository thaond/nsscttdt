...
public abstract class PmlEdmDocumentRecordTypeLocalServiceBaseImpl
    implements PmlEdmDocumentRecordTypeLocalService {
    ...
    public PmlEdmDocumentRecordType addPmlEdmDocumentRecordType(
        PmlEdmDocumentRecordType pmlEdmDocumentRecordType)
        throws SystemException {
        pmlEdmDocumentRecordType.setNew(true);

        return pmlEdmDocumentRecordTypePersistence.update(pmlEdmDocumentRecordType,
            false);
    }

    public PmlEdmDocumentRecordType createPmlEdmDocumentRecordType(
        int documentRecordTypeId) {
        return pmlEdmDocumentRecordTypePersistence.create(documentRecordTypeId);
    }
    ...
    public void deletePmlEdmDocumentRecordType(
        PmlEdmDocumentRecordType pmlEdmDocumentRecordType)
        throws SystemException {
        pmlEdmDocumentRecordTypePersistence.remove(pmlEdmDocumentRecordType);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlEdmDocumentRecordTypePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlEdmDocumentRecordType getPmlEdmDocumentRecordType(
        int documentRecordTypeId) throws PortalException, SystemException {
        return pmlEdmDocumentRecordTypePersistence.findByPrimaryKey(documentRecordTypeId);
    }

    public List<PmlEdmDocumentRecordType> getPmlEdmDocumentRecordTypes(
        int start, int end) throws SystemException {
        return pmlEdmDocumentRecordTypePersistence.findAll(start, end);
    }

    public int getPmlEdmDocumentRecordTypesCount() throws SystemException {
        return pmlEdmDocumentRecordTypePersistence.countAll();
    }

    public PmlEdmDocumentRecordType updatePmlEdmDocumentRecordType(
        PmlEdmDocumentRecordType pmlEdmDocumentRecordType)
        throws SystemException {
