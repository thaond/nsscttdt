 ...
 * 
 */
package com.sgs.portlet.onedoorpcccreport_baocaohosothangluyke.searchfiledetail;
...
public class PmlOneDoorReceiveFileSearch extends SearchContainer<PmlOneDoorReceiveFile>{
	...
	public PmlOneDoorReceiveFileSearch(RenderRequest renderRequest, PortletURL iteratorURL) {
		...
		try {
			...
			String portletName = "SGS_ONEDOORPCCCREPORT_BAOCAOHOSOTHANGLUYKE";
			
			if (Validator.isNotNull(orderByCol) &&
				Validator.isNotNull(orderByType)) {

				preferences.setValue(portletName, "baocaohosothangluykeworks-order-by-col",	orderByCol);
				preferences.setValue(portletName, "baocaohosothangluykeworks-order-by-type", orderByType);
			}
			
			else {
				orderByCol = preferences.getValue(portletName, "baocaohosothangluykeworks-order-by-col", "pccc-DSHS-mahoso");
				orderByType = preferences.getValue(portletName, "baocaohosothangluykeworks-order-by-type", "desc");
			}
