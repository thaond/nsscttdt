...
public abstract class PmlTeamLeaderLocalServiceBaseImpl
    implements PmlTeamLeaderLocalService {
    ...
    public PmlTeamLeader addPmlTeamLeader(PmlTeamLeader pmlTeamLeader)
        throws SystemException {
        pmlTeamLeader.setNew(true);

        return pmlTeamLeaderPersistence.update(pmlTeamLeader, false);
    }

    public PmlTeamLeader createPmlTeamLeader(long teamId) {
        return pmlTeamLeaderPersistence.create(teamId);
    }

    public void deletePmlTeamLeader(long teamId)
        throws PortalException, SystemException {
        pmlTeamLeaderPersistence.remove(teamId);
    }

    public void deletePmlTeamLeader(PmlTeamLeader pmlTeamLeader)
        throws SystemException {
        pmlTeamLeaderPersistence.remove(pmlTeamLeader);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlTeamLeaderPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlTeamLeader getPmlTeamLeader(long teamId)
        throws PortalException, SystemException {
        return pmlTeamLeaderPersistence.findByPrimaryKey(teamId);
    }

    public List<PmlTeamLeader> getPmlTeamLeaders(int start, int end)
        throws SystemException {
        return pmlTeamLeaderPersistence.findAll(start, end);
    }

    public int getPmlTeamLeadersCount() throws SystemException {
        return pmlTeamLeaderPersistence.countAll();
    }

    public PmlTeamLeader updatePmlTeamLeader(PmlTeamLeader pmlTeamLeader)
        throws SystemException {
        pmlTeamLeader.setNew(false);

        return pmlTeamLeaderPersistence.update(pmlTeamLeader, true);
    }
