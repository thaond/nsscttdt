...
public abstract class PmlEdmWriteDocumentSendLocalServiceBaseImpl
    implements PmlEdmWriteDocumentSendLocalService {
    ...
    public PmlEdmWriteDocumentSend addPmlEdmWriteDocumentSend(
        PmlEdmWriteDocumentSend pmlEdmWriteDocumentSend)
        throws SystemException {
        pmlEdmWriteDocumentSend.setNew(true);

        return pmlEdmWriteDocumentSendPersistence.update(pmlEdmWriteDocumentSend,
            false);
    }

    public PmlEdmWriteDocumentSend createPmlEdmWriteDocumentSend(
        PmlEdmWriteDocumentSendPK pmlEdmWriteDocumentSendPK) {
        return pmlEdmWriteDocumentSendPersistence.create(pmlEdmWriteDocumentSendPK);
    }

    public void deletePmlEdmWriteDocumentSend(
        PmlEdmWriteDocumentSendPK pmlEdmWriteDocumentSendPK)
        throws PortalException, SystemException {
        pmlEdmWriteDocumentSendPersistence.remove(pmlEdmWriteDocumentSendPK);
    }

    public void deletePmlEdmWriteDocumentSend(
        PmlEdmWriteDocumentSend pmlEdmWriteDocumentSend)
        throws SystemException {
        pmlEdmWriteDocumentSendPersistence.remove(pmlEdmWriteDocumentSend);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlEdmWriteDocumentSendPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlEdmWriteDocumentSend getPmlEdmWriteDocumentSend(
        PmlEdmWriteDocumentSendPK pmlEdmWriteDocumentSendPK)
        throws PortalException, SystemException {
        return pmlEdmWriteDocumentSendPersistence.findByPrimaryKey(pmlEdmWriteDocumentSendPK);
    }

    public List<PmlEdmWriteDocumentSend> getPmlEdmWriteDocumentSends(
        int start, int end) throws SystemException {
        return pmlEdmWriteDocumentSendPersistence.findAll(start, end);
    }

    public int getPmlEdmWriteDocumentSendsCount() throws SystemException {
        return pmlEdmWriteDocumentSendPersistence.countAll();
    }

    public PmlEdmWriteDocumentSend updatePmlEdmWriteDocumentSend(
        PmlEdmWriteDocumentSend pmlEdmWriteDocumentSend)
        throws SystemException {
