...
public abstract class PmlPaintDocumentLocalServiceBaseImpl
    implements PmlPaintDocumentLocalService {
    ...
    public PmlPaintDocument addPmlPaintDocument(
        PmlPaintDocument pmlPaintDocument) throws SystemException {
        pmlPaintDocument.setNew(true);

        return pmlPaintDocumentPersistence.update(pmlPaintDocument, false);
    }

    public PmlPaintDocument createPmlPaintDocument(long paintDocumentId) {
        return pmlPaintDocumentPersistence.create(paintDocumentId);
    }

    public void deletePmlPaintDocument(long paintDocumentId)
        throws PortalException, SystemException {
        pmlPaintDocumentPersistence.remove(paintDocumentId);
    }

    public void deletePmlPaintDocument(PmlPaintDocument pmlPaintDocument)
        throws SystemException {
        pmlPaintDocumentPersistence.remove(pmlPaintDocument);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlPaintDocumentPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlPaintDocument getPmlPaintDocument(long paintDocumentId)
        throws PortalException, SystemException {
        return pmlPaintDocumentPersistence.findByPrimaryKey(paintDocumentId);
    }

    public List<PmlPaintDocument> getPmlPaintDocuments(int start, int end)
        throws SystemException {
        return pmlPaintDocumentPersistence.findAll(start, end);
    }

    public int getPmlPaintDocumentsCount() throws SystemException {
        return pmlPaintDocumentPersistence.countAll();
    }

    public PmlPaintDocument updatePmlPaintDocument(
        PmlPaintDocument pmlPaintDocument) throws SystemException {
        pmlPaintDocument.setNew(false);

        return pmlPaintDocumentPersistence.update(pmlPaintDocument, true);
    }

    public PmlPaintDocument updatePmlPaintDocument(
        PmlPaintDocument pmlPaintDocument, boolean merge)
        throws SystemException {
        pmlPaintDocument.setNew(false);

        return pmlPaintDocumentPersistence.update(pmlPaintDocument, merge);
    }
