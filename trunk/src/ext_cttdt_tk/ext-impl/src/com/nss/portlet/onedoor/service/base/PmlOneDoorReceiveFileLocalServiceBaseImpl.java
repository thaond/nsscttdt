...
public abstract class PmlOneDoorReceiveFileLocalServiceBaseImpl
    implements PmlOneDoorReceiveFileLocalService {
    ...
    public PmlOneDoorReceiveFile addPmlOneDoorReceiveFile(
        PmlOneDoorReceiveFile pmlOneDoorReceiveFile) throws SystemException {
        pmlOneDoorReceiveFile.setNew(true);

        return pmlOneDoorReceiveFilePersistence.update(pmlOneDoorReceiveFile,
            false);
    }

    public PmlOneDoorReceiveFile createPmlOneDoorReceiveFile(String fileId) {
        return pmlOneDoorReceiveFilePersistence.create(fileId);
    }

    public void deletePmlOneDoorReceiveFile(String fileId)
        throws PortalException, SystemException {
        pmlOneDoorReceiveFilePersistence.remove(fileId);
    }

    public void deletePmlOneDoorReceiveFile(
        PmlOneDoorReceiveFile pmlOneDoorReceiveFile) throws SystemException {
        pmlOneDoorReceiveFilePersistence.remove(pmlOneDoorReceiveFile);
    }

    public List<Object> dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return pmlOneDoorReceiveFilePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public PmlOneDoorReceiveFile getPmlOneDoorReceiveFile(String fileId)
        throws PortalException, SystemException {
        return pmlOneDoorReceiveFilePersistence.findByPrimaryKey(fileId);
    }

    public List<PmlOneDoorReceiveFile> getPmlOneDoorReceiveFiles(int start,
        int end) throws SystemException {
        return pmlOneDoorReceiveFilePersistence.findAll(start, end);
    }

    public int getPmlOneDoorReceiveFilesCount() throws SystemException {
        return pmlOneDoorReceiveFilePersistence.countAll();
    }

    public PmlOneDoorReceiveFile updatePmlOneDoorReceiveFile(
        PmlOneDoorReceiveFile pmlOneDoorReceiveFile) throws SystemException {
