 ...
 * <code>com.nss.portlet.onedoor.service.http.PmlProcessDisposeServiceJSON</code>
 * to translate objects.
 * </p>
 *
 * @author Brian Wing Shun Chan
 *
 * @see com.nss.portlet.onedoor.service.http.PmlProcessDisposeServiceJSON
 *
 */
public class PmlProcessDisposeJSONSerializer {
    ...
    public static JSONArray toJSONArray(
        com.nss.portlet.onedoor.model.PmlProcessDispose[] models) {
    ...
    public static JSONArray toJSONArray(
        List<com.nss.portlet.onedoor.model.PmlProcessDispose> models) {
        JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
