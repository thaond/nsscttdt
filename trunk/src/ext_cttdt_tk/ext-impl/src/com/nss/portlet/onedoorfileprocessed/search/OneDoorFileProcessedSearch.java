...
import com.nss.portlet.onedoorfileprocessed.util.OneDoorFileProcessedSearchUtil;
...
public class OneDoorFileProcessedSearch extends SearchContainer<PmlOneDoorReceiveFile> {
	...
	public OneDoorFileProcessedSearch(RenderRequest renderRequest, PortletURL iteratorURL){
		...
		try {
			...
			String portletName = "NSS_ONEDOORRETURN";
			...
			OrderByComparator orderByComparator = OneDoorFileProcessedSearchUtil.getOneDoorFileByComparator(orderByCol, orderByType);
