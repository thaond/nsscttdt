package com.nss.portlet.van_ban_phap_quy.search;
...
import com.nss.portlet.van_ban_phap_quy.util.VanBanPhapQuySearchUtil;
...
public class VanBanPhapQuySearch extends SearchContainer<VanBanPhapQuy>{
	...
	public VanBanPhapQuySearch(PortletRequest portletRequest, PortletURL iteratorURL) {
		...
		try {
			...
			String portletName = "NSS_VAN_BAN_PHAP_QUY";
			...
			if (Validator.isNotNull(orderByCol) &&
				...
				orderByCol = preferences.getValue(
						portletName, "vanbanphapquys-order-by-col", "ngayBanHanh");
