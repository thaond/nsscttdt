 ...
 * 
 */
package com.nss.portlet.onedoorprocess.searchDelegated;
 ...
 *
 */
public class PmlOneDoorReceiveFileSearchDelegated extends SearchContainer<PmlOneDoorReceiveFile>{
	...
	public PmlOneDoorReceiveFileSearchDelegated(RenderRequest renderRequest, PortletURL iteratorURL) {
		super(renderRequest, new PmlOneDoorReceiveFileSearchDelegatedDisplayTerms(renderRequest),
				new PmlOneDoorReceiveFileSearchDelegatedTerms(renderRequest), DEFAULT_CUR_PARAM,
		...
		try {
			...
			String portletName = "NSS_ONEDOORPROCESS";
	...
	private static Log _log = LogFactoryUtil.getLog(PmlOneDoorReceiveFileSearchDelegated.class);
}
