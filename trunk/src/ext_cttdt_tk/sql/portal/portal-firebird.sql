...
create table InstanceBean (
	processInstanceId int64 not null primary key,
	businessProcessId int64,
	articleId int64,
	categoryId int64,
...
create table JournalProcessDefinition (
	journalProcessDefinitionId int64 not null primary key,
	name varchar(75),
	version varchar(75),
	content varchar(75)
);
...
create table log_workflow_journal_article (
	logWorkflowJournalArticleId int64 not null primary key,
	resourcePrimkey int64,
	transition integer,
	groupId int64,
	companyId int64,
...
create table nss_contact_book (
	contactBookId int64 not null primary key,
	contactBookCode varchar(75),
	contactBookName varchar(75),
	contactDescription varchar(75),
	contactActive smallint,
	companyid int64,
	userid int64
);

create table nss_detail_book (
	detailBookId int64 not null primary key,
	detailBookCode varchar(75),
	detailBookName varchar(75),
	detailDescription varchar(75),
	detailActive smallint,
	zip varchar(75),
	internal_ varchar(75),
	home varchar(75),
	mobile varchar(75),
	contactBookId int64,
	companyid int64,
...
create table nss_image_signer (
	imageSignerId int64 not null primary key,
	imageIdSign int64,
	imageIdUnSign int64,
	userId int64
);
...
create table nss_quan_ly_quy_trinh_duyet_tin (
	managementWorkflowJournalId int64 not null primary key,
	groupId int64,
	companyId int64,
	userId int64,
...
create table nss_signature (
	signatureId int64 not null primary key,
	groupId int64,
	companyId int64,
	userId int64,
	userName varchar(75),
	createDate timestamp,
	articlePrimKey int64,
	articleId varchar(75),
	version double precision,
	signData varchar(75)
);
...
create table nss_workflow_journal_article (
	workflowJournalArticleId int64 not null primary key,
	groupId int64,
	companyId int64,
	userId int64,
	userIds varchar(75),
