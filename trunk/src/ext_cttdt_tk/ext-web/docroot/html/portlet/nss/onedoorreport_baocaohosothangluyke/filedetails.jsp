...
<%@page import="com.nss.portlet.onedoorreport_baocaohosothangluyke.searchfiledetail.PmlOneDoorReceiveFileSearch"%>

<liferay-util:include page="/html/portlet/nss/onedoorreport_baocaohosothang/js/onedoorreport_baocaohosothangluyke-js.jsp"></liferay-util:include>

<link type="text/css" rel="stylesheet" href="/html/css/changeColorRow.css" />
<link type="text/css" rel="stylesheet" href="/html/portlet/nss/onedoorreport_baocaohosothangluyke/css/ex.css" />
...
<portlet:actionURL var="filter">
	<portlet:param name="struts_action"	value="/nss/onedoorreport_baocaohosothangluyke/filedetails" />
		...
		<div id="listdivpccc">
			<div id="listdiv" >
				...
				<ul>
					...
					<li style="width: 22%">
							<div class="btpre_hs" align="left"><liferay-util:include page="/html/portlet/nss/onedoorreport_baocaohosothangluyke/button.jsp"></liferay-util:include></div>
						</li>
			</ul>
			</div>
					...
					<table class="taglib-search-iterator table-pml" cellspacing="0" width="100%">	
						...
						%>
								...
								<portlet:renderURL var="detail"	windowState="<%= LiferayWindowState.EXCLUSIVE.toString() %>">
									<portlet:param name="struts_action"	value="/nss/onedoorreport_baocaohosothangluyke/filedetails_detail" />
