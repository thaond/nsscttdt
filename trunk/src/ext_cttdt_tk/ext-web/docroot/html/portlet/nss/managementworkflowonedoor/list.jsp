...
<%@page import="com.nss.portlet.filetype.service.persistence.PmlFileTypeUtil"%>
...
<%@page import="com.nss.portlet.managementworkflowonedoor.search.OneDoorWorkflowSearchTems"%>
<%@page import="com.nss.portlet.onedoor.model.PmlWorkflow"%>
<%@page import="com.nss.portlet.onedoor.service.PmlWorkflowLocalServiceUtil"%>
<%@page import="com.nss.portlet.filetype.service.PmlFileTypeLocalServiceUtil"%>
<%@page import="com.nss.portlet.onedoor.PmlWorkflowCanNotDeleteException"%>
...
<div class="title_categ"><liferay-ui:message key="workflow-admin"/></div>
 <div class="boxcontent">
	...
	<liferay-ui:search-form
		page="/html/portlet/nss/managementworkflowonedoor/search_form.jsp"
	...
	<%
		...
		for (int i = 0; i < results.size(); i ++) {
			...
			rowURLDelete.setParameter("struts_action", "/nss/managementworkflowonedoor/view");
...
<!--  add  -->
	...
	<portlet:actionURL var="add_process_workflow_admin">
		<portlet:param name="struts_action" value="/nss/managementworkflowonedoor/view" />
		...
		<form action="<%=add_process_workflow_admin %>" enctype="multipart/form-data" method="post" onsubmit="return <portlet:namespace />check_filetype_upload();">
			...
			<div class="boxcontent"> 
 			<table cellspacing="0"  width="100%">
					<tr>
						<td align="right" width="20%"><liferay-ui:message key="sgs_filetype_filetypeName"/>&nbsp;:</td>
						<td><select id="_fileTypeId" name="<portlet:namespace />_fileTypeId" style="width: 96%">
								<logic:iterate id="workflow" name="pmlFileTypeList" type="com.nss.portlet.filetype.model.PmlFileType"	indexId="i"  scope="request">
					...
					<tr>
						<td align="right"><liferay-ui:message key="sgs_fileName"/>&nbsp;:</td>
						<td>
