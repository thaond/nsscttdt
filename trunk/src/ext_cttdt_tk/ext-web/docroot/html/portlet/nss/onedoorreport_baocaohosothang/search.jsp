...
<div id="search-popup">
<fieldset>
<table style="width: 100%" class="bgdocsend" cellspacing="0">
<tr>
	...
	<fieldset ><legend class="legend-noborder" style="background-color: #EAEAEA"><liferay-ui:message key="pccc-TN-thongtinngaythang"/></legend>
