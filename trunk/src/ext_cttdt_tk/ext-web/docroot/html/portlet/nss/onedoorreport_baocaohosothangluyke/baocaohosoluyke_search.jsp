...
<%@page import="com.nss.portlet.onedoorreport_baocaohosothangluyke.search.BaoCaoHoSoLuyKeDisplayTerms"%>


<%@page import="java.text.SimpleDateFormat"%><script type="text/javascript" src="/html/js/calendar.js"></script>
		...
		<li style="width: 40%">
					<table  cellspacing="0" width="100%">
						<tr>
							...
							<td align="left">
								<input type="text" name="<portlet:namespace/><%= BaoCaoHoSoLuyKeDisplayTerms.TUNGAY %>" id="<portlet:namespace />fromDate" value="<%= HtmlUtil.escape(displayTerms.getFromDate()) %>" style="width: 100px" />
		...
		<li style="width: 38%">
				<table cellspacing="0" width="100%">
						<tr>
							...
							<td align="left">
								<input type="text" name="<portlet:namespace/><%= BaoCaoHoSoLuyKeDisplayTerms.DENNGAY %>" id="<portlet:namespace />toDate" value="<%= HtmlUtil.escape(displayTerms.getToDate()) %>" style="width: 100px" />
