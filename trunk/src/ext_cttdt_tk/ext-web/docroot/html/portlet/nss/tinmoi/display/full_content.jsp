...
<div class="asset-full-content <%= showAssetTitle ? "show-asset-title" : "" %>">
	<c:choose>
		<c:when test="<%= className.equals(BlogsEntry.class.getName()) %>">
			...
			viewFullContentURL.setParameter("struts_action", "/nss/tinmoi/view_content");
			...
			<div class="asset-content">
				...
				<c:if test="<%= PropsValues.BLOGS_ENTRY_COMMENTS_ENABLED && enableComments %>">
					...
					<portlet:actionURL var="discussionURL">
						<portlet:param name="struts_action" value="/nss/tinmoi/edit_entry_discussion" />
					</portlet:actionURL>
		...
		<c:when test="<%= className.equals(DLFileEntry.class.getName()) %>">
			...
			<div class="asset-content">
				...
				<c:if test="<%= PropsValues.DL_FILE_ENTRY_COMMENTS_ENABLED && enableComments %>">
					...
					<portlet:actionURL var="discussionURL">
						<portlet:param name="struts_action" value="/nss/tinmoi/edit_file_entry_discussion" />
					</portlet:actionURL>
			...
			<c:if test="<%= articleDisplay != null %>">
				...
				<div class="asset-content">
					...
					<c:if test="<%= articleDisplay.isPaginate() %>">
						...
						articlePageURL.setParameter("struts_action", "/nss/tinmoi/view_content");
					...
					<c:if test="<%= PropsValues.JOURNAL_ARTICLE_COMMENTS_ENABLED && enableComments %>">
						...
						<portlet:actionURL var="discussionURL">
							<portlet:param name="struts_action" value="/nss/tinmoi/edit_article_discussion" />
						</portlet:actionURL>
		...
		<c:when test="<%= className.equals(WikiPage.class.getName()) %>">
			...
			<div class="asset-content">
				...
				<c:if test="<%= PropsValues.WIKI_PAGE_COMMENTS_ENABLED && enableComments %>">
					...
					<portlet:actionURL var="discussionURL">
						<portlet:param name="struts_action" value="/nss/tinmoi/edit_page_discussion" />
					</portlet:actionURL>
...
<%!
private static Log _log = LogFactoryUtil.getLog("portal-web.docroot.html.portlet.nss.tinmoi.display_full_content.jsp");
%>